...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['superagent','http-proxy-agent', 'querystring', 'Authentication/MerchantConfig', 'Authentication/Logger', 'Authentication/Constants', 'Authentication/Authorization', 'Authentication/PayloadDigest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('superagent'), require('http-proxy-agent'), require('querystring'), require('./authentication/core/MerchantConfig'), require('./authentication/logging/Logger'), require('./authentication/util/Constants'), require('./authentication/core/Authorization'), require('./authentication/payloadDigest/DigestGenerator'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.ApiClient = factory(root.superagent, root.http-proxy-agent, root.querystring, root.Authentication.MerchantConfig, root.Authentication.Logger, root.Authentication.Constants, root.Authentication.Authorization, root.Authentication.PayloadDigest);
  }
}(this, function(superagent, {HttpProxyAgent}, querystring, MerchantConfig, Logger, Constants, Authorization, PayloadDigest) {
  // 'use strict';
  ...
  exports.prototype.callApi = function callApi(path, httpMethod, pathParams,
    ...
    if (useProxy && (proxyAddress != null && proxyAddress != '')) {
      require('http-proxy-agent')(require('superagent'));
      var request = superagent(httpMethod, url);
