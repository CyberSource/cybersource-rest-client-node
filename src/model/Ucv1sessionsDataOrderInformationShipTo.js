...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Ucv1sessionsDataOrderInformationShipTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Ucv1sessionsDataOrderInformationShipTo model module.
   * @module model/Ucv1sessionsDataOrderInformationShipTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ucv1sessionsDataOrderInformationShipTo</code>.
   * @alias module:model/Ucv1sessionsDataOrderInformationShipTo
   * @class
   */
  ...
  /**
   * Constructs a <code>Ucv1sessionsDataOrderInformationShipTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ucv1sessionsDataOrderInformationShipTo} obj Optional instance to populate.
   * @return {module:model/Ucv1sessionsDataOrderInformationShipTo} The populated <code>Ucv1sessionsDataOrderInformationShipTo</code> instance.
   */
