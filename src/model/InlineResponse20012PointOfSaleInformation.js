...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse20012PointOfSaleInformation = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse20012PointOfSaleInformation model module.
   * @module model/InlineResponse20012PointOfSaleInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse20012PointOfSaleInformation</code>.
   * @alias module:model/InlineResponse20012PointOfSaleInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse20012PointOfSaleInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20012PointOfSaleInformation} obj Optional instance to populate.
   * @return {module:model/InlineResponse20012PointOfSaleInformation} The populated <code>InlineResponse20012PointOfSaleInformation</code> instance.
   */
