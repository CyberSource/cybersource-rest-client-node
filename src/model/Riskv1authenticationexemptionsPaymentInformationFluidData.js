...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Riskv1authenticationexemptionsPaymentInformationFluidData = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Riskv1authenticationexemptionsPaymentInformationFluidData model module.
   * @module model/Riskv1authenticationexemptionsPaymentInformationFluidData
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Riskv1authenticationexemptionsPaymentInformationFluidData</code>.
   * @alias module:model/Riskv1authenticationexemptionsPaymentInformationFluidData
   * @class
  ...
  /**
   * Constructs a <code>Riskv1authenticationexemptionsPaymentInformationFluidData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Riskv1authenticationexemptionsPaymentInformationFluidData} obj Optional instance to populate.
   * @return {module:model/Riskv1authenticationexemptionsPaymentInformationFluidData} The populated <code>Riskv1authenticationexemptionsPaymentInformationFluidData</code> instance.
   */
