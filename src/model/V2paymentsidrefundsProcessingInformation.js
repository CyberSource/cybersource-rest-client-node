...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V2paymentsidrefundsProcessingInformationRecurringOptions'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V2paymentsidrefundsProcessingInformationRecurringOptions'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.V2paymentsidrefundsProcessingInformation = factory(root.CyberSource.ApiClient, root.CyberSource.V2paymentsidrefundsProcessingInformationRecurringOptions);
  }
}(this, function(ApiClient, V2paymentsidrefundsProcessingInformationRecurringOptions) {
  'use strict';
  ...
  /**
   * The V2paymentsidrefundsProcessingInformation model module.
   * @module model/V2paymentsidrefundsProcessingInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2paymentsidrefundsProcessingInformation</code>.
   * @alias module:model/V2paymentsidrefundsProcessingInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>V2paymentsidrefundsProcessingInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2paymentsidrefundsProcessingInformation} obj Optional instance to populate.
   * @return {module:model/V2paymentsidrefundsProcessingInformation} The populated <code>V2paymentsidrefundsProcessingInformation</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('recurringOptions')) {
        obj['recurringOptions'] = V2paymentsidrefundsProcessingInformationRecurringOptions.constructFromObject(data['recurringOptions']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/V2paymentsidrefundsProcessingInformationRecurringOptions} recurringOptions
   */
