...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse2002OrderInformationLineItems = factory(root.CyberSource.ApiClient, root.CyberSource.V2paymentsOrderInformationAmountDetailsTaxDetails);
  }
  ...
  /**
   * The InlineResponse2002OrderInformationLineItems model module.
   * @module model/InlineResponse2002OrderInformationLineItems
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2002OrderInformationLineItems</code>.
   * @alias module:model/InlineResponse2002OrderInformationLineItems
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2002OrderInformationLineItems</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2002OrderInformationLineItems} obj Optional instance to populate.
   * @return {module:model/InlineResponse2002OrderInformationLineItems} The populated <code>InlineResponse2002OrderInformationLineItems</code> instance.
   */
