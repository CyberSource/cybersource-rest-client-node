...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InvoicingV2InvoicesCancel200Response = factory(root.CyberSource.ApiClient, root.CyberSource.InvoicingV2InvoicesAllGet200ResponseLinks, root.CyberSource.InvoicingV2InvoicesPost201ResponseInvoiceInformation, root.CyberSource.InvoicingV2InvoicesPost201ResponseOrderInformation, root.CyberSource.Invoicingv2invoicesCustomerInformation, root.CyberSource.Invoicingv2invoicesProcessingInformation);
  }
  ...
  /**
   * The InvoicingV2InvoicesCancel200Response model module.
   * @module model/InvoicingV2InvoicesCancel200Response
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InvoicingV2InvoicesCancel200Response</code>.
   * @alias module:model/InvoicingV2InvoicesCancel200Response
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoicingV2InvoicesCancel200Response</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoicingV2InvoicesCancel200Response} obj Optional instance to populate.
   * @return {module:model/InvoicingV2InvoicesCancel200Response} The populated <code>InvoicingV2InvoicesCancel200Response</code> instance.
   */
