...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PaymentProductsPayerAuthenticationSubscriptionInformation', 'model/RiskProductsDecisionManagerConfigurationInformation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PaymentProductsPayerAuthenticationSubscriptionInformation'), require('./RiskProductsDecisionManagerConfigurationInformation'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.RiskProductsDecisionManager = factory(root.CyberSource.ApiClient, root.CyberSource.PaymentProductsPayerAuthenticationSubscriptionInformation, root.CyberSource.RiskProductsDecisionManagerConfigurationInformation);
  }
}(this, function(ApiClient, PaymentProductsPayerAuthenticationSubscriptionInformation, RiskProductsDecisionManagerConfigurationInformation) {
  'use strict';
