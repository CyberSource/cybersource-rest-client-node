...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20011PaymentProcessorToTerminalMap'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse20011PaymentProcessorToTerminalMap'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse20011Devices = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse20011PaymentProcessorToTerminalMap);
  }
}(this, function(ApiClient, InlineResponse20011PaymentProcessorToTerminalMap) {
  'use strict';
  ...
  /**
   * The InlineResponse20011Devices model module.
   * @module model/InlineResponse20011Devices
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse20011Devices</code>.
   * @alias module:model/InlineResponse20011Devices
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse20011Devices</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20011Devices} obj Optional instance to populate.
   * @return {module:model/InlineResponse20011Devices} The populated <code>InlineResponse20011Devices</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('paymentProcessorToTerminalMap')) {
        obj['paymentProcessorToTerminalMap'] = InlineResponse20011PaymentProcessorToTerminalMap.constructFromObject(data['paymentProcessorToTerminalMap']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse20011PaymentProcessorToTerminalMap} paymentProcessorToTerminalMap
   */
