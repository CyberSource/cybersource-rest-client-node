...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.V2payoutsRecipientInformation = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The V2payoutsRecipientInformation model module.
   * @module model/V2payoutsRecipientInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2payoutsRecipientInformation</code>.
   * @alias module:model/V2payoutsRecipientInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>V2payoutsRecipientInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2payoutsRecipientInformation} obj Optional instance to populate.
   * @return {module:model/V2payoutsRecipientInformation} The populated <code>V2payoutsRecipientInformation</code> instance.
   */
