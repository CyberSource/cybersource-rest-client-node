...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.V2paymentsidcapturesOrderInformationInvoiceDetails = factory(root.CyberSource.ApiClient, root.CyberSource.V2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum);
  }
  ...
  /**
   * The V2paymentsidcapturesOrderInformationInvoiceDetails model module.
   * @module model/V2paymentsidcapturesOrderInformationInvoiceDetails
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2paymentsidcapturesOrderInformationInvoiceDetails</code>.
   * @alias module:model/V2paymentsidcapturesOrderInformationInvoiceDetails
   * @class
   */
  ...
  /**
   * Constructs a <code>V2paymentsidcapturesOrderInformationInvoiceDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2paymentsidcapturesOrderInformationInvoiceDetails} obj Optional instance to populate.
   * @return {module:model/V2paymentsidcapturesOrderInformationInvoiceDetails} The populated <code>V2paymentsidcapturesOrderInformationInvoiceDetails</code> instance.
   */
