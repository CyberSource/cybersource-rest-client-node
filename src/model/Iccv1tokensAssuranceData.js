...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Iccv1tokensAuthenticatedIdentities', 'model/Iccv1tokensAuthenticationContext'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Iccv1tokensAuthenticatedIdentities'), require('./Iccv1tokensAuthenticationContext'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.Iccv1tokensAssuranceData = factory(root.CyberSource.ApiClient, root.CyberSource.Iccv1tokensAuthenticatedIdentities, root.CyberSource.Iccv1tokensAuthenticationContext);
  }
}(this, function(ApiClient, Iccv1tokensAuthenticatedIdentities, Iccv1tokensAuthenticationContext) {
  'use strict';
  ...
  /**
   * The Iccv1tokensAssuranceData model module.
   * @module model/Iccv1tokensAssuranceData
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Iccv1tokensAssuranceData</code>.
   ...
   * @alias module:model/Iccv1tokensAssuranceData
   * @class
  ...
  /**
   * Constructs a <code>Iccv1tokensAssuranceData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Iccv1tokensAssuranceData} obj Optional instance to populate.
   * @return {module:model/Iccv1tokensAssuranceData} The populated <code>Iccv1tokensAssuranceData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('authenticationContext')) {
        obj['authenticationContext'] = Iccv1tokensAuthenticationContext.constructFromObject(data['authenticationContext']);
      }
      if (data.hasOwnProperty('authenticatedIdentities')) {
        obj['authenticatedIdentities'] = Iccv1tokensAuthenticatedIdentities.constructFromObject(data['authenticatedIdentities']);
      }
  ...
  /**
   * @member {module:model/Iccv1tokensAuthenticationContext} authenticationContext
   */
  exports.prototype['authenticationContext'] = undefined;
  /**
   * @member {module:model/Iccv1tokensAuthenticatedIdentities} authenticatedIdentities
   */
