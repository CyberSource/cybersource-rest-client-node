...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformation = factory(root.CyberSource.ApiClient, root.CyberSource.Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService);
  }
}(this, function(ApiClient, Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService) {
  'use strict';
  ...
  /**
   * The Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformation model module.
   * @module model/Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformation</code>.
   * @alias module:model/Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformation} obj Optional instance to populate.
   * @return {module:model/Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformation} The populated <code>Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformation</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('service')) {
        obj['service'] = ApiClient.convertToType(data['service'], [Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/Ptsv2paymentsidrefundsTravelInformationTransitAirlineAncillaryInformationService>} service
   */
