...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse20016OrderInformationCurrencyConversionOffer = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse20016OrderInformationCurrencyConversionOffer model module.
   * @module model/InlineResponse20016OrderInformationCurrencyConversionOffer
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse20016OrderInformationCurrencyConversionOffer</code>.
   * @alias module:model/InlineResponse20016OrderInformationCurrencyConversionOffer
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse20016OrderInformationCurrencyConversionOffer</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20016OrderInformationCurrencyConversionOffer} obj Optional instance to populate.
   * @return {module:model/InlineResponse20016OrderInformationCurrencyConversionOffer} The populated <code>InlineResponse20016OrderInformationCurrencyConversionOffer</code> instance.
   */
