...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2007LinksReport', 'model/InlineResponse202LinksStatus'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2007LinksReport'), require('./InlineResponse202LinksStatus'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse2007Links = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse2007LinksReport, root.CyberSource.InlineResponse202LinksStatus);
  }
}(this, function(ApiClient, InlineResponse2007LinksReport, InlineResponse202LinksStatus) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('report')) {
        obj['report'] = ApiClient.convertToType(data['report'], [InlineResponse2007LinksReport]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/InlineResponse2007LinksReport>} report
   */
