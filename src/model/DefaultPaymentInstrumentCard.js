...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DefaultPaymentInstrumentCardTokenizedInformation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DefaultPaymentInstrumentCardTokenizedInformation'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.DefaultPaymentInstrumentCard = factory(root.CyberSource.ApiClient, root.CyberSource.DefaultPaymentInstrumentCardTokenizedInformation);
  }
}(this, function(ApiClient, DefaultPaymentInstrumentCardTokenizedInformation) {
  'use strict';
  ...
  /**
   * The DefaultPaymentInstrumentCard model module.
   * @module model/DefaultPaymentInstrumentCard
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>DefaultPaymentInstrumentCard</code>.
   * @alias module:model/DefaultPaymentInstrumentCard
   * @class
   */
  ...
  /**
   * Constructs a <code>DefaultPaymentInstrumentCard</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DefaultPaymentInstrumentCard} obj Optional instance to populate.
   * @return {module:model/DefaultPaymentInstrumentCard} The populated <code>DefaultPaymentInstrumentCard</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('tokenizedInformation')) {
        obj['tokenizedInformation'] = DefaultPaymentInstrumentCardTokenizedInformation.constructFromObject(data['tokenizedInformation']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/DefaultPaymentInstrumentCardTokenizedInformation} tokenizedInformation
   */
