...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.VirtualTerminalGlobalPaymentSettingsMerchantDefinedDataFields = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The VirtualTerminalGlobalPaymentSettingsMerchantDefinedDataFields model module.
   * @module model/VirtualTerminalGlobalPaymentSettingsMerchantDefinedDataFields
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>VirtualTerminalGlobalPaymentSettingsMerchantDefinedDataFields</code>.
   * @alias module:model/VirtualTerminalGlobalPaymentSettingsMerchantDefinedDataFields
   * @class
   */
  ...
  /**
   * Constructs a <code>VirtualTerminalGlobalPaymentSettingsMerchantDefinedDataFields</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VirtualTerminalGlobalPaymentSettingsMerchantDefinedDataFields} obj Optional instance to populate.
   * @return {module:model/VirtualTerminalGlobalPaymentSettingsMerchantDefinedDataFields} The populated <code>VirtualTerminalGlobalPaymentSettingsMerchantDefinedDataFields</code> instance.
   */
