...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse201OrderInformationShipTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse201OrderInformationShipTo model module.
   * @module model/InlineResponse201OrderInformationShipTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse201OrderInformationShipTo</code>.
   * @alias module:model/InlineResponse201OrderInformationShipTo
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse201OrderInformationShipTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse201OrderInformationShipTo} obj Optional instance to populate.
   * @return {module:model/InlineResponse201OrderInformationShipTo} The populated <code>InlineResponse201OrderInformationShipTo</code> instance.
   */
