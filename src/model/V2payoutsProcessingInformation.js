...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V2payoutsProcessingInformationPayoutsOptions'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V2payoutsProcessingInformationPayoutsOptions'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.V2payoutsProcessingInformation = factory(root.CyberSource.ApiClient, root.CyberSource.V2payoutsProcessingInformationPayoutsOptions);
  }
}(this, function(ApiClient, V2payoutsProcessingInformationPayoutsOptions) {
  'use strict';
  ...
  /**
   * The V2payoutsProcessingInformation model module.
   * @module model/V2payoutsProcessingInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2payoutsProcessingInformation</code>.
   * @alias module:model/V2payoutsProcessingInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>V2payoutsProcessingInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2payoutsProcessingInformation} obj Optional instance to populate.
   * @return {module:model/V2payoutsProcessingInformation} The populated <code>V2payoutsProcessingInformation</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('payoutsOptions')) {
        obj['payoutsOptions'] = V2payoutsProcessingInformationPayoutsOptions.constructFromObject(data['payoutsOptions']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/V2payoutsProcessingInformationPayoutsOptions} payoutsOptions
   */
