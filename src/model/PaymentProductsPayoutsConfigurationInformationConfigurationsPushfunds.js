...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PaymentProductsPayoutsConfigurationInformationConfigurationsProcessorAccount'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PaymentProductsPayoutsConfigurationInformationConfigurationsProcessorAccount'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds = factory(root.CyberSource.ApiClient, root.CyberSource.PaymentProductsPayoutsConfigurationInformationConfigurationsProcessorAccount);
  }
}(this, function(ApiClient, PaymentProductsPayoutsConfigurationInformationConfigurationsProcessorAccount) {
  'use strict';
  ...
  /**
   * The PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds model module.
   * @module model/PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds</code>.
   ...
   * @alias module:model/PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds
   * @class
   * @param acquirerCountryCode {Number} TBD
   * @param acquiringBIN {Number} TBD
   * @param originatorBusinessApplicationId {String} TBD
   * @param processorAccount {Array.<module:model/PaymentProductsPayoutsConfigurationInformationConfigurationsProcessorAccount>} TBD
   */
  ...
  /**
   * Constructs a <code>PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds} obj Optional instance to populate.
   * @return {module:model/PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds} The populated <code>PaymentProductsPayoutsConfigurationInformationConfigurationsPushfunds</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('processorAccount')) {
        obj['processorAccount'] = ApiClient.convertToType(data['processorAccount'], [PaymentProductsPayoutsConfigurationInformationConfigurationsProcessorAccount]);
      }
    }
    return obj;
  }
  ...
  /**
   * TBD
   * @member {Array.<module:model/PaymentProductsPayoutsConfigurationInformationConfigurationsProcessorAccount>} processorAccount
   */
