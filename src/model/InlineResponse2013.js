...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2013PayoutInformation', 'model/TmsBinLookupIssuerInformation', 'model/TmsBinLookupPaymentAccountInformation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2013PayoutInformation'), require('./TmsBinLookupIssuerInformation'), require('./TmsBinLookupPaymentAccountInformation'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse2013 = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse2013PayoutInformation, root.CyberSource.TmsBinLookupIssuerInformation, root.CyberSource.TmsBinLookupPaymentAccountInformation);
  }
}(this, function(ApiClient, InlineResponse2013PayoutInformation, TmsBinLookupIssuerInformation, TmsBinLookupPaymentAccountInformation) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('payoutInformation')) {
        obj['payoutInformation'] = InlineResponse2013PayoutInformation.constructFromObject(data['payoutInformation']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse2013PayoutInformation} payoutInformation
   */
