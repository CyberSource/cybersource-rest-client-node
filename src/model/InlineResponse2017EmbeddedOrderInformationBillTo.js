...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse2017EmbeddedOrderInformationBillTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse2017EmbeddedOrderInformationBillTo model module.
   * @module model/InlineResponse2017EmbeddedOrderInformationBillTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2017EmbeddedOrderInformationBillTo</code>.
   * @alias module:model/InlineResponse2017EmbeddedOrderInformationBillTo
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2017EmbeddedOrderInformationBillTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2017EmbeddedOrderInformationBillTo} obj Optional instance to populate.
   * @return {module:model/InlineResponse2017EmbeddedOrderInformationBillTo} The populated <code>InlineResponse2017EmbeddedOrderInformationBillTo</code> instance.
   */
