...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.V2paymentsOrderInformationInvoiceDetails = factory(root.CyberSource.ApiClient, root.CyberSource.V2paymentsOrderInformationInvoiceDetailsTransactionAdviceAddendum);
  }
  ...
  /**
   * The V2paymentsOrderInformationInvoiceDetails model module.
   * @module model/V2paymentsOrderInformationInvoiceDetails
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2paymentsOrderInformationInvoiceDetails</code>.
   * @alias module:model/V2paymentsOrderInformationInvoiceDetails
   * @class
   */
  ...
  /**
   * Constructs a <code>V2paymentsOrderInformationInvoiceDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2paymentsOrderInformationInvoiceDetails} obj Optional instance to populate.
   * @return {module:model/V2paymentsOrderInformationInvoiceDetails} The populated <code>V2paymentsOrderInformationInvoiceDetails</code> instance.
   */
