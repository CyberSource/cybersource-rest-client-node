...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.DefaultShippingAddressShipTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The DefaultShippingAddressShipTo model module.
   * @module model/DefaultShippingAddressShipTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>DefaultShippingAddressShipTo</code>.
   * @alias module:model/DefaultShippingAddressShipTo
   * @class
   */
  ...
  /**
   * Constructs a <code>DefaultShippingAddressShipTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DefaultShippingAddressShipTo} obj Optional instance to populate.
   * @return {module:model/DefaultShippingAddressShipTo} The populated <code>DefaultShippingAddressShipTo</code> instance.
   */
