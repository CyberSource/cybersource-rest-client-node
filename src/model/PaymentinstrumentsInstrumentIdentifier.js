...
(function(root, factory) {
  ...
  /**
   * The PaymentinstrumentsInstrumentIdentifier model module.
   * @module model/PaymentinstrumentsInstrumentIdentifier
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PaymentinstrumentsInstrumentIdentifier</code>.
   * @alias module:model/PaymentinstrumentsInstrumentIdentifier
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentinstrumentsInstrumentIdentifier</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentinstrumentsInstrumentIdentifier} obj Optional instance to populate.
   * @return {module:model/PaymentinstrumentsInstrumentIdentifier} The populated <code>PaymentinstrumentsInstrumentIdentifier</code> instance.
   */
   ...
   * @member {module:model/PaymentinstrumentsInstrumentIdentifier.ObjectEnum} object
   */
  exports.prototype['object'] = undefined;
  /**
   * Current state of the token.
   * @member {module:model/PaymentinstrumentsInstrumentIdentifier.StateEnum} state
   */
