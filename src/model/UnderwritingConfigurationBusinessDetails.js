...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/UnderwritingConfigurationBusinessDetailsProductServicesSubscription'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./UnderwritingConfigurationBusinessDetailsProductServicesSubscription'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.UnderwritingConfigurationBusinessDetails = factory(root.CyberSource.ApiClient, root.CyberSource.UnderwritingConfigurationBusinessDetailsProductServicesSubscription);
  }
}(this, function(ApiClient, UnderwritingConfigurationBusinessDetailsProductServicesSubscription) {
  'use strict';
  ...
  /**
   * The UnderwritingConfigurationBusinessDetails model module.
   * @module model/UnderwritingConfigurationBusinessDetails
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>UnderwritingConfigurationBusinessDetails</code>.
   * @alias module:model/UnderwritingConfigurationBusinessDetails
   * @class
  ...
  /**
   * Constructs a <code>UnderwritingConfigurationBusinessDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UnderwritingConfigurationBusinessDetails} obj Optional instance to populate.
   * @return {module:model/UnderwritingConfigurationBusinessDetails} The populated <code>UnderwritingConfigurationBusinessDetails</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('productServicesSubscription')) {
        obj['productServicesSubscription'] = ApiClient.convertToType(data['productServicesSubscription'], [UnderwritingConfigurationBusinessDetailsProductServicesSubscription]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/UnderwritingConfigurationBusinessDetailsProductServicesSubscription>} productServicesSubscription
   */
