...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse2003KeyInformation = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse201ErrorInformation);
  }
  ...
  /**
   * The InlineResponse2003KeyInformation model module.
   * @module model/InlineResponse2003KeyInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2003KeyInformation</code>.
   * key information 
   * @alias module:model/InlineResponse2003KeyInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2003KeyInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2003KeyInformation} obj Optional instance to populate.
   * @return {module:model/InlineResponse2003KeyInformation} The populated <code>InlineResponse2003KeyInformation</code> instance.
   */
