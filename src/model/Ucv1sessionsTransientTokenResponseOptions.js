...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Ucv1sessionsTransientTokenResponseOptions = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Ucv1sessionsTransientTokenResponseOptions model module.
   * @module model/Ucv1sessionsTransientTokenResponseOptions
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ucv1sessionsTransientTokenResponseOptions</code>.
   * @alias module:model/Ucv1sessionsTransientTokenResponseOptions
   * @class
   */
  ...
  /**
   * Constructs a <code>Ucv1sessionsTransientTokenResponseOptions</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ucv1sessionsTransientTokenResponseOptions} obj Optional instance to populate.
   * @return {module:model/Ucv1sessionsTransientTokenResponseOptions} The populated <code>Ucv1sessionsTransientTokenResponseOptions</code> instance.
   */
