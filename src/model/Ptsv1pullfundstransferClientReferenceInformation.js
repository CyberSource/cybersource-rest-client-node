...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Ptsv1pullfundstransferClientReferenceInformation = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Ptsv1pullfundstransferClientReferenceInformation model module.
   * @module model/Ptsv1pullfundstransferClientReferenceInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ptsv1pullfundstransferClientReferenceInformation</code>.
   * @alias module:model/Ptsv1pullfundstransferClientReferenceInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>Ptsv1pullfundstransferClientReferenceInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv1pullfundstransferClientReferenceInformation} obj Optional instance to populate.
   * @return {module:model/Ptsv1pullfundstransferClientReferenceInformation} The populated <code>Ptsv1pullfundstransferClientReferenceInformation</code> instance.
   */
