...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2008EmbeddedLinks', 'model/InlineResponse2008EmbeddedTotals'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2008EmbeddedLinks'), require('./InlineResponse2008EmbeddedTotals'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse2008EmbeddedBatches = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse2008EmbeddedLinks, root.CyberSource.InlineResponse2008EmbeddedTotals);
  }
}(this, function(ApiClient, InlineResponse2008EmbeddedLinks, InlineResponse2008EmbeddedTotals) {
  'use strict';
  ...
  /**
   * The InlineResponse2008EmbeddedBatches model module.
   * @module model/InlineResponse2008EmbeddedBatches
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2008EmbeddedBatches</code>.
   * @alias module:model/InlineResponse2008EmbeddedBatches
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2008EmbeddedBatches</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2008EmbeddedBatches} obj Optional instance to populate.
   * @return {module:model/InlineResponse2008EmbeddedBatches} The populated <code>InlineResponse2008EmbeddedBatches</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('_links')) {
        obj['_links'] = InlineResponse2008EmbeddedLinks.constructFromObject(data['_links']);
      }
  ...
  /**
   * @member {module:model/InlineResponse2008EmbeddedLinks} _links
   */
