...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Riskv1authenticationexemptionsOrderInformationLineItems = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Riskv1authenticationexemptionsOrderInformationLineItems model module.
   * @module model/Riskv1authenticationexemptionsOrderInformationLineItems
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Riskv1authenticationexemptionsOrderInformationLineItems</code>.
   * @alias module:model/Riskv1authenticationexemptionsOrderInformationLineItems
   * @class
   */
  ...
  /**
   * Constructs a <code>Riskv1authenticationexemptionsOrderInformationLineItems</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Riskv1authenticationexemptionsOrderInformationLineItems} obj Optional instance to populate.
   * @return {module:model/Riskv1authenticationexemptionsOrderInformationLineItems} The populated <code>Riskv1authenticationexemptionsOrderInformationLineItems</code> instance.
   */
