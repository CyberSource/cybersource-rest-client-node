...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse2013PayoutInformationPushFunds = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse2013PayoutInformationPushFunds model module.
   * @module model/InlineResponse2013PayoutInformationPushFunds
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2013PayoutInformationPushFunds</code>.
   * @alias module:model/InlineResponse2013PayoutInformationPushFunds
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2013PayoutInformationPushFunds</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2013PayoutInformationPushFunds} obj Optional instance to populate.
   * @return {module:model/InlineResponse2013PayoutInformationPushFunds} The populated <code>InlineResponse2013PayoutInformationPushFunds</code> instance.
   */
