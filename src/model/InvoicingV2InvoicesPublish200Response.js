...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InvoicingV2InvoicesPublish200Response = factory(root.CyberSource.ApiClient, root.CyberSource.InvoicingV2InvoicesAllGet200ResponseLinks, root.CyberSource.InvoicingV2InvoicesPost201ResponseInvoiceInformation, root.CyberSource.InvoicingV2InvoicesPost201ResponseOrderInformation, root.CyberSource.Invoicingv2invoicesCustomerInformation, root.CyberSource.Invoicingv2invoicesProcessingInformation);
  }
  ...
  /**
   * The InvoicingV2InvoicesPublish200Response model module.
   * @module model/InvoicingV2InvoicesPublish200Response
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InvoicingV2InvoicesPublish200Response</code>.
   * @alias module:model/InvoicingV2InvoicesPublish200Response
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoicingV2InvoicesPublish200Response</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoicingV2InvoicesPublish200Response} obj Optional instance to populate.
   * @return {module:model/InvoicingV2InvoicesPublish200Response} The populated <code>InvoicingV2InvoicesPublish200Response</code> instance.
   */
