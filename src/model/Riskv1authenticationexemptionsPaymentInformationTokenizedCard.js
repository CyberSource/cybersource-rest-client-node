...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Riskv1authenticationexemptionsPaymentInformationTokenizedCard = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Riskv1authenticationexemptionsPaymentInformationTokenizedCard model module.
   * @module model/Riskv1authenticationexemptionsPaymentInformationTokenizedCard
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Riskv1authenticationexemptionsPaymentInformationTokenizedCard</code>.
   * @alias module:model/Riskv1authenticationexemptionsPaymentInformationTokenizedCard
   * @class
  ...
  /**
   * Constructs a <code>Riskv1authenticationexemptionsPaymentInformationTokenizedCard</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Riskv1authenticationexemptionsPaymentInformationTokenizedCard} obj Optional instance to populate.
   * @return {module:model/Riskv1authenticationexemptionsPaymentInformationTokenizedCard} The populated <code>Riskv1authenticationexemptionsPaymentInformationTokenizedCard</code> instance.
   */
