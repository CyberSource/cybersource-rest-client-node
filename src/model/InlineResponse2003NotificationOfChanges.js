...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse2003NotificationOfChanges = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse2003NotificationOfChanges model module.
   * @module model/InlineResponse2003NotificationOfChanges
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2003NotificationOfChanges</code>.
   * Notification Of Change
   * @alias module:model/InlineResponse2003NotificationOfChanges
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2003NotificationOfChanges</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2003NotificationOfChanges} obj Optional instance to populate.
   * @return {module:model/InlineResponse2003NotificationOfChanges} The populated <code>InlineResponse2003NotificationOfChanges</code> instance.
   */
