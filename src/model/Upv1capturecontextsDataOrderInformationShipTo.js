...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Upv1capturecontextsDataOrderInformationShipTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Upv1capturecontextsDataOrderInformationShipTo model module.
   * @module model/Upv1capturecontextsDataOrderInformationShipTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Upv1capturecontextsDataOrderInformationShipTo</code>.
   * @alias module:model/Upv1capturecontextsDataOrderInformationShipTo
   * @class
   */
  ...
  /**
   * Constructs a <code>Upv1capturecontextsDataOrderInformationShipTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Upv1capturecontextsDataOrderInformationShipTo} obj Optional instance to populate.
   * @return {module:model/Upv1capturecontextsDataOrderInformationShipTo} The populated <code>Upv1capturecontextsDataOrderInformationShipTo</code> instance.
   */
