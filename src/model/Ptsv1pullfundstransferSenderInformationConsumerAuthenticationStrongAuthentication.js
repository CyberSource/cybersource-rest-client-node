...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication model module.
   * @module model/Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication</code>.
   * @alias module:model/Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication
   * @class
   */
  ...
  /**
   * Constructs a <code>Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication} obj Optional instance to populate.
   * @return {module:model/Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication} The populated <code>Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication</code> instance.
   */
