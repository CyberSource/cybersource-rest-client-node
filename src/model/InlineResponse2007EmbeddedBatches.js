...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2007EmbeddedLinks', 'model/InlineResponse2007EmbeddedTotals'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2007EmbeddedLinks'), require('./InlineResponse2007EmbeddedTotals'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse2007EmbeddedBatches = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse2007EmbeddedLinks, root.CyberSource.InlineResponse2007EmbeddedTotals);
  }
}(this, function(ApiClient, InlineResponse2007EmbeddedLinks, InlineResponse2007EmbeddedTotals) {
  'use strict';
  ...
  /**
   * The InlineResponse2007EmbeddedBatches model module.
   * @module model/InlineResponse2007EmbeddedBatches
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2007EmbeddedBatches</code>.
   * @alias module:model/InlineResponse2007EmbeddedBatches
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2007EmbeddedBatches</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2007EmbeddedBatches} obj Optional instance to populate.
   * @return {module:model/InlineResponse2007EmbeddedBatches} The populated <code>InlineResponse2007EmbeddedBatches</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('_links')) {
        obj['_links'] = InlineResponse2007EmbeddedLinks.constructFromObject(data['_links']);
      }
  ...
  /**
   * @member {module:model/InlineResponse2007EmbeddedLinks} _links
   */
