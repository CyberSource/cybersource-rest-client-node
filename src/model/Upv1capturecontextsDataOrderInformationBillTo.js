...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Upv1capturecontextsDataOrderInformationBillToCompany'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Upv1capturecontextsDataOrderInformationBillToCompany'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.Upv1capturecontextsDataOrderInformationBillTo = factory(root.CyberSource.ApiClient, root.CyberSource.Upv1capturecontextsDataOrderInformationBillToCompany);
  }
}(this, function(ApiClient, Upv1capturecontextsDataOrderInformationBillToCompany) {
  'use strict';
  ...
  /**
   * The Upv1capturecontextsDataOrderInformationBillTo model module.
   * @module model/Upv1capturecontextsDataOrderInformationBillTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Upv1capturecontextsDataOrderInformationBillTo</code>.
   * @alias module:model/Upv1capturecontextsDataOrderInformationBillTo
   * @class
   */
  ...
  /**
   * Constructs a <code>Upv1capturecontextsDataOrderInformationBillTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Upv1capturecontextsDataOrderInformationBillTo} obj Optional instance to populate.
   * @return {module:model/Upv1capturecontextsDataOrderInformationBillTo} The populated <code>Upv1capturecontextsDataOrderInformationBillTo</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('company')) {
        obj['company'] = Upv1capturecontextsDataOrderInformationBillToCompany.constructFromObject(data['company']);
      }
  ...
  /**
   * @member {module:model/Upv1capturecontextsDataOrderInformationBillToCompany} company
   */
