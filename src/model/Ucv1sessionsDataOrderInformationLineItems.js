...
(function(root, factory) {
  ...
  /**
   * The Ucv1sessionsDataOrderInformationLineItems model module.
   * @module model/Ucv1sessionsDataOrderInformationLineItems
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ucv1sessionsDataOrderInformationLineItems</code>.
   * @alias module:model/Ucv1sessionsDataOrderInformationLineItems
   * @class
   */
  ...
  /**
   * Constructs a <code>Ucv1sessionsDataOrderInformationLineItems</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ucv1sessionsDataOrderInformationLineItems} obj Optional instance to populate.
   * @return {module:model/Ucv1sessionsDataOrderInformationLineItems} The populated <code>Ucv1sessionsDataOrderInformationLineItems</code> instance.
   */
