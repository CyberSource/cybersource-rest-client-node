...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse20010SourceRecord = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse20010SourceRecord model module.
   * @module model/InlineResponse20010SourceRecord
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse20010SourceRecord</code>.
   * @alias module:model/InlineResponse20010SourceRecord
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse20010SourceRecord</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20010SourceRecord} obj Optional instance to populate.
   * @return {module:model/InlineResponse20010SourceRecord} The populated <code>InlineResponse20010SourceRecord</code> instance.
   */
