...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.V2paymentsidcapturesProcessingInformationAuthorizationOptions = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The V2paymentsidcapturesProcessingInformationAuthorizationOptions model module.
   * @module model/V2paymentsidcapturesProcessingInformationAuthorizationOptions
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2paymentsidcapturesProcessingInformationAuthorizationOptions</code>.
   * @alias module:model/V2paymentsidcapturesProcessingInformationAuthorizationOptions
   * @class
   */
  ...
  /**
   * Constructs a <code>V2paymentsidcapturesProcessingInformationAuthorizationOptions</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2paymentsidcapturesProcessingInformationAuthorizationOptions} obj Optional instance to populate.
   * @return {module:model/V2paymentsidcapturesProcessingInformationAuthorizationOptions} The populated <code>V2paymentsidcapturesProcessingInformationAuthorizationOptions</code> instance.
   */
