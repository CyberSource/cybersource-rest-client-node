...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>TmsMerchantInformation</code>.
  ...
  /**
   * Constructs a <code>TmsMerchantInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TmsMerchantInformation} obj Optional instance to populate.
   * @return {module:model/TmsMerchantInformation} The populated <code>TmsMerchantInformation</code> instance.
   */
