...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.V2paymentsMerchantInformation = factory(root.CyberSource.ApiClient, root.CyberSource.V2paymentsMerchantInformationMerchantDescriptor);
  }
  ...
  /**
   * The V2paymentsMerchantInformation model module.
   * @module model/V2paymentsMerchantInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2paymentsMerchantInformation</code>.
   * @alias module:model/V2paymentsMerchantInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>V2paymentsMerchantInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2paymentsMerchantInformation} obj Optional instance to populate.
   * @return {module:model/V2paymentsMerchantInformation} The populated <code>V2paymentsMerchantInformation</code> instance.
   */
