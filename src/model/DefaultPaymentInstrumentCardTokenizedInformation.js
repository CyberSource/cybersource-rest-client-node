...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.DefaultPaymentInstrumentCardTokenizedInformation = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The DefaultPaymentInstrumentCardTokenizedInformation model module.
   * @module model/DefaultPaymentInstrumentCardTokenizedInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>DefaultPaymentInstrumentCardTokenizedInformation</code>.
   * @alias module:model/DefaultPaymentInstrumentCardTokenizedInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>DefaultPaymentInstrumentCardTokenizedInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DefaultPaymentInstrumentCardTokenizedInformation} obj Optional instance to populate.
   * @return {module:model/DefaultPaymentInstrumentCardTokenizedInformation} The populated <code>DefaultPaymentInstrumentCardTokenizedInformation</code> instance.
   */
