...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.AccountUpdaterConfigurationsMasterCard = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The AccountUpdaterConfigurationsMasterCard model module.
   * @module model/AccountUpdaterConfigurationsMasterCard
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>AccountUpdaterConfigurationsMasterCard</code>.
   * @alias module:model/AccountUpdaterConfigurationsMasterCard
   * @class
  ...
  /**
   * Constructs a <code>AccountUpdaterConfigurationsMasterCard</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AccountUpdaterConfigurationsMasterCard} obj Optional instance to populate.
   * @return {module:model/AccountUpdaterConfigurationsMasterCard} The populated <code>AccountUpdaterConfigurationsMasterCard</code> instance.
   */
