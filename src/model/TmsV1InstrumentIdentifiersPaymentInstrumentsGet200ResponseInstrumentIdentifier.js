...
(function(root, factory) {
  ...
  /**
   * The TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseInstrumentIdentifier model module.
   * @module model/TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseInstrumentIdentifier
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseInstrumentIdentifier</code>.
   * @alias module:model/TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseInstrumentIdentifier
   * @class
   */
  ...
  /**
   * Constructs a <code>TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseInstrumentIdentifier</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseInstrumentIdentifier} obj Optional instance to populate.
   * @return {module:model/TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseInstrumentIdentifier} The populated <code>TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseInstrumentIdentifier</code> instance.
   */
   ...
   * @member {module:model/TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseInstrumentIdentifier.ObjectEnum} object
   */
  exports.prototype['object'] = undefined;
  /**
   * Current state of the token.
   * @member {module:model/TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseInstrumentIdentifier.StateEnum} state
   */
