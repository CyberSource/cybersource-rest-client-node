...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Riskv1authenticationexemptionsPaymentInformationCard = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Riskv1authenticationexemptionsPaymentInformationCard model module.
   * @module model/Riskv1authenticationexemptionsPaymentInformationCard
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Riskv1authenticationexemptionsPaymentInformationCard</code>.
   * @alias module:model/Riskv1authenticationexemptionsPaymentInformationCard
   * @class
   * @param bin {String} description: The BIN is the first six digits of the card's Primary Account Number (PAN). 
   ...
   * @param _number {String} The customer’s payment card number, also known as the Primary Account Number (PAN). You can also use this field for encoded account numbers.  For processor-specific information, see the `customer_cc_number` field description in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html) 
   */
  var exports = function(bin, type, expirationMonth, expirationYear, _number) {
    var _this = this;
  ...
  /**
   * Constructs a <code>Riskv1authenticationexemptionsPaymentInformationCard</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Riskv1authenticationexemptionsPaymentInformationCard} obj Optional instance to populate.
   * @return {module:model/Riskv1authenticationexemptionsPaymentInformationCard} The populated <code>Riskv1authenticationexemptionsPaymentInformationCard</code> instance.
   */
