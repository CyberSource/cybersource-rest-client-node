...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse2002OrderInformationBillTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse2002OrderInformationBillTo model module.
   * @module model/InlineResponse2002OrderInformationBillTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2002OrderInformationBillTo</code>.
   * @alias module:model/InlineResponse2002OrderInformationBillTo
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2002OrderInformationBillTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2002OrderInformationBillTo} obj Optional instance to populate.
   * @return {module:model/InlineResponse2002OrderInformationBillTo} The populated <code>InlineResponse2002OrderInformationBillTo</code> instance.
   */
