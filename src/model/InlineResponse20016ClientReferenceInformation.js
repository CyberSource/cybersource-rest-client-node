...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse20016ClientReferenceInformation = factory(root.CyberSource.ApiClient, root.CyberSource.Riskv1decisionsClientReferenceInformationPartner);
  }
  ...
  /**
   * The InlineResponse20016ClientReferenceInformation model module.
   * @module model/InlineResponse20016ClientReferenceInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse20016ClientReferenceInformation</code>.
   * @alias module:model/InlineResponse20016ClientReferenceInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse20016ClientReferenceInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20016ClientReferenceInformation} obj Optional instance to populate.
   * @return {module:model/InlineResponse20016ClientReferenceInformation} The populated <code>InlineResponse20016ClientReferenceInformation</code> instance.
   */
