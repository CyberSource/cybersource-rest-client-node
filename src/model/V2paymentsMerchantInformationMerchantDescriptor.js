...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.V2paymentsMerchantInformationMerchantDescriptor = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The V2paymentsMerchantInformationMerchantDescriptor model module.
   * @module model/V2paymentsMerchantInformationMerchantDescriptor
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2paymentsMerchantInformationMerchantDescriptor</code>.
   * @alias module:model/V2paymentsMerchantInformationMerchantDescriptor
   * @class
   */
  ...
  /**
   * Constructs a <code>V2paymentsMerchantInformationMerchantDescriptor</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2paymentsMerchantInformationMerchantDescriptor} obj Optional instance to populate.
   * @return {module:model/V2paymentsMerchantInformationMerchantDescriptor} The populated <code>V2paymentsMerchantInformationMerchantDescriptor</code> instance.
   */
