...
(function(root, factory) {
  ...
  /**
   * The InlineResponse2005IntegrationInformation model module.
   * @module model/InlineResponse2005IntegrationInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2005IntegrationInformation</code>.
   * @alias module:model/InlineResponse2005IntegrationInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2005IntegrationInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2005IntegrationInformation} obj Optional instance to populate.
   * @return {module:model/InlineResponse2005IntegrationInformation} The populated <code>InlineResponse2005IntegrationInformation</code> instance.
   */
