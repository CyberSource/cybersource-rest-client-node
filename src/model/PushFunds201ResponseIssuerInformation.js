...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.PushFunds201ResponseIssuerInformation = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The PushFunds201ResponseIssuerInformation model module.
   * @module model/PushFunds201ResponseIssuerInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PushFunds201ResponseIssuerInformation</code>.
   * @alias module:model/PushFunds201ResponseIssuerInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>PushFunds201ResponseIssuerInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PushFunds201ResponseIssuerInformation} obj Optional instance to populate.
   * @return {module:model/PushFunds201ResponseIssuerInformation} The populated <code>PushFunds201ResponseIssuerInformation</code> instance.
   */
