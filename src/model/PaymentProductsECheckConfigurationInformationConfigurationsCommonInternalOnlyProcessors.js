...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.PaymentProductsECheckConfigurationInformationConfigurationsCommonInternalOnlyProcessors = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The PaymentProductsECheckConfigurationInformationConfigurationsCommonInternalOnlyProcessors model module.
   * @module model/PaymentProductsECheckConfigurationInformationConfigurationsCommonInternalOnlyProcessors
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PaymentProductsECheckConfigurationInformationConfigurationsCommonInternalOnlyProcessors</code>.
   * Name of the payment processor. Example - \&quot;wellsfargoach\&quot;
   * @alias module:model/PaymentProductsECheckConfigurationInformationConfigurationsCommonInternalOnlyProcessors
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentProductsECheckConfigurationInformationConfigurationsCommonInternalOnlyProcessors</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentProductsECheckConfigurationInformationConfigurationsCommonInternalOnlyProcessors} obj Optional instance to populate.
   * @return {module:model/PaymentProductsECheckConfigurationInformationConfigurationsCommonInternalOnlyProcessors} The populated <code>PaymentProductsECheckConfigurationInformationConfigurationsCommonInternalOnlyProcessors</code> instance.
   */
