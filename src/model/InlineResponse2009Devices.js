...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse2009Devices = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>InlineResponse2009Devices</code>.
  ...
  /**
   * Constructs a <code>InlineResponse2009Devices</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2009Devices} obj Optional instance to populate.
   * @return {module:model/InlineResponse2009Devices} The populated <code>InlineResponse2009Devices</code> instance.
   */
