...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.ShippingAddressPaginated = factory(root.CyberSource.ApiClient, root.CyberSource.ShippingAddressListForCustomerEmbedded, root.CyberSource.ShippingAddressListForCustomerLinks);
  }
  ...
  /**
   * The ShippingAddressPaginated model module.
   * @module model/ShippingAddressPaginated
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>ShippingAddressPaginated</code>.
   * A paginated container of Shipping Addresses. 
   * @alias module:model/ShippingAddressPaginated
   * @class
   */
  ...
  /**
   * Constructs a <code>ShippingAddressPaginated</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ShippingAddressPaginated} obj Optional instance to populate.
   * @return {module:model/ShippingAddressPaginated} The populated <code>ShippingAddressPaginated</code> instance.
   */
