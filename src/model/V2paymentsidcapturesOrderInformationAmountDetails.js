...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts', 'model/V2paymentsOrderInformationAmountDetailsTaxDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts'), require('./V2paymentsOrderInformationAmountDetailsTaxDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.V2paymentsidcapturesOrderInformationAmountDetails = factory(root.CyberSource.ApiClient, root.CyberSource.V2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts, root.CyberSource.V2paymentsOrderInformationAmountDetailsTaxDetails);
  }
}(this, function(ApiClient, V2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts, V2paymentsOrderInformationAmountDetailsTaxDetails) {
  'use strict';
  ...
  /**
   * The V2paymentsidcapturesOrderInformationAmountDetails model module.
   * @module model/V2paymentsidcapturesOrderInformationAmountDetails
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2paymentsidcapturesOrderInformationAmountDetails</code>.
   * @alias module:model/V2paymentsidcapturesOrderInformationAmountDetails
   * @class
   */
  ...
  /**
   * Constructs a <code>V2paymentsidcapturesOrderInformationAmountDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2paymentsidcapturesOrderInformationAmountDetails} obj Optional instance to populate.
   * @return {module:model/V2paymentsidcapturesOrderInformationAmountDetails} The populated <code>V2paymentsidcapturesOrderInformationAmountDetails</code> instance.
   */
