...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.V2paymentsBuyerInformation = factory(root.CyberSource.ApiClient, root.CyberSource.V2paymentsBuyerInformationPersonalIdentification);
  }
  ...
  /**
   * The V2paymentsBuyerInformation model module.
   * @module model/V2paymentsBuyerInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2paymentsBuyerInformation</code>.
   * @alias module:model/V2paymentsBuyerInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>V2paymentsBuyerInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2paymentsBuyerInformation} obj Optional instance to populate.
   * @return {module:model/V2paymentsBuyerInformation} The populated <code>V2paymentsBuyerInformation</code> instance.
   */
