...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.GetAllSubscriptionsResponseOrderInformationAmountDetails = factory(root.CyberSource.ApiClient, root.CyberSource.GetAllSubscriptionsResponseOrderInformationAmountDetailsSurcharge);
  }
  ...
  /**
   * The GetAllSubscriptionsResponseOrderInformationAmountDetails model module.
   * @module model/GetAllSubscriptionsResponseOrderInformationAmountDetails
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>GetAllSubscriptionsResponseOrderInformationAmountDetails</code>.
   * @alias module:model/GetAllSubscriptionsResponseOrderInformationAmountDetails
   * @class
   */
  ...
  /**
   * Constructs a <code>GetAllSubscriptionsResponseOrderInformationAmountDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetAllSubscriptionsResponseOrderInformationAmountDetails} obj Optional instance to populate.
   * @return {module:model/GetAllSubscriptionsResponseOrderInformationAmountDetails} The populated <code>GetAllSubscriptionsResponseOrderInformationAmountDetails</code> instance.
   */
