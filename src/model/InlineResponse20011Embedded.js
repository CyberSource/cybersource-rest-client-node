...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>InlineResponse20011Embedded</code>.
  ...
  /**
   * Constructs a <code>InlineResponse20011Embedded</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20011Embedded} obj Optional instance to populate.
   * @return {module:model/InlineResponse20011Embedded} The populated <code>InlineResponse20011Embedded</code> instance.
   */
  ...
  /**
   * @member {Array.<module:model/InlineResponse20011EmbeddedBatches>} batches
   */
