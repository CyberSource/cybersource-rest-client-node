...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.V2paymentsidrefundsMerchantInformation = factory(root.CyberSource.ApiClient, root.CyberSource.V2paymentsMerchantInformationMerchantDescriptor);
  }
  ...
  /**
   * The V2paymentsidrefundsMerchantInformation model module.
   * @module model/V2paymentsidrefundsMerchantInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2paymentsidrefundsMerchantInformation</code>.
   * @alias module:model/V2paymentsidrefundsMerchantInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>V2paymentsidrefundsMerchantInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2paymentsidrefundsMerchantInformation} obj Optional instance to populate.
   * @return {module:model/V2paymentsidrefundsMerchantInformation} The populated <code>V2paymentsidrefundsMerchantInformation</code> instance.
   */
