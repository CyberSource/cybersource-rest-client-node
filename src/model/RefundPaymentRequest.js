...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('travelInformation')) {
        obj['travelInformation'] = Ptsv2paymentsidrefundsTravelInformation.constructFromObject(data['travelInformation']);
      }
  ...
  /**
   * @member {module:model/Ptsv2paymentsidrefundsTravelInformation} travelInformation
   */
