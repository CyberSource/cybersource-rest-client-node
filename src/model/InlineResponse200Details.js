...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>InlineResponse200Details</code>.
  ...
  /**
   * Constructs a <code>InlineResponse200Details</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse200Details} obj Optional instance to populate.
   * @return {module:model/InlineResponse200Details} The populated <code>InlineResponse200Details</code> instance.
   */
