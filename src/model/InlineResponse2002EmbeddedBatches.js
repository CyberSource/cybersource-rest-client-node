...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2002EmbeddedLinks', 'model/InlineResponse2002EmbeddedTotals'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2002EmbeddedLinks'), require('./InlineResponse2002EmbeddedTotals'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse2002EmbeddedBatches = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse2002EmbeddedLinks, root.CyberSource.InlineResponse2002EmbeddedTotals);
  }
}(this, function(ApiClient, InlineResponse2002EmbeddedLinks, InlineResponse2002EmbeddedTotals) {
  'use strict';
  ...
  /**
   * The InlineResponse2002EmbeddedBatches model module.
   * @module model/InlineResponse2002EmbeddedBatches
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2002EmbeddedBatches</code>.
   * @alias module:model/InlineResponse2002EmbeddedBatches
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2002EmbeddedBatches</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2002EmbeddedBatches} obj Optional instance to populate.
   * @return {module:model/InlineResponse2002EmbeddedBatches} The populated <code>InlineResponse2002EmbeddedBatches</code> instance.
   */
