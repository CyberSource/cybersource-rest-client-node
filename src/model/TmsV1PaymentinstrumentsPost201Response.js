...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TmsV1PaymentinstrumentsPost201ResponseCard', 'model/Tmsv1instrumentidentifiersLinks', 'model/Tmsv1instrumentidentifiersMetadata', 'model/Tmsv1paymentinstrumentsBankAccount', 'model/Tmsv1paymentinstrumentsBillTo', 'model/Tmsv1paymentinstrumentsBuyerInformation', 'model/Tmsv1paymentinstrumentsInstrumentIdentifier', 'model/Tmsv1paymentinstrumentsMerchantInformation', 'model/Tmsv1paymentinstrumentsProcessingInformation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TmsV1PaymentinstrumentsPost201ResponseCard'), require('./Tmsv1instrumentidentifiersLinks'), require('./Tmsv1instrumentidentifiersMetadata'), require('./Tmsv1paymentinstrumentsBankAccount'), require('./Tmsv1paymentinstrumentsBillTo'), require('./Tmsv1paymentinstrumentsBuyerInformation'), require('./Tmsv1paymentinstrumentsInstrumentIdentifier'), require('./Tmsv1paymentinstrumentsMerchantInformation'), require('./Tmsv1paymentinstrumentsProcessingInformation'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.TmsV1PaymentinstrumentsPost201Response = factory(root.CyberSource.ApiClient, root.CyberSource.TmsV1PaymentinstrumentsPost201ResponseCard, root.CyberSource.Tmsv1instrumentidentifiersLinks, root.CyberSource.Tmsv1instrumentidentifiersMetadata, root.CyberSource.Tmsv1paymentinstrumentsBankAccount, root.CyberSource.Tmsv1paymentinstrumentsBillTo, root.CyberSource.Tmsv1paymentinstrumentsBuyerInformation, root.CyberSource.Tmsv1paymentinstrumentsInstrumentIdentifier, root.CyberSource.Tmsv1paymentinstrumentsMerchantInformation, root.CyberSource.Tmsv1paymentinstrumentsProcessingInformation);
  }
}(this, function(ApiClient, TmsV1PaymentinstrumentsPost201ResponseCard, Tmsv1instrumentidentifiersLinks, Tmsv1instrumentidentifiersMetadata, Tmsv1paymentinstrumentsBankAccount, Tmsv1paymentinstrumentsBillTo, Tmsv1paymentinstrumentsBuyerInformation, Tmsv1paymentinstrumentsInstrumentIdentifier, Tmsv1paymentinstrumentsMerchantInformation, Tmsv1paymentinstrumentsProcessingInformation) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('card')) {
        obj['card'] = TmsV1PaymentinstrumentsPost201ResponseCard.constructFromObject(data['card']);
      }
  ...
  /**
   * @member {module:model/TmsV1PaymentinstrumentsPost201ResponseCard} card
   */
