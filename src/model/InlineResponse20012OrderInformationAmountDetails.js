...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse20012OrderInformationAmountDetails = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse20012OrderInformationAmountDetails model module.
   * @module model/InlineResponse20012OrderInformationAmountDetails
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse20012OrderInformationAmountDetails</code>.
   * @alias module:model/InlineResponse20012OrderInformationAmountDetails
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse20012OrderInformationAmountDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20012OrderInformationAmountDetails} obj Optional instance to populate.
   * @return {module:model/InlineResponse20012OrderInformationAmountDetails} The populated <code>InlineResponse20012OrderInformationAmountDetails</code> instance.
   */
