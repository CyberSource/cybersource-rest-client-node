...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Iplv2paymentlinksOrderInformationAmountDetails = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Iplv2paymentlinksOrderInformationAmountDetails model module.
   * @module model/Iplv2paymentlinksOrderInformationAmountDetails
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Iplv2paymentlinksOrderInformationAmountDetails</code>.
   * Contains all of the amount-related fields.
   * @alias module:model/Iplv2paymentlinksOrderInformationAmountDetails
   * @class
  ...
  /**
   * Constructs a <code>Iplv2paymentlinksOrderInformationAmountDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Iplv2paymentlinksOrderInformationAmountDetails} obj Optional instance to populate.
   * @return {module:model/Iplv2paymentlinksOrderInformationAmountDetails} The populated <code>Iplv2paymentlinksOrderInformationAmountDetails</code> instance.
   */
