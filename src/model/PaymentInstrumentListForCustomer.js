...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.PaymentInstrumentListForCustomer = factory(root.CyberSource.ApiClient, root.CyberSource.PaymentInstrumentListForCustomerEmbedded, root.CyberSource.PaymentInstrumentListForCustomerLinks);
  }
  ...
  /**
   * The PaymentInstrumentListForCustomer model module.
   * @module model/PaymentInstrumentListForCustomer
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PaymentInstrumentListForCustomer</code>.
   * @alias module:model/PaymentInstrumentListForCustomer
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentInstrumentListForCustomer</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentInstrumentListForCustomer} obj Optional instance to populate.
   * @return {module:model/PaymentInstrumentListForCustomer} The populated <code>PaymentInstrumentListForCustomer</code> instance.
   */
