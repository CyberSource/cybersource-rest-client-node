...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Tmsv2tokenizedcardsCard = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Tmsv2tokenizedcardsCard model module.
   * @module model/Tmsv2tokenizedcardsCard
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Tmsv2tokenizedcardsCard</code>.
   * @alias module:model/Tmsv2tokenizedcardsCard
   * @class
   */
  ...
  /**
   * Constructs a <code>Tmsv2tokenizedcardsCard</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Tmsv2tokenizedcardsCard} obj Optional instance to populate.
   * @return {module:model/Tmsv2tokenizedcardsCard} The populated <code>Tmsv2tokenizedcardsCard</code> instance.
   */
