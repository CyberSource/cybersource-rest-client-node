...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Upv1capturecontextsDataOrderInformationBillToCompany = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Upv1capturecontextsDataOrderInformationBillToCompany model module.
   * @module model/Upv1capturecontextsDataOrderInformationBillToCompany
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Upv1capturecontextsDataOrderInformationBillToCompany</code>.
   * @alias module:model/Upv1capturecontextsDataOrderInformationBillToCompany
   * @class
   */
  ...
  /**
   * Constructs a <code>Upv1capturecontextsDataOrderInformationBillToCompany</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Upv1capturecontextsDataOrderInformationBillToCompany} obj Optional instance to populate.
   * @return {module:model/Upv1capturecontextsDataOrderInformationBillToCompany} The populated <code>Upv1capturecontextsDataOrderInformationBillToCompany</code> instance.
   */
