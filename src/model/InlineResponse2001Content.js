...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>InlineResponse2001Content</code>.
  ...
  /**
   * Constructs a <code>InlineResponse2001Content</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2001Content} obj Optional instance to populate.
   * @return {module:model/InlineResponse2001Content} The populated <code>InlineResponse2001Content</code> instance.
   */
