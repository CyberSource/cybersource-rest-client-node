...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Ucv1sessionsDataOrderInformationBillToCompany'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Ucv1sessionsDataOrderInformationBillToCompany'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.Ucv1sessionsDataOrderInformationBillTo = factory(root.CyberSource.ApiClient, root.CyberSource.Ucv1sessionsDataOrderInformationBillToCompany);
  }
}(this, function(ApiClient, Ucv1sessionsDataOrderInformationBillToCompany) {
  'use strict';
  ...
  /**
   * The Ucv1sessionsDataOrderInformationBillTo model module.
   * @module model/Ucv1sessionsDataOrderInformationBillTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ucv1sessionsDataOrderInformationBillTo</code>.
   * @alias module:model/Ucv1sessionsDataOrderInformationBillTo
   * @class
   */
  ...
  /**
   * Constructs a <code>Ucv1sessionsDataOrderInformationBillTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ucv1sessionsDataOrderInformationBillTo} obj Optional instance to populate.
   * @return {module:model/Ucv1sessionsDataOrderInformationBillTo} The populated <code>Ucv1sessionsDataOrderInformationBillTo</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('company')) {
        obj['company'] = Ucv1sessionsDataOrderInformationBillToCompany.constructFromObject(data['company']);
      }
  ...
  /**
   * @member {module:model/Ucv1sessionsDataOrderInformationBillToCompany} company
   */
