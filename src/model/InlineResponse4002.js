...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse4002 = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse201ErrorInformationDetails);
  }
   ...
   * @member {module:model/InlineResponse4002.StatusEnum} status
   */
  exports.prototype['status'] = undefined;
  /**
   * The reason of the status. 
   * @member {module:model/InlineResponse4002.ReasonEnum} reason
   */
