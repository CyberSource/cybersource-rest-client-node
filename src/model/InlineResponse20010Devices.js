...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>InlineResponse20010Devices</code>.
  ...
  /**
   * Constructs a <code>InlineResponse20010Devices</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20010Devices} obj Optional instance to populate.
   * @return {module:model/InlineResponse20010Devices} The populated <code>InlineResponse20010Devices</code> instance.
   */
