...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('unscheduledPaymentInformation')) {
        obj['unscheduledPaymentInformation'] = TssV2TransactionsGet200ResponseUnscheduledPaymentInformation.constructFromObject(data['unscheduledPaymentInformation']);
      }
  ...
  /**
   * @member {module:model/TssV2TransactionsGet200ResponseUnscheduledPaymentInformation} unscheduledPaymentInformation
   */
