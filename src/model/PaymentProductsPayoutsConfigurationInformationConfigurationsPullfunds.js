...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds model module.
   * @module model/PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds</code>.
   ...
   * @alias module:model/PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds
   * @class
  ...
  /**
   * Constructs a <code>PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds} obj Optional instance to populate.
   * @return {module:model/PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds} The populated <code>PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds</code> instance.
   */
