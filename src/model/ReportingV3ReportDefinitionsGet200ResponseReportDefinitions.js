...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ReportDefinitionDefaultSettings'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ReportDefinitionDefaultSettings'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.ReportingV3ReportDefinitionsGet200ResponseReportDefinitions = factory(root.CyberSource.ApiClient, root.CyberSource.ReportDefinitionDefaultSettings);
  }
}(this, function(ApiClient, ReportDefinitionDefaultSettings) {
  'use strict';
