...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Vasv2taxClientReferenceInformationPartner = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Vasv2taxClientReferenceInformationPartner model module.
   * @module model/Vasv2taxClientReferenceInformationPartner
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Vasv2taxClientReferenceInformationPartner</code>.
   * @alias module:model/Vasv2taxClientReferenceInformationPartner
   * @class
   */
  ...
  /**
   * Constructs a <code>Vasv2taxClientReferenceInformationPartner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Vasv2taxClientReferenceInformationPartner} obj Optional instance to populate.
   * @return {module:model/Vasv2taxClientReferenceInformationPartner} The populated <code>Vasv2taxClientReferenceInformationPartner</code> instance.
   */
