...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20011Links'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse20011Links'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse20011 = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse20011Links);
  }
}(this, function(ApiClient, InlineResponse20011Links) {
  'use strict';
   ...
   * @member {module:model/InlineResponse20011.ObjectEnum} object
   */
