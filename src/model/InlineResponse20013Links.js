...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20013LinksReport', 'model/InlineResponse202LinksStatus'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse20013LinksReport'), require('./InlineResponse202LinksStatus'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse20013Links = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse20013LinksReport, root.CyberSource.InlineResponse202LinksStatus);
  }
}(this, function(ApiClient, InlineResponse20013LinksReport, InlineResponse202LinksStatus) {
  'use strict';
