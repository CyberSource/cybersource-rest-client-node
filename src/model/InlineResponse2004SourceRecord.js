...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse2004SourceRecord = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse2004SourceRecord model module.
   * @module model/InlineResponse2004SourceRecord
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2004SourceRecord</code>.
   * @alias module:model/InlineResponse2004SourceRecord
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2004SourceRecord</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2004SourceRecord} obj Optional instance to populate.
   * @return {module:model/InlineResponse2004SourceRecord} The populated <code>InlineResponse2004SourceRecord</code> instance.
   */
