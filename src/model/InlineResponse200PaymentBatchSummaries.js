...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse200PaymentBatchSummaries = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse200PaymentBatchSummaries model module.
   * @module model/InlineResponse200PaymentBatchSummaries
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse200PaymentBatchSummaries</code>.
  ...
  /**
   * Constructs a <code>InlineResponse200PaymentBatchSummaries</code> from a plain JavaScript object, optionally creating a new instance.
   ...
   * @return {module:model/InlineResponse200PaymentBatchSummaries} The populated <code>InlineResponse200PaymentBatchSummaries</code> instance.
   */
