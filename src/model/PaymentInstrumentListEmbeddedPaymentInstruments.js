...
(function(root, factory) {
  ...
  /**
   * The PaymentInstrumentListEmbeddedPaymentInstruments model module.
   * @module model/PaymentInstrumentListEmbeddedPaymentInstruments
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PaymentInstrumentListEmbeddedPaymentInstruments</code>.
   * @alias module:model/PaymentInstrumentListEmbeddedPaymentInstruments
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentInstrumentListEmbeddedPaymentInstruments</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentInstrumentListEmbeddedPaymentInstruments} obj Optional instance to populate.
   * @return {module:model/PaymentInstrumentListEmbeddedPaymentInstruments} The populated <code>PaymentInstrumentListEmbeddedPaymentInstruments</code> instance.
   */
