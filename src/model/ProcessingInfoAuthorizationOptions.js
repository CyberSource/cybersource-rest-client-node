...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ProcessingInfoAuthorizationOptionsInitiator'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ProcessingInfoAuthorizationOptionsInitiator'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.ProcessingInfoAuthorizationOptions = factory(root.CyberSource.ApiClient, root.CyberSource.ProcessingInfoAuthorizationOptionsInitiator);
  }
}(this, function(ApiClient, ProcessingInfoAuthorizationOptionsInitiator) {
  'use strict';
  ...
  /**
   * The ProcessingInfoAuthorizationOptions model module.
   * @module model/ProcessingInfoAuthorizationOptions
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>ProcessingInfoAuthorizationOptions</code>.
   * @alias module:model/ProcessingInfoAuthorizationOptions
   * @class
   */
  ...
  /**
   * Constructs a <code>ProcessingInfoAuthorizationOptions</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProcessingInfoAuthorizationOptions} obj Optional instance to populate.
   * @return {module:model/ProcessingInfoAuthorizationOptions} The populated <code>ProcessingInfoAuthorizationOptions</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('initiator')) {
        obj['initiator'] = ProcessingInfoAuthorizationOptionsInitiator.constructFromObject(data['initiator']);
      }
  ...
  /**
   * @member {module:model/ProcessingInfoAuthorizationOptionsInitiator} initiator
   */
