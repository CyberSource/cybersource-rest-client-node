...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse2002OrderInformationShipTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse2002OrderInformationShipTo model module.
   * @module model/InlineResponse2002OrderInformationShipTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2002OrderInformationShipTo</code>.
   * @alias module:model/InlineResponse2002OrderInformationShipTo
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2002OrderInformationShipTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2002OrderInformationShipTo} obj Optional instance to populate.
   * @return {module:model/InlineResponse2002OrderInformationShipTo} The populated <code>InlineResponse2002OrderInformationShipTo</code> instance.
   */
