...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.V2paymentsOrderInformationBillTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The V2paymentsOrderInformationBillTo model module.
   * @module model/V2paymentsOrderInformationBillTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2paymentsOrderInformationBillTo</code>.
   * @alias module:model/V2paymentsOrderInformationBillTo
   * @class
   */
  ...
  /**
   * Constructs a <code>V2paymentsOrderInformationBillTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2paymentsOrderInformationBillTo} obj Optional instance to populate.
   * @return {module:model/V2paymentsOrderInformationBillTo} The populated <code>V2paymentsOrderInformationBillTo</code> instance.
   */
   ...
   * @member {module:model/V2paymentsOrderInformationBillTo.PhoneTypeEnum} phoneType
   */
