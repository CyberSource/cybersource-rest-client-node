...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>InlineResponse2004IntegrationInformation</code>.
  ...
  /**
   * Constructs a <code>InlineResponse2004IntegrationInformation</code> from a plain JavaScript object, optionally creating a new instance.
   ...
   * @return {module:model/InlineResponse2004IntegrationInformation} The populated <code>InlineResponse2004IntegrationInformation</code> instance.
   */
   ...
   * @member {Array.<module:model/InlineResponse2004IntegrationInformationTenantConfigurations>} tenantConfigurations
   */
