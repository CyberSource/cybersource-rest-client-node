...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Ucv1sessionsDataAggregatorInformationSubMerchant'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Ucv1sessionsDataAggregatorInformationSubMerchant'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.Ucv1sessionsDataAggregatorInformation = factory(root.CyberSource.ApiClient, root.CyberSource.Ucv1sessionsDataAggregatorInformationSubMerchant);
  }
}(this, function(ApiClient, Ucv1sessionsDataAggregatorInformationSubMerchant) {
  'use strict';
  ...
  /**
   * The Ucv1sessionsDataAggregatorInformation model module.
   * @module model/Ucv1sessionsDataAggregatorInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ucv1sessionsDataAggregatorInformation</code>.
   * @alias module:model/Ucv1sessionsDataAggregatorInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>Ucv1sessionsDataAggregatorInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ucv1sessionsDataAggregatorInformation} obj Optional instance to populate.
   * @return {module:model/Ucv1sessionsDataAggregatorInformation} The populated <code>Ucv1sessionsDataAggregatorInformation</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('subMerchant')) {
        obj['subMerchant'] = Ucv1sessionsDataAggregatorInformationSubMerchant.constructFromObject(data['subMerchant']);
      }
  ...
  /**
   * @member {module:model/Ucv1sessionsDataAggregatorInformationSubMerchant} subMerchant
   */
