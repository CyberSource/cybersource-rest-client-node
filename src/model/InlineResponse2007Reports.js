...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse2007Reports = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse2007Reports model module.
   * @module model/InlineResponse2007Reports
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2007Reports</code>.
   * Report Search Result Bean
   * @alias module:model/InlineResponse2007Reports
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2007Reports</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2007Reports} obj Optional instance to populate.
   * @return {module:model/InlineResponse2007Reports} The populated <code>InlineResponse2007Reports</code> instance.
   */
   ...
   * @member {module:model/InlineResponse2007Reports.ReportMimeTypeEnum} reportMimeType
   */
  exports.prototype['reportMimeType'] = undefined;
  /**
   * Frequency of the report to get generated
   * @member {module:model/InlineResponse2007Reports.ReportFrequencyEnum} reportFrequency
   */
  exports.prototype['reportFrequency'] = undefined;
  /**
   * Status of the report
   * @member {module:model/InlineResponse2007Reports.StatusEnum} status
   */
