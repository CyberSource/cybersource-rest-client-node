...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Ucv1sessionsDataOrderInformationShippingDetails = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Ucv1sessionsDataOrderInformationShippingDetails model module.
   * @module model/Ucv1sessionsDataOrderInformationShippingDetails
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ucv1sessionsDataOrderInformationShippingDetails</code>.
   * @alias module:model/Ucv1sessionsDataOrderInformationShippingDetails
   * @class
   */
  ...
  /**
   * Constructs a <code>Ucv1sessionsDataOrderInformationShippingDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ucv1sessionsDataOrderInformationShippingDetails} obj Optional instance to populate.
   * @return {module:model/Ucv1sessionsDataOrderInformationShippingDetails} The populated <code>Ucv1sessionsDataOrderInformationShippingDetails</code> instance.
   */
