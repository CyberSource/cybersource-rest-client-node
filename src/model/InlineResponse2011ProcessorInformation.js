...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse2011ProcessorInformation = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse2011ProcessorInformation model module.
   * @module model/InlineResponse2011ProcessorInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2011ProcessorInformation</code>.
   * @alias module:model/InlineResponse2011ProcessorInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2011ProcessorInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2011ProcessorInformation} obj Optional instance to populate.
   * @return {module:model/InlineResponse2011ProcessorInformation} The populated <code>InlineResponse2011ProcessorInformation</code> instance.
   */
