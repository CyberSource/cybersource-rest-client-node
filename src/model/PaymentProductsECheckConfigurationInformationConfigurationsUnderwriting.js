...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.PaymentProductsECheckConfigurationInformationConfigurationsUnderwriting = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The PaymentProductsECheckConfigurationInformationConfigurationsUnderwriting model module.
   * @module model/PaymentProductsECheckConfigurationInformationConfigurationsUnderwriting
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PaymentProductsECheckConfigurationInformationConfigurationsUnderwriting</code>.
   * @alias module:model/PaymentProductsECheckConfigurationInformationConfigurationsUnderwriting
   * @class
  ...
  /**
   * Constructs a <code>PaymentProductsECheckConfigurationInformationConfigurationsUnderwriting</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentProductsECheckConfigurationInformationConfigurationsUnderwriting} obj Optional instance to populate.
   * @return {module:model/PaymentProductsECheckConfigurationInformationConfigurationsUnderwriting} The populated <code>PaymentProductsECheckConfigurationInformationConfigurationsUnderwriting</code> instance.
   */
