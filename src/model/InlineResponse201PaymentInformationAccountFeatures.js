...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse201PaymentInformationAccountFeatures = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse201PaymentInformationAccountFeatures model module.
   * @module model/InlineResponse201PaymentInformationAccountFeatures
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse201PaymentInformationAccountFeatures</code>.
   * @alias module:model/InlineResponse201PaymentInformationAccountFeatures
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse201PaymentInformationAccountFeatures</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse201PaymentInformationAccountFeatures} obj Optional instance to populate.
   * @return {module:model/InlineResponse201PaymentInformationAccountFeatures} The populated <code>InlineResponse201PaymentInformationAccountFeatures</code> instance.
   */
   ...
   * @member {module:model/InlineResponse201PaymentInformationAccountFeatures.BalanceSignEnum} balanceSign
   */
