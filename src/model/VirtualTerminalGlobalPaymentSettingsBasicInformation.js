...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.VirtualTerminalGlobalPaymentSettingsBasicInformation = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The VirtualTerminalGlobalPaymentSettingsBasicInformation model module.
   * @module model/VirtualTerminalGlobalPaymentSettingsBasicInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>VirtualTerminalGlobalPaymentSettingsBasicInformation</code>.
   * @alias module:model/VirtualTerminalGlobalPaymentSettingsBasicInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>VirtualTerminalGlobalPaymentSettingsBasicInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VirtualTerminalGlobalPaymentSettingsBasicInformation} obj Optional instance to populate.
   * @return {module:model/VirtualTerminalGlobalPaymentSettingsBasicInformation} The populated <code>VirtualTerminalGlobalPaymentSettingsBasicInformation</code> instance.
   */
