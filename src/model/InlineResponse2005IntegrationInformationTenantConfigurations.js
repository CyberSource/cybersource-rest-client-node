...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse2005IntegrationInformationTenantConfigurations = factory(root.CyberSource.ApiClient, root.CyberSource.Boardingv1registrationsIntegrationInformationTenantInformation);
  }
  ...
  /**
   * The InlineResponse2005IntegrationInformationTenantConfigurations model module.
   * @module model/InlineResponse2005IntegrationInformationTenantConfigurations
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2005IntegrationInformationTenantConfigurations</code>.
   * @alias module:model/InlineResponse2005IntegrationInformationTenantConfigurations
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2005IntegrationInformationTenantConfigurations</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2005IntegrationInformationTenantConfigurations} obj Optional instance to populate.
   * @return {module:model/InlineResponse2005IntegrationInformationTenantConfigurations} The populated <code>InlineResponse2005IntegrationInformationTenantConfigurations</code> instance.
   */
