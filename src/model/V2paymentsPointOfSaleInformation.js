...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V2paymentsPointOfSaleInformationEmv'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V2paymentsPointOfSaleInformationEmv'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.V2paymentsPointOfSaleInformation = factory(root.CyberSource.ApiClient, root.CyberSource.V2paymentsPointOfSaleInformationEmv);
  }
}(this, function(ApiClient, V2paymentsPointOfSaleInformationEmv) {
  'use strict';
  ...
  /**
   * The V2paymentsPointOfSaleInformation model module.
   * @module model/V2paymentsPointOfSaleInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2paymentsPointOfSaleInformation</code>.
   * @alias module:model/V2paymentsPointOfSaleInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>V2paymentsPointOfSaleInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2paymentsPointOfSaleInformation} obj Optional instance to populate.
   * @return {module:model/V2paymentsPointOfSaleInformation} The populated <code>V2paymentsPointOfSaleInformation</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('emv')) {
        obj['emv'] = V2paymentsPointOfSaleInformationEmv.constructFromObject(data['emv']);
      }
  ...
  /**
   * @member {module:model/V2paymentsPointOfSaleInformationEmv} emv
   */
