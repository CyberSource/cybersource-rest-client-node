...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.V2creditsProcessingInformation = factory(root.CyberSource.ApiClient, root.CyberSource.V2paymentsidrefundsProcessingInformationRecurringOptions);
  }
  ...
  /**
   * The V2creditsProcessingInformation model module.
   * @module model/V2creditsProcessingInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2creditsProcessingInformation</code>.
   * @alias module:model/V2creditsProcessingInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>V2creditsProcessingInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2creditsProcessingInformation} obj Optional instance to populate.
   * @return {module:model/V2creditsProcessingInformation} The populated <code>V2creditsProcessingInformation</code> instance.
   */
