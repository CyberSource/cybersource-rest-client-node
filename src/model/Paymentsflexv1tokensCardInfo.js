...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Paymentsflexv1tokensCardInfo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Paymentsflexv1tokensCardInfo model module.
   * @module model/Paymentsflexv1tokensCardInfo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Paymentsflexv1tokensCardInfo</code>.
   * @alias module:model/Paymentsflexv1tokensCardInfo
   * @class
   */
  ...
  /**
   * Constructs a <code>Paymentsflexv1tokensCardInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Paymentsflexv1tokensCardInfo} obj Optional instance to populate.
   * @return {module:model/Paymentsflexv1tokensCardInfo} The populated <code>Paymentsflexv1tokensCardInfo</code> instance.
   */
