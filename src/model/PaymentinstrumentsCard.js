...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.PaymentinstrumentsCard = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The PaymentinstrumentsCard model module.
   * @module model/PaymentinstrumentsCard
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PaymentinstrumentsCard</code>.
   * @alias module:model/PaymentinstrumentsCard
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentinstrumentsCard</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentinstrumentsCard} obj Optional instance to populate.
   * @return {module:model/PaymentinstrumentsCard} The populated <code>PaymentinstrumentsCard</code> instance.
   */
  ...
  /**
   * Credit card brand.
   * @member {module:model/PaymentinstrumentsCard.TypeEnum} type
   */
