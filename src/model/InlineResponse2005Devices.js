...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse2005Devices = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse2005Devices model module.
   * @module model/InlineResponse2005Devices
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2005Devices</code>.
   * @alias module:model/InlineResponse2005Devices
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2005Devices</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2005Devices} obj Optional instance to populate.
   * @return {module:model/InlineResponse2005Devices} The populated <code>InlineResponse2005Devices</code> instance.
   */
