...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>InlineResponse2003IntegrationInformation</code>.
  ...
  /**
   * Constructs a <code>InlineResponse2003IntegrationInformation</code> from a plain JavaScript object, optionally creating a new instance.
   ...
   * @return {module:model/InlineResponse2003IntegrationInformation} The populated <code>InlineResponse2003IntegrationInformation</code> instance.
   */
   ...
   * @member {Array.<module:model/InlineResponse2003IntegrationInformationTenantConfigurations>} tenantConfigurations
   */
