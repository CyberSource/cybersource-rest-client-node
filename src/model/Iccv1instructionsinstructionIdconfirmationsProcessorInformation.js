...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/IccAmountDetail', 'model/IccPaymentInstrument'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./IccAmountDetail'), require('./IccPaymentInstrument'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.Iccv1instructionsinstructionIdconfirmationsProcessorInformation = factory(root.CyberSource.ApiClient, root.CyberSource.IccAmountDetail, root.CyberSource.IccPaymentInstrument);
  }
}(this, function(ApiClient, IccAmountDetail, IccPaymentInstrument) {
  'use strict';
  ...
  /**
   * The Iccv1instructionsinstructionIdconfirmationsProcessorInformation model module.
   * @module model/Iccv1instructionsinstructionIdconfirmationsProcessorInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Iccv1instructionsinstructionIdconfirmationsProcessorInformation</code>.
   * Payment/Transaction Confirmation Data provided by the payment processor/acquirer.
   * @alias module:model/Iccv1instructionsinstructionIdconfirmationsProcessorInformation
   * @class
  ...
  /**
   * Constructs a <code>Iccv1instructionsinstructionIdconfirmationsProcessorInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Iccv1instructionsinstructionIdconfirmationsProcessorInformation} obj Optional instance to populate.
   * @return {module:model/Iccv1instructionsinstructionIdconfirmationsProcessorInformation} The populated <code>Iccv1instructionsinstructionIdconfirmationsProcessorInformation</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('paymentInstrument')) {
        obj['paymentInstrument'] = IccPaymentInstrument.constructFromObject(data['paymentInstrument']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/IccPaymentInstrument} paymentInstrument
   */
