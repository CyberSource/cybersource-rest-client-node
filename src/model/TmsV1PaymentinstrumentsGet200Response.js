...
(function(root, factory) {
  ...
  /**
   * The TmsV1PaymentinstrumentsGet200Response model module.
   * @module model/TmsV1PaymentinstrumentsGet200Response
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>TmsV1PaymentinstrumentsGet200Response</code>.
   * @alias module:model/TmsV1PaymentinstrumentsGet200Response
   * @class
   */
  ...
  /**
   * Constructs a <code>TmsV1PaymentinstrumentsGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TmsV1PaymentinstrumentsGet200Response} obj Optional instance to populate.
   * @return {module:model/TmsV1PaymentinstrumentsGet200Response} The populated <code>TmsV1PaymentinstrumentsGet200Response</code> instance.
   */
   ...
   * @member {module:model/TmsV1PaymentinstrumentsGet200Response.ObjectEnum} object
   */
  exports.prototype['object'] = undefined;
  /**
   * Current state of the token.
   * @member {module:model/TmsV1PaymentinstrumentsGet200Response.StateEnum} state
   */
