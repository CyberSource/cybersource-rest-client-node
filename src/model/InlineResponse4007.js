...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse4007Fields'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse4007Fields'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse4007 = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse4007Fields);
  }
}(this, function(ApiClient, InlineResponse4007Fields) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('fields')) {
        obj['fields'] = ApiClient.convertToType(data['fields'], [InlineResponse4007Fields]);
      }
    }
    return obj;
  }
  ...
  /**
   * Error fields List
   * @member {Array.<module:model/InlineResponse4007Fields>} fields
   */
