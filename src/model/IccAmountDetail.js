...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.IccAmountDetail = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The IccAmountDetail model module.
   * @module model/IccAmountDetail
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>IccAmountDetail</code>.
   * Amount Detail data. Breaks down the total transaction amount into components.
   * @alias module:model/IccAmountDetail
   * @class
  ...
  /**
   * Constructs a <code>IccAmountDetail</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IccAmountDetail} obj Optional instance to populate.
   * @return {module:model/IccAmountDetail} The populated <code>IccAmountDetail</code> instance.
   */
