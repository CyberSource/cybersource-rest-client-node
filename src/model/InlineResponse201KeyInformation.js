...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse201KeyInformation = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse201ErrorInformation);
  }
  ...
  /**
   * The InlineResponse201KeyInformation model module.
   * @module model/InlineResponse201KeyInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse201KeyInformation</code>.
   * key information 
   * @alias module:model/InlineResponse201KeyInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse201KeyInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse201KeyInformation} obj Optional instance to populate.
   * @return {module:model/InlineResponse201KeyInformation} The populated <code>InlineResponse201KeyInformation</code> instance.
   */
