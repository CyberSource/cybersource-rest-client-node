...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse2009SourceRecord = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse2009SourceRecord model module.
   * @module model/InlineResponse2009SourceRecord
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2009SourceRecord</code>.
   * @alias module:model/InlineResponse2009SourceRecord
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2009SourceRecord</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2009SourceRecord} obj Optional instance to populate.
   * @return {module:model/InlineResponse2009SourceRecord} The populated <code>InlineResponse2009SourceRecord</code> instance.
   */
