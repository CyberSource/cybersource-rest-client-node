...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TssV2TransactionsGet200ResponseProcessorInformationAchVerification', 'model/TssV2TransactionsGet200ResponseProcessorInformationAvs', 'model/TssV2TransactionsGet200ResponseProcessorInformationCardVerification', 'model/TssV2TransactionsGet200ResponseProcessorInformationElectronicVerificationResults', 'model/TssV2TransactionsGet200ResponseProcessorInformationProcessor'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TssV2TransactionsGet200ResponseProcessorInformationAchVerification'), require('./TssV2TransactionsGet200ResponseProcessorInformationAvs'), require('./TssV2TransactionsGet200ResponseProcessorInformationCardVerification'), require('./TssV2TransactionsGet200ResponseProcessorInformationElectronicVerificationResults'), require('./TssV2TransactionsGet200ResponseProcessorInformationProcessor'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.TssV2TransactionsGet200ResponseProcessorInformation = factory(root.CyberSource.ApiClient, root.CyberSource.TssV2TransactionsGet200ResponseProcessorInformationAchVerification, root.CyberSource.TssV2TransactionsGet200ResponseProcessorInformationAvs, root.CyberSource.TssV2TransactionsGet200ResponseProcessorInformationCardVerification, root.CyberSource.TssV2TransactionsGet200ResponseProcessorInformationElectronicVerificationResults, root.CyberSource.TssV2TransactionsGet200ResponseProcessorInformationProcessor);
  }
}(this, function(ApiClient, TssV2TransactionsGet200ResponseProcessorInformationAchVerification, TssV2TransactionsGet200ResponseProcessorInformationAvs, TssV2TransactionsGet200ResponseProcessorInformationCardVerification, TssV2TransactionsGet200ResponseProcessorInformationElectronicVerificationResults, TssV2TransactionsGet200ResponseProcessorInformationProcessor) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('avs')) {
        obj['avs'] = TssV2TransactionsGet200ResponseProcessorInformationAvs.constructFromObject(data['avs']);
      }
  ...
  /**
   * @member {module:model/TssV2TransactionsGet200ResponseProcessorInformationAvs} avs
   */
