...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts', 'model/V2paymentsOrderInformationAmountDetailsSurcharge', 'model/V2paymentsOrderInformationAmountDetailsTaxDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts'), require('./V2paymentsOrderInformationAmountDetailsSurcharge'), require('./V2paymentsOrderInformationAmountDetailsTaxDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.V2paymentsOrderInformationAmountDetails = factory(root.CyberSource.ApiClient, root.CyberSource.V2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts, root.CyberSource.V2paymentsOrderInformationAmountDetailsSurcharge, root.CyberSource.V2paymentsOrderInformationAmountDetailsTaxDetails);
  }
}(this, function(ApiClient, V2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts, V2paymentsOrderInformationAmountDetailsSurcharge, V2paymentsOrderInformationAmountDetailsTaxDetails) {
  'use strict';
  ...
  /**
   * The V2paymentsOrderInformationAmountDetails model module.
   * @module model/V2paymentsOrderInformationAmountDetails
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2paymentsOrderInformationAmountDetails</code>.
   * @alias module:model/V2paymentsOrderInformationAmountDetails
   * @class
   */
  ...
  /**
   * Constructs a <code>V2paymentsOrderInformationAmountDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2paymentsOrderInformationAmountDetails} obj Optional instance to populate.
   * @return {module:model/V2paymentsOrderInformationAmountDetails} The populated <code>V2paymentsOrderInformationAmountDetails</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('surcharge')) {
        obj['surcharge'] = V2paymentsOrderInformationAmountDetailsSurcharge.constructFromObject(data['surcharge']);
      }
      ...
      if (data.hasOwnProperty('amexAdditionalAmounts')) {
        obj['amexAdditionalAmounts'] = ApiClient.convertToType(data['amexAdditionalAmounts'], [V2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts]);
      }
  ...
  /**
   * @member {module:model/V2paymentsOrderInformationAmountDetailsSurcharge} surcharge
   */
  ...
  /**
   * @member {Array.<module:model/V2paymentsOrderInformationAmountDetailsAmexAdditionalAmounts>} amexAdditionalAmounts
   */
