...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse20012ClientReferenceInformation = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse20012ClientReferenceInformation model module.
   * @module model/InlineResponse20012ClientReferenceInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse20012ClientReferenceInformation</code>.
   * @alias module:model/InlineResponse20012ClientReferenceInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse20012ClientReferenceInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20012ClientReferenceInformation} obj Optional instance to populate.
   * @return {module:model/InlineResponse20012ClientReferenceInformation} The populated <code>InlineResponse20012ClientReferenceInformation</code> instance.
   */
