...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2013Links', 'model/InlineResponse2013OrderInformation', 'model/InlineResponse2013ProcessorInformation', 'model/InlineResponse2014CreditAmountDetails', 'model/InlineResponse201ClientReferenceInformation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2013Links'), require('./InlineResponse2013OrderInformation'), require('./InlineResponse2013ProcessorInformation'), require('./InlineResponse2014CreditAmountDetails'), require('./InlineResponse201ClientReferenceInformation'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse2014 = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse2013Links, root.CyberSource.InlineResponse2013OrderInformation, root.CyberSource.InlineResponse2013ProcessorInformation, root.CyberSource.InlineResponse2014CreditAmountDetails, root.CyberSource.InlineResponse201ClientReferenceInformation);
  }
}(this, function(ApiClient, InlineResponse2013Links, InlineResponse2013OrderInformation, InlineResponse2013ProcessorInformation, InlineResponse2014CreditAmountDetails, InlineResponse201ClientReferenceInformation) {
  'use strict';
   ...
   * @member {module:model/InlineResponse2014.StatusEnum} status
   */
