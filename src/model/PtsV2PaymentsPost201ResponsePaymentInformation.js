...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('./PtsV2PaymentsPost201ResponsePaymentAccountInformationCard'), require('./PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard'), require('./PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures'), require('./PtsV2PaymentsPost201ResponsePaymentInformationBank'), require('./PtsV2PaymentsPost201ResponsePaymentInformationEWallet'), require('./PtsV2PaymentsPost201ResponsePaymentInformationInstrumentIdentifier'), require('./PtsV2PaymentsPost201ResponsePaymentInformationTokenizedPaymentMethod'), require('./Ptsv2paymentsPaymentInformationCustomer'), require('./Ptsv2paymentsPaymentInformationPaymentInstrument'), require('./Ptsv2paymentsPaymentInformationShippingAddress'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.PtsV2PaymentsPost201ResponsePaymentInformation = factory(root.CyberSource.ApiClient, root.CyberSource.PtsV2PaymentsPost201ResponsePaymentAccountInformationCard, root.CyberSource.PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard, root.CyberSource.PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures, root.CyberSource.PtsV2PaymentsPost201ResponsePaymentInformationBank, root.CyberSource.PtsV2PaymentsPost201ResponsePaymentInformationEWallet, root.CyberSource.PtsV2PaymentsPost201ResponsePaymentInformationInstrumentIdentifier, root.CyberSource.PtsV2PaymentsPost201ResponsePaymentInformationTokenizedPaymentMethod, root.CyberSource.Ptsv2paymentsPaymentInformationCustomer, root.CyberSource.Ptsv2paymentsPaymentInformationPaymentInstrument, root.CyberSource.Ptsv2paymentsPaymentInformationShippingAddress);
  }
}(this, function(ApiClient, PtsV2PaymentsPost201ResponsePaymentAccountInformationCard, PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard, PtsV2PaymentsPost201ResponsePaymentInformationAccountFeatures, PtsV2PaymentsPost201ResponsePaymentInformationBank, PtsV2PaymentsPost201ResponsePaymentInformationEWallet, PtsV2PaymentsPost201ResponsePaymentInformationInstrumentIdentifier, PtsV2PaymentsPost201ResponsePaymentInformationTokenizedPaymentMethod, Ptsv2paymentsPaymentInformationCustomer, Ptsv2paymentsPaymentInformationPaymentInstrument, Ptsv2paymentsPaymentInformationShippingAddress) {
  'use strict';
