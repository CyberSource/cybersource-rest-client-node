...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer', 'model/PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1', 'model/PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonPaymentTypes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer'), require('./PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1'), require('./PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonPaymentTypes'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonProcessors = factory(root.CyberSource.ApiClient, root.CyberSource.PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer, root.CyberSource.PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1, root.CyberSource.PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonPaymentTypes);
  }
}(this, function(ApiClient, PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer, PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1, PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonPaymentTypes) {
  'use strict';
  ...
  /**
   * The PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonProcessors model module.
   * @module model/PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonProcessors
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonProcessors</code>.
   * @alias module:model/PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonProcessors
   * @class
  ...
  /**
   * Constructs a <code>PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonProcessors</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonProcessors} obj Optional instance to populate.
   * @return {module:model/PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonProcessors} The populated <code>PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonProcessors</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('acquirer')) {
        obj['acquirer'] = PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer.constructFromObject(data['acquirer']);
      }
      ...
      if (data.hasOwnProperty('paymentTypes')) {
        obj['paymentTypes'] = ApiClient.convertToType(data['paymentTypes'], {'String': PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonPaymentTypes});
      }
      if (data.hasOwnProperty('currencies')) {
        obj['currencies'] = ApiClient.convertToType(data['currencies'], {'String': PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1});
      }
  ...
  /**
   * @member {module:model/PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer} acquirer
   */
   ...
   * @member {Object.<String, module:model/PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonPaymentTypes>} paymentTypes
   */
   ...
   * @member {Object.<String, module:model/PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1>} currencies
   */
   ...
   * @member {module:model/PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonProcessors.IndustryCodeEnum} industryCode
   */
