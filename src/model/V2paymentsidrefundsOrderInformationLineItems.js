...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.V2paymentsidrefundsOrderInformationLineItems = factory(root.CyberSource.ApiClient, root.CyberSource.V2paymentsOrderInformationAmountDetailsTaxDetails);
  }
  ...
  /**
   * The V2paymentsidrefundsOrderInformationLineItems model module.
   * @module model/V2paymentsidrefundsOrderInformationLineItems
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2paymentsidrefundsOrderInformationLineItems</code>.
   * @alias module:model/V2paymentsidrefundsOrderInformationLineItems
   * @class
   */
  ...
  /**
   * Constructs a <code>V2paymentsidrefundsOrderInformationLineItems</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2paymentsidrefundsOrderInformationLineItems} obj Optional instance to populate.
   * @return {module:model/V2paymentsidrefundsOrderInformationLineItems} The populated <code>V2paymentsidrefundsOrderInformationLineItems</code> instance.
   */
