...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.PtsV2PaymentsRefundPost201ResponseErrorInformation = factory(root.CyberSource.ApiClient, root.CyberSource.PtsV2PaymentsPost201ResponseErrorInformationDetails);
  }
  ...
  /**
   * The PtsV2PaymentsRefundPost201ResponseErrorInformation model module.
   * @module model/PtsV2PaymentsRefundPost201ResponseErrorInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PtsV2PaymentsRefundPost201ResponseErrorInformation</code>.
   * @alias module:model/PtsV2PaymentsRefundPost201ResponseErrorInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>PtsV2PaymentsRefundPost201ResponseErrorInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PtsV2PaymentsRefundPost201ResponseErrorInformation} obj Optional instance to populate.
   * @return {module:model/PtsV2PaymentsRefundPost201ResponseErrorInformation} The populated <code>PtsV2PaymentsRefundPost201ResponseErrorInformation</code> instance.
   */
