...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2007EmbeddedTotals', 'model/InlineResponse2008Billing', 'model/InlineResponse2008Links'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2007EmbeddedTotals'), require('./InlineResponse2008Billing'), require('./InlineResponse2008Links'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse2008 = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse2007EmbeddedTotals, root.CyberSource.InlineResponse2008Billing, root.CyberSource.InlineResponse2008Links);
  }
}(this, function(ApiClient, InlineResponse2007EmbeddedTotals, InlineResponse2008Billing, InlineResponse2008Links) {
  'use strict';
