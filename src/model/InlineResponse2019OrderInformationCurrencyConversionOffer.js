...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse2019OrderInformationCurrencyConversionOffer = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse2019OrderInformationCurrencyConversionOffer model module.
   * @module model/InlineResponse2019OrderInformationCurrencyConversionOffer
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2019OrderInformationCurrencyConversionOffer</code>.
   * @alias module:model/InlineResponse2019OrderInformationCurrencyConversionOffer
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2019OrderInformationCurrencyConversionOffer</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2019OrderInformationCurrencyConversionOffer} obj Optional instance to populate.
   * @return {module:model/InlineResponse2019OrderInformationCurrencyConversionOffer} The populated <code>InlineResponse2019OrderInformationCurrencyConversionOffer</code> instance.
   */
