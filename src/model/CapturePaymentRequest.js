...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Ptsv2paymentsDeviceInformation', 'model/Ptsv2paymentsMerchantDefinedInformation', 'model/Ptsv2paymentsidcapturesAggregatorInformation', 'model/Ptsv2paymentsidcapturesBuyerInformation', 'model/Ptsv2paymentsidcapturesClientReferenceInformation', 'model/Ptsv2paymentsidcapturesMerchantInformation', 'model/Ptsv2paymentsidcapturesOrderInformation', 'model/Ptsv2paymentsidcapturesPaymentInformation', 'model/Ptsv2paymentsidcapturesPointOfSaleInformation', 'model/Ptsv2paymentsidcapturesProcessingInformation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Ptsv2paymentsDeviceInformation'), require('./Ptsv2paymentsMerchantDefinedInformation'), require('./Ptsv2paymentsidcapturesAggregatorInformation'), require('./Ptsv2paymentsidcapturesBuyerInformation'), require('./Ptsv2paymentsidcapturesClientReferenceInformation'), require('./Ptsv2paymentsidcapturesMerchantInformation'), require('./Ptsv2paymentsidcapturesOrderInformation'), require('./Ptsv2paymentsidcapturesPaymentInformation'), require('./Ptsv2paymentsidcapturesPointOfSaleInformation'), require('./Ptsv2paymentsidcapturesProcessingInformation'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.CapturePaymentRequest = factory(root.CyberSource.ApiClient, root.CyberSource.Ptsv2paymentsDeviceInformation, root.CyberSource.Ptsv2paymentsMerchantDefinedInformation, root.CyberSource.Ptsv2paymentsidcapturesAggregatorInformation, root.CyberSource.Ptsv2paymentsidcapturesBuyerInformation, root.CyberSource.Ptsv2paymentsidcapturesClientReferenceInformation, root.CyberSource.Ptsv2paymentsidcapturesMerchantInformation, root.CyberSource.Ptsv2paymentsidcapturesOrderInformation, root.CyberSource.Ptsv2paymentsidcapturesPaymentInformation, root.CyberSource.Ptsv2paymentsidcapturesPointOfSaleInformation, root.CyberSource.Ptsv2paymentsidcapturesProcessingInformation);
  }
}(this, function(ApiClient, Ptsv2paymentsDeviceInformation, Ptsv2paymentsMerchantDefinedInformation, Ptsv2paymentsidcapturesAggregatorInformation, Ptsv2paymentsidcapturesBuyerInformation, Ptsv2paymentsidcapturesClientReferenceInformation, Ptsv2paymentsidcapturesMerchantInformation, Ptsv2paymentsidcapturesOrderInformation, Ptsv2paymentsidcapturesPaymentInformation, Ptsv2paymentsidcapturesPointOfSaleInformation, Ptsv2paymentsidcapturesProcessingInformation) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('clientReferenceInformation')) {
        obj['clientReferenceInformation'] = Ptsv2paymentsidcapturesClientReferenceInformation.constructFromObject(data['clientReferenceInformation']);
      }
  ...
  /**
   * @member {module:model/Ptsv2paymentsidcapturesClientReferenceInformation} clientReferenceInformation
   */
