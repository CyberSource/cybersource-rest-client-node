...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.UnderwritingConfigurationDepositInformation = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The UnderwritingConfigurationDepositInformation model module.
   * @module model/UnderwritingConfigurationDepositInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>UnderwritingConfigurationDepositInformation</code>.
   * @alias module:model/UnderwritingConfigurationDepositInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>UnderwritingConfigurationDepositInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UnderwritingConfigurationDepositInformation} obj Optional instance to populate.
