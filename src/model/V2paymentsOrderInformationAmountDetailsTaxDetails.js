...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.V2paymentsOrderInformationAmountDetailsTaxDetails = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The V2paymentsOrderInformationAmountDetailsTaxDetails model module.
   * @module model/V2paymentsOrderInformationAmountDetailsTaxDetails
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2paymentsOrderInformationAmountDetailsTaxDetails</code>.
   * @alias module:model/V2paymentsOrderInformationAmountDetailsTaxDetails
   * @class
   */
  ...
  /**
   * Constructs a <code>V2paymentsOrderInformationAmountDetailsTaxDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2paymentsOrderInformationAmountDetailsTaxDetails} obj Optional instance to populate.
   * @return {module:model/V2paymentsOrderInformationAmountDetailsTaxDetails} The populated <code>V2paymentsOrderInformationAmountDetailsTaxDetails</code> instance.
   */
   ...
   * @member {module:model/V2paymentsOrderInformationAmountDetailsTaxDetails.TypeEnum} type
   */
