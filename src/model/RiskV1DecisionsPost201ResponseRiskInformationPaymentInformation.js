...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation model module.
   * @module model/RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation</code>.
  ...
  /**
   * Constructs a <code>RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation</code> from a plain JavaScript object, optionally creating a new instance.
   ...
   * @return {module:model/RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation} The populated <code>RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation</code> instance.
   */
