...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse20012OrderInformationBillTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The InlineResponse20012OrderInformationBillTo model module.
   * @module model/InlineResponse20012OrderInformationBillTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse20012OrderInformationBillTo</code>.
   * @alias module:model/InlineResponse20012OrderInformationBillTo
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse20012OrderInformationBillTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20012OrderInformationBillTo} obj Optional instance to populate.
   * @return {module:model/InlineResponse20012OrderInformationBillTo} The populated <code>InlineResponse20012OrderInformationBillTo</code> instance.
   */
