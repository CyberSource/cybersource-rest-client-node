...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('pointOfSaleInformation')) {
        obj['pointOfSaleInformation'] = TmsPointOfSaleInformation.constructFromObject(data['pointOfSaleInformation']);
      }
  ...
  /**
   * @member {module:model/TmsPointOfSaleInformation} pointOfSaleInformation
   */
