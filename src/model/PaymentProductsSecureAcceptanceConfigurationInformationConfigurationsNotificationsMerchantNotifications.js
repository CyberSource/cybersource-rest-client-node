...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications model module.
   * @module model/PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications</code>.
   * @alias module:model/PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications} obj Optional instance to populate.
   * @return {module:model/PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications} The populated <code>PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications</code> instance.
   */
