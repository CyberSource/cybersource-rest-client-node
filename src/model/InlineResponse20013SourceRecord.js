...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>InlineResponse20013SourceRecord</code>.
  ...
  /**
   * Constructs a <code>InlineResponse20013SourceRecord</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20013SourceRecord} obj Optional instance to populate.
   * @return {module:model/InlineResponse20013SourceRecord} The populated <code>InlineResponse20013SourceRecord</code> instance.
   */
