...
(function(root, factory) {
  ...
  /**
   * The TssV2TransactionsPost201Response1EmbeddedTransactionSummaries model module.
   * @module model/TssV2TransactionsPost201Response1EmbeddedTransactionSummaries
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>TssV2TransactionsPost201Response1EmbeddedTransactionSummaries</code>.
   * @alias module:model/TssV2TransactionsPost201Response1EmbeddedTransactionSummaries
   * @class
   */
  ...
  /**
   * Constructs a <code>TssV2TransactionsPost201Response1EmbeddedTransactionSummaries</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TssV2TransactionsPost201Response1EmbeddedTransactionSummaries} obj Optional instance to populate.
   * @return {module:model/TssV2TransactionsPost201Response1EmbeddedTransactionSummaries} The populated <code>TssV2TransactionsPost201Response1EmbeddedTransactionSummaries</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('paymentInformation')) {
        obj['paymentInformation'] = TssV2TransactionsPost201Response1EmbeddedPaymentInformation.constructFromObject(data['paymentInformation']);
      }
  ...
  /**
   * @member {module:model/TssV2TransactionsPost201Response1EmbeddedPaymentInformation} paymentInformation
   */
