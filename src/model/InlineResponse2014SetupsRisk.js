...
(function(root, factory) {
  ...
  /**
   * The InlineResponse2014SetupsRisk model module.
   * @module model/InlineResponse2014SetupsRisk
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2014SetupsRisk</code>.
   * @alias module:model/InlineResponse2014SetupsRisk
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2014SetupsRisk</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2014SetupsRisk} obj Optional instance to populate.
   * @return {module:model/InlineResponse2014SetupsRisk} The populated <code>InlineResponse2014SetupsRisk</code> instance.
   */
