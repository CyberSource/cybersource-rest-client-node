...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.V2paymentsOrderInformationShippingDetails = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The V2paymentsOrderInformationShippingDetails model module.
   * @module model/V2paymentsOrderInformationShippingDetails
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>V2paymentsOrderInformationShippingDetails</code>.
   * @alias module:model/V2paymentsOrderInformationShippingDetails
   * @class
   */
  ...
  /**
   * Constructs a <code>V2paymentsOrderInformationShippingDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2paymentsOrderInformationShippingDetails} obj Optional instance to populate.
   * @return {module:model/V2paymentsOrderInformationShippingDetails} The populated <code>V2paymentsOrderInformationShippingDetails</code> instance.
   */
