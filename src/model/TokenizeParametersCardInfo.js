...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.TokenizeParametersCardInfo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The TokenizeParametersCardInfo model module.
   * @module model/TokenizeParametersCardInfo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>TokenizeParametersCardInfo</code>.
   * @alias module:model/TokenizeParametersCardInfo
   * @class
  ...
  /**
   * Constructs a <code>TokenizeParametersCardInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TokenizeParametersCardInfo} obj Optional instance to populate.
   * @return {module:model/TokenizeParametersCardInfo} The populated <code>TokenizeParametersCardInfo</code> instance.
   */
