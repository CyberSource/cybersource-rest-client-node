...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RiskAddressVerificationInformationBarCode', 'model/RiskAddressVerificationInformationStandardAddress'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RiskAddressVerificationInformationBarCode'), require('./RiskAddressVerificationInformationStandardAddress'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.RiskAddressVerificationInformation = factory(root.CyberSource.ApiClient, root.CyberSource.RiskAddressVerificationInformationBarCode, root.CyberSource.RiskAddressVerificationInformationStandardAddress);
  }
}(this, function(ApiClient, RiskAddressVerificationInformationBarCode, RiskAddressVerificationInformationStandardAddress) {
  'use strict';
  ...
  /**
   * The RiskAddressVerificationInformation model module.
   * @module model/RiskAddressVerificationInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>RiskAddressVerificationInformation</code>.
   * @alias module:model/RiskAddressVerificationInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>RiskAddressVerificationInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RiskAddressVerificationInformation} obj Optional instance to populate.
   * @return {module:model/RiskAddressVerificationInformation} The populated <code>RiskAddressVerificationInformation</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('barCode')) {
        obj['barCode'] = RiskAddressVerificationInformationBarCode.constructFromObject(data['barCode']);
      }
      ...
      if (data.hasOwnProperty('standardAddress')) {
        obj['standardAddress'] = RiskAddressVerificationInformationStandardAddress.constructFromObject(data['standardAddress']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/RiskAddressVerificationInformationBarCode} barCode
   */
  ...
  /**
   * @member {module:model/RiskAddressVerificationInformationStandardAddress} standardAddress
   */
