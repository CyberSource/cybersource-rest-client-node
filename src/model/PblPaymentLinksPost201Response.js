...
(function(root, factory) {
  ...
  /**
   * The PblPaymentLinksPost201Response model module.
   * @module model/PblPaymentLinksPost201Response
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PblPaymentLinksPost201Response</code>.
   * @alias module:model/PblPaymentLinksPost201Response
   * @class
   */
  ...
  /**
   * Constructs a <code>PblPaymentLinksPost201Response</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PblPaymentLinksPost201Response} obj Optional instance to populate.
   * @return {module:model/PblPaymentLinksPost201Response} The populated <code>PblPaymentLinksPost201Response</code> instance.
   */
