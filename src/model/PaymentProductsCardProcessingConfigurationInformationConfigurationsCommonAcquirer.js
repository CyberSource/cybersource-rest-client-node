...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer model module.
   * @module model/PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer</code>.
   ...
   * @alias module:model/PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer} obj Optional instance to populate.
   * @return {module:model/PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer} The populated <code>PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer</code> instance.
   */
