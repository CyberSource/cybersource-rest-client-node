...
(function(root, factory) {
  ...
  /**
   * The InvoicingV2InvoicesPut200Response model module.
   * @module model/InvoicingV2InvoicesPut200Response
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InvoicingV2InvoicesPut200Response</code>.
   * @alias module:model/InvoicingV2InvoicesPut200Response
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoicingV2InvoicesPut200Response</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoicingV2InvoicesPut200Response} obj Optional instance to populate.
   * @return {module:model/InvoicingV2InvoicesPut200Response} The populated <code>InvoicingV2InvoicesPut200Response</code> instance.
   */
