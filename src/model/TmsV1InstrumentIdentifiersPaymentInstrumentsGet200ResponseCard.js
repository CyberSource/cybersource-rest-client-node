...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * Constructs a <code>TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard} obj Optional instance to populate.
   * @return {module:model/TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard} The populated <code>TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard</code> instance.
   */
   ...
   * @member {module:model/TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard.TypeEnum} type
   */
