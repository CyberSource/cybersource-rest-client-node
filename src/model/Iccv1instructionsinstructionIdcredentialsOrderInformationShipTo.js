...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Iccv1instructionsinstructionIdcredentialsOrderInformationShipTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Iccv1instructionsinstructionIdcredentialsOrderInformationShipTo model module.
   * @module model/Iccv1instructionsinstructionIdcredentialsOrderInformationShipTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Iccv1instructionsinstructionIdcredentialsOrderInformationShipTo</code>.
   * Shipping information.
   * @alias module:model/Iccv1instructionsinstructionIdcredentialsOrderInformationShipTo
   * @class
  ...
  /**
   * Constructs a <code>Iccv1instructionsinstructionIdcredentialsOrderInformationShipTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Iccv1instructionsinstructionIdcredentialsOrderInformationShipTo} obj Optional instance to populate.
   * @return {module:model/Iccv1instructionsinstructionIdcredentialsOrderInformationShipTo} The populated <code>Iccv1instructionsinstructionIdcredentialsOrderInformationShipTo</code> instance.
   */
