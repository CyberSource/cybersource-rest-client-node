...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Tmsv2TokenizedCardCard', 'model/Tmsv2TokenizedCardVerificationResults'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Tmsv2TokenizedCardCard'), require('./Tmsv2TokenizedCardVerificationResults'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse2011TokenizedCard = factory(root.CyberSource.ApiClient, root.CyberSource.Tmsv2TokenizedCardCard, root.CyberSource.Tmsv2TokenizedCardVerificationResults);
  }
}(this, function(ApiClient, Tmsv2TokenizedCardCard, Tmsv2TokenizedCardVerificationResults) {
  'use strict';
