...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.ProcessorInformationSellerProtection = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The ProcessorInformationSellerProtection model module.
   * @module model/ProcessorInformationSellerProtection
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>ProcessorInformationSellerProtection</code>.
   * @alias module:model/ProcessorInformationSellerProtection
   * @class
   */
  ...
  /**
   * Constructs a <code>ProcessorInformationSellerProtection</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProcessorInformationSellerProtection} obj Optional instance to populate.
   * @return {module:model/ProcessorInformationSellerProtection} The populated <code>ProcessorInformationSellerProtection</code> instance.
   */
