...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Iccv1instructionsDeclineThreshold', 'model/Iccv1instructionsRecurringPaymentInformation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Iccv1instructionsDeclineThreshold'), require('./Iccv1instructionsRecurringPaymentInformation'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.Iccv1instructionsMandates = factory(root.CyberSource.ApiClient, root.CyberSource.Iccv1instructionsDeclineThreshold, root.CyberSource.Iccv1instructionsRecurringPaymentInformation);
  }
}(this, function(ApiClient, Iccv1instructionsDeclineThreshold, Iccv1instructionsRecurringPaymentInformation) {
  'use strict';
  ...
  /**
   * The Iccv1instructionsMandates model module.
   * @module model/Iccv1instructionsMandates
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Iccv1instructionsMandates</code>.
   ...
   * @alias module:model/Iccv1instructionsMandates
   * @class
   ...
   * @param declineThreshold {module:model/Iccv1instructionsDeclineThreshold} 
  ...
  /**
   * Constructs a <code>Iccv1instructionsMandates</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Iccv1instructionsMandates} obj Optional instance to populate.
   * @return {module:model/Iccv1instructionsMandates} The populated <code>Iccv1instructionsMandates</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('declineThreshold')) {
        obj['declineThreshold'] = Iccv1instructionsDeclineThreshold.constructFromObject(data['declineThreshold']);
      }
      if (data.hasOwnProperty('recurringPaymentInformation')) {
        obj['recurringPaymentInformation'] = Iccv1instructionsRecurringPaymentInformation.constructFromObject(data['recurringPaymentInformation']);
      }
  ...
  /**
   * @member {module:model/Iccv1instructionsDeclineThreshold} declineThreshold
   */
  exports.prototype['declineThreshold'] = undefined;
  /**
   * @member {module:model/Iccv1instructionsRecurringPaymentInformation} recurringPaymentInformation
   */
