...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Iccv1mppcredentialsChallengeEncryptionJwk = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Iccv1mppcredentialsChallengeEncryptionJwk model module.
   * @module model/Iccv1mppcredentialsChallengeEncryptionJwk
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Iccv1mppcredentialsChallengeEncryptionJwk</code>.
   ...
   * @alias module:model/Iccv1mppcredentialsChallengeEncryptionJwk
   * @class
  ...
  /**
   * Constructs a <code>Iccv1mppcredentialsChallengeEncryptionJwk</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Iccv1mppcredentialsChallengeEncryptionJwk} obj Optional instance to populate.
   * @return {module:model/Iccv1mppcredentialsChallengeEncryptionJwk} The populated <code>Iccv1mppcredentialsChallengeEncryptionJwk</code> instance.
   */
