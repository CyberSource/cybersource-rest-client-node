...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard model module.
   * @module model/PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard</code>.
   * @alias module:model/PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard
   * @class
   */
  ...
  /**
   * Constructs a <code>PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard} obj Optional instance to populate.
   * @return {module:model/PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard} The populated <code>PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard</code> instance.
   */
