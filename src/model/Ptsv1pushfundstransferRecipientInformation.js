...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Ptsv1pushfundstransferRecipientInformationPersonalIdentification', 'model/PushFundsTransferPaymentInformation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Ptsv1pushfundstransferRecipientInformationPersonalIdentification'), require('./PushFundsTransferPaymentInformation'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.Ptsv1pushfundstransferRecipientInformation = factory(root.CyberSource.ApiClient, root.CyberSource.Ptsv1pushfundstransferRecipientInformationPersonalIdentification, root.CyberSource.PushFundsTransferPaymentInformation);
  }
}(this, function(ApiClient, Ptsv1pushfundstransferRecipientInformationPersonalIdentification, PushFundsTransferPaymentInformation) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('paymentInformation')) {
        obj['paymentInformation'] = PushFundsTransferPaymentInformation.constructFromObject(data['paymentInformation']);
      }
  ...
  /**
   * @member {module:model/PushFundsTransferPaymentInformation} paymentInformation
   */
