...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.PblPaymentLinksAllGet200ResponseOrderInformationAmountDetails = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The PblPaymentLinksAllGet200ResponseOrderInformationAmountDetails model module.
   * @module model/PblPaymentLinksAllGet200ResponseOrderInformationAmountDetails
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PblPaymentLinksAllGet200ResponseOrderInformationAmountDetails</code>.
   * Contains all of the amount-related fields.
   * @alias module:model/PblPaymentLinksAllGet200ResponseOrderInformationAmountDetails
   * @class
   */
  ...
  /**
   * Constructs a <code>PblPaymentLinksAllGet200ResponseOrderInformationAmountDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PblPaymentLinksAllGet200ResponseOrderInformationAmountDetails} obj Optional instance to populate.
   * @return {module:model/PblPaymentLinksAllGet200ResponseOrderInformationAmountDetails} The populated <code>PblPaymentLinksAllGet200ResponseOrderInformationAmountDetails</code> instance.
   */
