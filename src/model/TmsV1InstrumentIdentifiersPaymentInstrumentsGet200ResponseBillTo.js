...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo model module.
   * @module model/TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo</code>.
   * @alias module:model/TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo
   * @class
   */
  ...
  /**
   * Constructs a <code>TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo} obj Optional instance to populate.
   * @return {module:model/TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo} The populated <code>TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo</code> instance.
   */
