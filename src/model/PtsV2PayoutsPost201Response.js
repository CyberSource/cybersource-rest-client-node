...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PtsV2PaymentsReversalsPost201ResponseLinks', 'model/PtsV2PayoutsPost201ResponseErrorInformation', 'model/PtsV2PayoutsPost201ResponseMerchantInformation', 'model/PtsV2PayoutsPost201ResponseOrderInformation', 'model/PtsV2PayoutsPost201ResponseProcessorInformation', 'model/PtsV2PayoutsPost201ResponseRecipientInformation', 'model/PtsV2PayoutsPost201ResponseStatusInformation', 'model/Ptsv2payoutsClientReferenceInformation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PtsV2PaymentsReversalsPost201ResponseLinks'), require('./PtsV2PayoutsPost201ResponseErrorInformation'), require('./PtsV2PayoutsPost201ResponseMerchantInformation'), require('./PtsV2PayoutsPost201ResponseOrderInformation'), require('./PtsV2PayoutsPost201ResponseProcessorInformation'), require('./PtsV2PayoutsPost201ResponseRecipientInformation'), require('./PtsV2PayoutsPost201ResponseStatusInformation'), require('./Ptsv2payoutsClientReferenceInformation'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.PtsV2PayoutsPost201Response = factory(root.CyberSource.ApiClient, root.CyberSource.PtsV2PaymentsReversalsPost201ResponseLinks, root.CyberSource.PtsV2PayoutsPost201ResponseErrorInformation, root.CyberSource.PtsV2PayoutsPost201ResponseMerchantInformation, root.CyberSource.PtsV2PayoutsPost201ResponseOrderInformation, root.CyberSource.PtsV2PayoutsPost201ResponseProcessorInformation, root.CyberSource.PtsV2PayoutsPost201ResponseRecipientInformation, root.CyberSource.PtsV2PayoutsPost201ResponseStatusInformation, root.CyberSource.Ptsv2payoutsClientReferenceInformation);
  }
}(this, function(ApiClient, PtsV2PaymentsReversalsPost201ResponseLinks, PtsV2PayoutsPost201ResponseErrorInformation, PtsV2PayoutsPost201ResponseMerchantInformation, PtsV2PayoutsPost201ResponseOrderInformation, PtsV2PayoutsPost201ResponseProcessorInformation, PtsV2PayoutsPost201ResponseRecipientInformation, PtsV2PayoutsPost201ResponseStatusInformation, Ptsv2payoutsClientReferenceInformation) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('statusInformation')) {
        obj['statusInformation'] = PtsV2PayoutsPost201ResponseStatusInformation.constructFromObject(data['statusInformation']);
      }
  ...
  /**
   * @member {module:model/PtsV2PayoutsPost201ResponseStatusInformation} statusInformation
   */
  exports.prototype['statusInformation'] = undefined;
  /**
