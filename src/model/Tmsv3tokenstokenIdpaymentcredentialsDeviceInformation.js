...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Tmsv3tokenstokenIdpaymentcredentialsDeviceInformation = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Tmsv3tokenstokenIdpaymentcredentialsDeviceInformation model module.
   * @module model/Tmsv3tokenstokenIdpaymentcredentialsDeviceInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Tmsv3tokenstokenIdpaymentcredentialsDeviceInformation</code>.
   * @alias module:model/Tmsv3tokenstokenIdpaymentcredentialsDeviceInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>Tmsv3tokenstokenIdpaymentcredentialsDeviceInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Tmsv3tokenstokenIdpaymentcredentialsDeviceInformation} obj Optional instance to populate.
   * @return {module:model/Tmsv3tokenstokenIdpaymentcredentialsDeviceInformation} The populated <code>Tmsv3tokenstokenIdpaymentcredentialsDeviceInformation</code> instance.
   */
