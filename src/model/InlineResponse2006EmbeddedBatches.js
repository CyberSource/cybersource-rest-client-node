...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2006EmbeddedLinks', 'model/InlineResponse2006EmbeddedTotals'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2006EmbeddedLinks'), require('./InlineResponse2006EmbeddedTotals'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.InlineResponse2006EmbeddedBatches = factory(root.CyberSource.ApiClient, root.CyberSource.InlineResponse2006EmbeddedLinks, root.CyberSource.InlineResponse2006EmbeddedTotals);
  }
}(this, function(ApiClient, InlineResponse2006EmbeddedLinks, InlineResponse2006EmbeddedTotals) {
  'use strict';
  ...
  /**
   * The InlineResponse2006EmbeddedBatches model module.
   * @module model/InlineResponse2006EmbeddedBatches
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2006EmbeddedBatches</code>.
   * @alias module:model/InlineResponse2006EmbeddedBatches
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2006EmbeddedBatches</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2006EmbeddedBatches} obj Optional instance to populate.
   * @return {module:model/InlineResponse2006EmbeddedBatches} The populated <code>InlineResponse2006EmbeddedBatches</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('_links')) {
        obj['_links'] = InlineResponse2006EmbeddedLinks.constructFromObject(data['_links']);
      }
  ...
  /**
   * @member {module:model/InlineResponse2006EmbeddedLinks} _links
   */
