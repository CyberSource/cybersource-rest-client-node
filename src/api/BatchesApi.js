...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['Authentication/MLEUtility', 'ApiClient', 'model/Body', 'model/InlineResponse20010', 'model/InlineResponse2008', 'model/InlineResponse2009', 'model/InlineResponse202', 'model/InlineResponse4011'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../authentication/util/MLEUtility'), require('../ApiClient'), require('../model/Body'), require('../model/InlineResponse20010'), require('../model/InlineResponse2008'), require('../model/InlineResponse2009'), require('../model/InlineResponse202'), require('../model/InlineResponse4011'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.BatchesApi = factory(root.Authentication.MLEUtility, root.CyberSource.ApiClient, root.CyberSource.Body, root.CyberSource.InlineResponse20010, root.CyberSource.InlineResponse2008, root.CyberSource.InlineResponse2009, root.CyberSource.InlineResponse202, root.CyberSource.InlineResponse4011);
  }
}(this, function(MLEUtility, ApiClient, Body, InlineResponse20010, InlineResponse2008, InlineResponse2009, InlineResponse202, InlineResponse4011) {
  'use strict';
