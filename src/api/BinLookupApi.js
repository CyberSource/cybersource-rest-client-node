...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateBinLookupRequest', 'model/InlineResponse2011', 'model/PtsV2CreateOrderPost400Response', 'model/PtsV2PaymentsPost502Response'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateBinLookupRequest'), require('../model/InlineResponse2011'), require('../model/PtsV2CreateOrderPost400Response'), require('../model/PtsV2PaymentsPost502Response'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.BinLookupApi = factory(root.CyberSource.ApiClient, root.CyberSource.CreateBinLookupRequest, root.CyberSource.InlineResponse2011, root.CyberSource.PtsV2CreateOrderPost400Response, root.CyberSource.PtsV2PaymentsPost502Response);
  }
}(this, function(ApiClient, CreateBinLookupRequest, InlineResponse2011, PtsV2CreateOrderPost400Response, PtsV2PaymentsPost502Response) {
  'use strict';
