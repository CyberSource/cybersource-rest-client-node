...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['Authentication/MLEUtility', 'ApiClient', 'model/InlineResponse20011', 'model/InlineResponse2009', 'model/InlineResponse4008', 'model/InlineResponse401', 'model/InlineResponse4032', 'model/InlineResponse4044', 'model/InlineResponse5003', 'model/PostDeviceSearchRequest', 'model/PostDeviceSearchRequestV3'], factory);
...
}(this, function(MLEUtility, ApiClient, InlineResponse20011, InlineResponse2009, InlineResponse4008, InlineResponse401, InlineResponse4032, InlineResponse4044, InlineResponse5003, PostDeviceSearchRequest, PostDeviceSearchRequestV3) {
  'use strict';
  ...
  var exports = function(configObject, apiClient) {
    ...
    this.postSearchQuery = function(postDeviceSearchRequest, callback) {
      ...
      const isResponseMLEForApi = MLEUtility.checkIsResponseMLEForAPI(this.apiClient.merchantConfig, ['postSearchQuery']);
    ...
    this.postSearchQueryV3 = function(postDeviceSearchRequestV3, callback) {
      ...
      const isResponseMLEForApi = MLEUtility.checkIsResponseMLEForAPI(this.apiClient.merchantConfig, ['postSearchQueryV3']);
