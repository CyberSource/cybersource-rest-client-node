...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['Authentication/MLEUtility', 'ApiClient', 'model/InlineResponse4008', 'model/V1FileDetailsGet200Response'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../authentication/util/MLEUtility'), require('../ApiClient'), require('../model/InlineResponse4008'), require('../model/V1FileDetailsGet200Response'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.SecureFileShareApi = factory(root.Authentication.MLEUtility, root.CyberSource.ApiClient, root.CyberSource.InlineResponse4008, root.CyberSource.V1FileDetailsGet200Response);
  }
}(this, function(MLEUtility, ApiClient, InlineResponse4008, V1FileDetailsGet200Response) {
  'use strict';
  ...
  var exports = function(configObject, apiClient) {
    ...
    this.getFile = function(fileId, opts, callback) {
      ...
      const isResponseMLEForApi = MLEUtility.checkIsResponseMLEForAPI(this.apiClient.merchantConfig, ['getFile']);
    ...
    this.getFileDetail = function(startDate, endDate, opts, callback) {
      ...
      const isResponseMLEForApi = MLEUtility.checkIsResponseMLEForAPI(this.apiClient.merchantConfig, ['getFileDetail']);
