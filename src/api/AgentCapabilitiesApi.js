...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['Authentication/MLEUtility', 'ApiClient', 'model/AgenticCancelPurchaseIntentRequest', 'model/AgenticCardEnrollmentBadRequestResponse400', 'model/AgenticCardEnrollmentRequest', 'model/AgenticCardEnrollmentResponse200', 'model/AgenticCardEnrollmentResponse202', 'model/AgenticConfirmTransactionEventsRequest', 'model/AgenticConfirmTransactionEventsResponse202', 'model/AgenticCreatePurchaseIntentRequest', 'model/AgenticCreatePurchaseIntentResponse200', 'model/AgenticPendingPurchaseIntentResponse202', 'model/AgenticRetrievePaymentCredentialsRequest', 'model/AgenticRetrievePaymentCredentialsResponse200', 'model/AgenticUpdatePurchaseIntentRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../authentication/util/MLEUtility'), require('../ApiClient'), require('../model/AgenticCancelPurchaseIntentRequest'), require('../model/AgenticCardEnrollmentBadRequestResponse400'), require('../model/AgenticCardEnrollmentRequest'), require('../model/AgenticCardEnrollmentResponse200'), require('../model/AgenticCardEnrollmentResponse202'), require('../model/AgenticConfirmTransactionEventsRequest'), require('../model/AgenticConfirmTransactionEventsResponse202'), require('../model/AgenticCreatePurchaseIntentRequest'), require('../model/AgenticCreatePurchaseIntentResponse200'), require('../model/AgenticPendingPurchaseIntentResponse202'), require('../model/AgenticRetrievePaymentCredentialsRequest'), require('../model/AgenticRetrievePaymentCredentialsResponse200'), require('../model/AgenticUpdatePurchaseIntentRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.AgentCapabilitiesApi = factory(root.Authentication.MLEUtility, root.CyberSource.ApiClient, root.CyberSource.AgenticCancelPurchaseIntentRequest, root.CyberSource.AgenticCardEnrollmentBadRequestResponse400, root.CyberSource.AgenticCardEnrollmentRequest, root.CyberSource.AgenticCardEnrollmentResponse200, root.CyberSource.AgenticCardEnrollmentResponse202, root.CyberSource.AgenticConfirmTransactionEventsRequest, root.CyberSource.AgenticConfirmTransactionEventsResponse202, root.CyberSource.AgenticCreatePurchaseIntentRequest, root.CyberSource.AgenticCreatePurchaseIntentResponse200, root.CyberSource.AgenticPendingPurchaseIntentResponse202, root.CyberSource.AgenticRetrievePaymentCredentialsRequest, root.CyberSource.AgenticRetrievePaymentCredentialsResponse200, root.CyberSource.AgenticUpdatePurchaseIntentRequest);
  }
  ...
  /**
   * AgentCapabilities service.
   * @module api/AgentCapabilitiesApi
   * @version 0.0.1
   */

  /**
   * Constructs a new AgentCapabilitiesApi. 
   * @alias module:api/AgentCapabilitiesApi
   * @class
  ...
  var exports = function(configObject, apiClient) {
     ...
     * @callback module:api/AgentCapabilitiesApi~cancelPurchaseIntentCallback
     ...
     * @param {module:api/AgentCapabilitiesApi~cancelPurchaseIntentCallback} callback The callback function, accepting three arguments: error, data, response
      ...
      if (isMLEForApi === true) {
        MLEUtility.encryptRequestPayload(this.apiClient.merchantConfig, postBody).then(postBody => {
          return this.apiClient.callApi(
            '/icc/v1/instructions/{instructionId}/cancel', 'PUT',
     ...
     * @callback module:api/AgentCapabilitiesApi~confirmTransactionEventsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/AgentCapabilitiesApi~confirmTransactionEventsCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    this.confirmTransactionEvents = function(instructionId, agenticConfirmTransactionEventsRequest, callback) {
      ...
      if (isMLEForApi === true) {
        MLEUtility.encryptRequestPayload(this.apiClient.merchantConfig, postBody).then(postBody => {
          return this.apiClient.callApi(
            '/icc/v1/instructions/{instructionId}/confirmations', 'POST',
            pathParams, queryParams, headerParams, formParams, postBody,
            authNames, contentTypes, accepts, returnType, isResponseMLEForApi, callback
          );
        });
     ...
     * @callback module:api/AgentCapabilitiesApi~enrollCardCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/AgentCapabilitiesApi~enrollCardCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/AgentCapabilitiesApi~initiatePurchaseIntentCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AgenticCreatePurchaseIntentResponse200} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/AgentCapabilitiesApi~initiatePurchaseIntentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AgenticCreatePurchaseIntentResponse200}
     */
     ...
     * @callback module:api/AgentCapabilitiesApi~retrievePaymentCredentialsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/AgentCapabilitiesApi~retrievePaymentCredentialsCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    this.retrievePaymentCredentials = function(instructionId, agenticRetrievePaymentCredentialsRequest, callback) {
      ...
      if (isMLEForApi === true) {
        MLEUtility.encryptRequestPayload(this.apiClient.merchantConfig, postBody).then(postBody => {
          return this.apiClient.callApi(
            '/icc/v1/instructions/{instructionId}/credentials', 'POST',
            pathParams, queryParams, headerParams, formParams, postBody,
            authNames, contentTypes, accepts, returnType, isResponseMLEForApi, callback
          );
        });
     ...
     * @callback module:api/AgentCapabilitiesApi~updatePurchaseIntentCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AgenticCreatePurchaseIntentResponse200} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/AgentCapabilitiesApi~updatePurchaseIntentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AgenticCreatePurchaseIntentResponse200}
     */
    this.updatePurchaseIntent = function(instructionId, agenticUpdatePurchaseIntentRequest, callback) {
      ...
      if (isMLEForApi === true) {
        MLEUtility.encryptRequestPayload(this.apiClient.merchantConfig, postBody).then(postBody => {
          return this.apiClient.callApi(
            '/icc/v1/instructions/{instructionId}', 'PUT',
            pathParams, queryParams, headerParams, formParams, postBody,
            authNames, contentTypes, accepts, returnType, isResponseMLEForApi, callback
          );
        });
