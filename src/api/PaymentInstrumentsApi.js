...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Body2', 'model/Body3', 'model/InlineResponse4001', 'model/TmsV1InstrumentidentifiersPaymentinstrumentsGet200Response', 'model/TmsV1PaymentinstrumentsGet200Response', 'model/TmsV1PaymentinstrumentsPost201Response'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Body2'), require('../model/Body3'), require('../model/InlineResponse4001'), require('../model/TmsV1InstrumentidentifiersPaymentinstrumentsGet200Response'), require('../model/TmsV1PaymentinstrumentsGet200Response'), require('../model/TmsV1PaymentinstrumentsPost201Response'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.PaymentInstrumentsApi = factory(root.CyberSource.ApiClient, root.CyberSource.Body2, root.CyberSource.Body3, root.CyberSource.InlineResponse4001, root.CyberSource.TmsV1InstrumentidentifiersPaymentinstrumentsGet200Response, root.CyberSource.TmsV1PaymentinstrumentsGet200Response, root.CyberSource.TmsV1PaymentinstrumentsPost201Response);
  }
}(this, function(ApiClient, Body2, Body3, InlineResponse4001, TmsV1InstrumentidentifiersPaymentinstrumentsGet200Response, TmsV1PaymentinstrumentsGet200Response, TmsV1PaymentinstrumentsPost201Response) {
  'use strict';
  ...
  var exports = function(configObject, apiClient) {
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/TmsV1PaymentinstrumentsGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/TmsV1PaymentinstrumentsGet200Response}
     */
    this.tmsV1PaymentinstrumentsTokenIdGet = function(profileId, tokenId, callback) {
      ...
      var contentTypes = ['application/json;charset=utf-8'];
      var accepts = ['application/json;charset=utf-8'];
      var returnType = TmsV1PaymentinstrumentsGet200Response;
