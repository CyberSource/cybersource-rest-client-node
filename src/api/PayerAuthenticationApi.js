...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CheckPayerAuthEnrollmentRequest', 'model/PtsV2PaymentsPost502Response', 'model/Request', 'model/RiskV1AuthenticationResultsPost201Response', 'model/RiskV1AuthenticationsPost201Response', 'model/RiskV1AuthenticationsPost400Response'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CheckPayerAuthEnrollmentRequest'), require('../model/PtsV2PaymentsPost502Response'), require('../model/Request'), require('../model/RiskV1AuthenticationResultsPost201Response'), require('../model/RiskV1AuthenticationsPost201Response'), require('../model/RiskV1AuthenticationsPost400Response'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.PayerAuthenticationApi = factory(root.CyberSource.ApiClient, root.CyberSource.CheckPayerAuthEnrollmentRequest, root.CyberSource.PtsV2PaymentsPost502Response, root.CyberSource.Request, root.CyberSource.RiskV1AuthenticationResultsPost201Response, root.CyberSource.RiskV1AuthenticationsPost201Response, root.CyberSource.RiskV1AuthenticationsPost400Response);
  }
}(this, function(ApiClient, CheckPayerAuthEnrollmentRequest, PtsV2PaymentsPost502Response, Request, RiskV1AuthenticationResultsPost201Response, RiskV1AuthenticationsPost201Response, RiskV1AuthenticationsPost400Response) {
  'use strict';
