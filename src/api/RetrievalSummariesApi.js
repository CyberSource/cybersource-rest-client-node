...
(function(root, factory) {
  ...
  var exports = function(configObject, apiClient) {
    ...
    this.getRetrievalSummary = function(startTime, endTime, opts, callback) {
      ...
      var isMLEForApi = MLEUtility.checkIsMLEForAPI(this.apiClient.merchantConfig, inboundMLEStatus, 'getRetrievalSummary');
      const isResponseMLEForApi = MLEUtility.checkIsResponseMLEForAPI(this.apiClient.merchantConfig, ['getRetrievalSummary']);
