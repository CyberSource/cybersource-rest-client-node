...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GenerateFlexAPICaptureContextRequest', 'model/InlineResponse4001'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GenerateFlexAPICaptureContextRequest'), require('../model/InlineResponse4001'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.FlexAPIApi = factory(root.CyberSource.ApiClient, root.CyberSource.GenerateFlexAPICaptureContextRequest, root.CyberSource.InlineResponse4001);
  }
}(this, function(ApiClient, GenerateFlexAPICaptureContextRequest, InlineResponse4001) {
  'use strict';
  ...
  var exports = function(configObject, apiClient) {
    ...
    this.generateFlexAPICaptureContext = function(generateFlexAPICaptureContextRequest, callback) {
      ...
      postBody = sdkTracker.insertDeveloperIdTracker(postBody, 'module:model/GenerateFlexAPICaptureContextRequest', this.apiClient.merchantConfig.runEnvironment);
