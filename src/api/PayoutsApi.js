...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OctCreatePaymentRequest', 'model/PtsV2PaymentsPost502Response', 'model/PtsV2PayoutsPost400Response'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/OctCreatePaymentRequest'), require('../model/PtsV2PaymentsPost502Response'), require('../model/PtsV2PayoutsPost400Response'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.PayoutsApi = factory(root.CyberSource.ApiClient, root.CyberSource.OctCreatePaymentRequest, root.CyberSource.PtsV2PaymentsPost502Response, root.CyberSource.PtsV2PayoutsPost400Response);
  }
}(this, function(ApiClient, OctCreatePaymentRequest, PtsV2PaymentsPost502Response, PtsV2PayoutsPost400Response) {
  'use strict';
