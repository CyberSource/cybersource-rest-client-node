...
function loadFileData() {
	...
	var api = new cybersourceRestApi.KeyGenerationApi(configObject);
    ...
    // Testing- Change File heasers and File name
     ...
     var csvStream = csv.fromPath(path.join('QaScripts','CSV_Files','Flex','CoreServices','GenerateKey.csv'),
    { headers: true });
    ...
    csvStream.on("end", function () {
            TestRun.WriteOutData(resArr, testId, 'CreateGenerateKey',assertMessage);
    });
