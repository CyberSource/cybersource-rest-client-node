...
function loadFileData() {
    ...
    api = new cybersourceRestApi.TransactionBatchApi(configObject);
    ...
    var csvStream = csv.fromPath(path.join('QaScripts', 'CSV_Files', 'TransactionBatches', 'CoreServices', 'GetIndividualBatchFile.csv'),
        { headers: true });
    ...
    csvStream.on("data", function (data) {
        ...
        index++;
        var id = data['id'];
        api.ptsV1TransactionBatchesIdGet(id, callback);
        while (sync) {
    ...
    csvStream.on("end", function () {
        ...
        TestRun.WriteOutData(resArr, testId, 'GetIndividualBatchFile', assertMessage);
    });
