...
function loadFileData() {
    ...
    var csvStream = csv.fromPath(path.join('QaScripts','CSV_Files','Payments','CoreServices','VoidCredit.csv'),
    { headers: true });
    ...
    csvStream.on("data", function (data) {
        ...
        instance.voidCredit(request, id, callback);
        while(sync) {
    ...
    csvStream.on("end", function () {
            TestRun.WriteOutData(resArr, testId, 'VoidCredit',assertMessage);
    });
