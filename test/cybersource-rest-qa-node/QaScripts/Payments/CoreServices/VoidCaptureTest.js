...
function loadFileData() {
    ...
    var csvStream = csv.fromPath(path.join('QaScripts','CSV_Files','Payments','CoreServices','VoidCapture.csv'),
    { headers: true });   
    ...
    csvStream.on("data", function (data) {
        ...
        instance.voidCapture(request, id, callback);
        while(sync) {
    ...
    csvStream.on("end", function () {
            TestRun.WriteOutData(resArr, testId, 'VoidCapture',assertMessage);
    });
