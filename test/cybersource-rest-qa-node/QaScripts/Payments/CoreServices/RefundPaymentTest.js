...
function loadFileData() {
    ...
    // Testing- Change File heasers and File name
        var csvStream = csv.fromPath(path.join('QaScripts','CSV_Files','Payments','CoreServices','RefundPayment.csv'),
        { headers: true });
    ...
    csvStream.on("data", function (data) {
        ...
        instance.refundPayment(request, id, callback);
        while(sync) {
    ...
    csvStream.on("end", function () {
            TestRun.WriteOutData(resArr, testId, 'RefundPayment',assertMessage);
    });
