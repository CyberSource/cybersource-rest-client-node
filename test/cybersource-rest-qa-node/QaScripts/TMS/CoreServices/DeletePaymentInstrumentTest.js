...
//var retrievePaymentInstrument = require('./RetrievePaymentInstrumentTest'); 
...
function loadFileData() {
    ...
    var csvStream = csv.fromPath(path.join('QaScripts','CSV_Files','TMS','CoreServices','RemovePaymentsInstruments.csv'),
        { headers: true });
    ...
    csvStream.on("data", function (data) {
        ...
        api.tmsV1PaymentinstrumentsTokenIdDelete(profileId, tokenId, callback);
        while (sync) {
    ...
    csvStream.on("end", function () {
        ...
        TestRun.WriteOutData(resArr, testId, 'DeletePaymentInstrument',assertMessage);
    });
