...
function loadFileData() {
    ...
    var csvStream = csv.fromPath(path.join('QaScripts','CSV_Files','TMS','CoreServices','RetrievePaymentIdentifiers.csv'),
    { headers: true });
    ...
    csvStream.on("data", function (data) {
        ...
        api.tmsV1PaymentinstrumentsTokenIdGet(profileId, tokenId, callback);
        while (sync) {
    ...
    csvStream.on("end", function () {
        ...
        TestRun.WriteOutData(resArr, testId, 'RetrievePaymentInstrument',assertMessage);
    });
}