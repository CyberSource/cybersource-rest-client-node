...
function loadFileData() {
    ...
    var callback = function (error, data, response) {
        ...
        var csvStream = csv.fromPath(path.join('QaScripts', 'CSV_Files', 'TMS', 'CoreServices', 'RetrieveInstrumentIdentifier.csv'),
            { headers: true });
        ...
        csvStream.on("data", function (data) {
            ...
            api.tmsV1InstrumentidentifiersTokenIdGet(profileId, tokenId, callback);
            while (sync) {
        ...
        csvStream.on("end", function () {
            ...
            TestRun.WriteOutData(resArr, testId, 'RetrieveInstrumentIdentifier', assertMessage);
        });
    }