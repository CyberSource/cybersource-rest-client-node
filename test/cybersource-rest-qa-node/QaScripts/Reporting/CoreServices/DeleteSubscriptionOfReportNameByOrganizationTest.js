...
function loadFileData() {
    ...
    var callback = function (error, data, response) {      
     ...
     var csvStream = csv.fromPath(path.join('QaScripts','CSV_Files','Reporting','CoreServices','DeleteSubscriptionOfReportNameByOrganization.csv'),
     { headers: true });
 ...
 csvStream.on("data", function (data) {      
    ...
    api.deleteSubscription(reportName, callback);
    while (sync) {           
...
csvStream.on("end", function () {
    TestRun.WriteOutData(resArr, testId, 'DeleteSubscriptionOfReportNameByOrganization',assertMessage);
});
