...
function loadFileData() {
	...
	api = new cybersourceRestApi.NotificationOfChangesApi(configObject);    
    ...
    var callback = function (error, data, response) {      
     ...
     var csvStream = csv.fromPath(path.join('QaScripts','CSV_Files','Reporting','CoreServices','GetNotificationOfChanges.csv'),
     { headers: true });
 ...
 csvStream.on("data", function (data) {      
    ...
    api.getNotificationOfChangeReport(startTime, endTime, callback);
    while (sync) {           
...
csvStream.on("end", function () {
     TestRun.WriteOutData(resArr, testId, 'GetNotificationOfChanges',assertMessage);
});
