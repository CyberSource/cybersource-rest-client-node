...
var csvStream = csv.fromPath(path.join('QaScripts','CSV_Files','Reporting','CoreServices','GetAllSubscriptions.csv'),
{ headers: true });
...
// Fetch Data From Input File 
 ...
 csvStream.on("data", function (data) {      
    ...
    api.getAllSubscriptions(callback);
    while (sync) {           
...
csvStream.on("end", function () {
     TestRun.WriteOutData(resArr, testId, 'GetAllSubscriptions',assertMessage);
});
