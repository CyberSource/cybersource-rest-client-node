...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TransientTokenDataV2Api();
  });
  ...
  describe('TransientTokenDataV2Api', function() {
    ...
    describe('getTransactionForTransientToken', function() {
      it('should call getTransactionForTransientToken successfully', function(done) {
        ...
        //instance.getTransactionForTransientToken(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getTransactionForTransientTokenJTI', function() {
      it('should call getTransactionForTransientTokenJTI successfully', function(done) {
        //uncomment below and update the code to test getTransactionForTransientTokenJTI
        //instance.getTransactionForTransientTokenJTI(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
