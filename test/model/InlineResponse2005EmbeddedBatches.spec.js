...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2005EmbeddedBatches();
  });
  ...
  describe('InlineResponse2005EmbeddedBatches', function() {
    it('should create an instance of InlineResponse2005EmbeddedBatches', function() {
      // uncomment below and update the code to test InlineResponse2005EmbeddedBatches
      //var instane = new CyberSource.InlineResponse2005EmbeddedBatches();
      //expect(instance).to.be.a(CyberSource.InlineResponse2005EmbeddedBatches);
    });
