...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Flexv2sessionsFields();
  });
  ...
  describe('Flexv2sessionsFields', function() {
    it('should create an instance of Flexv2sessionsFields', function() {
      // uncomment below and update the code to test Flexv2sessionsFields
      //var instane = new CyberSource.Flexv2sessionsFields();
      //expect(instance).to.be.a(CyberSource.Flexv2sessionsFields);
    });
