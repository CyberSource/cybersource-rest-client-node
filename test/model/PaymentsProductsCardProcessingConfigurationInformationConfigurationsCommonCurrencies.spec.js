...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies();
  });
  ...
  describe('PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies', function() {
    it('should create an instance of PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies', function() {
      // uncomment below and update the code to test PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies
      //var instane = new CyberSource.PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies();
      //expect(instance).to.be.a(CyberSource.PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies);
    });
