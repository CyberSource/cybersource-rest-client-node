...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Upv1capturecontextsDataOrderInformationLineItems();
  });
  ...
  describe('Upv1capturecontextsDataOrderInformationLineItems', function() {
    it('should create an instance of Upv1capturecontextsDataOrderInformationLineItems', function() {
      // uncomment below and update the code to test Upv1capturecontextsDataOrderInformationLineItems
      //var instane = new CyberSource.Upv1capturecontextsDataOrderInformationLineItems();
      //expect(instance).to.be.a(CyberSource.Upv1capturecontextsDataOrderInformationLineItems);
    });
