...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PtsV2CreateBillingAgreementPost201Response();
  });
  ...
  describe('PtsV2CreateBillingAgreementPost201Response', function() {
    it('should create an instance of PtsV2CreateBillingAgreementPost201Response', function() {
      // uncomment below and update the code to test PtsV2CreateBillingAgreementPost201Response
      //var instane = new CyberSource.PtsV2CreateBillingAgreementPost201Response();
      //expect(instance).to.be.a(CyberSource.PtsV2CreateBillingAgreementPost201Response);
    });
