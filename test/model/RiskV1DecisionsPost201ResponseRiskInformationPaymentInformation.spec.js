...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation();
  });
  ...
  describe('RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation', function() {
    it('should create an instance of RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation', function() {
      // uncomment below and update the code to test RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation
      //var instane = new CyberSource.RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation();
      //expect(instance).to.be.a(CyberSource.RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation);
    });
