...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Iplv2paymentlinksProcessingInformation();
  });
  ...
  describe('Iplv2paymentlinksProcessingInformation', function() {
    it('should create an instance of Iplv2paymentlinksProcessingInformation', function() {
      // uncomment below and update the code to test Iplv2paymentlinksProcessingInformation
      //var instane = new CyberSource.Iplv2paymentlinksProcessingInformation();
      //expect(instance).to.be.a(CyberSource.Iplv2paymentlinksProcessingInformation);
    });
