...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentreferencesPaymentInformation();
  });
  ...
  describe('Ptsv2paymentreferencesPaymentInformation', function() {
    it('should create an instance of Ptsv2paymentreferencesPaymentInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentreferencesPaymentInformation
      //var instane = new CyberSource.Ptsv2paymentreferencesPaymentInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentreferencesPaymentInformation);
    });
