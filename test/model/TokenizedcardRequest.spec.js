...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TokenizedcardRequest();
  });
  ...
  describe('TokenizedcardRequest', function() {
    it('should create an instance of TokenizedcardRequest', function() {
      // uncomment below and update the code to test TokenizedcardRequest
      //var instane = new CyberSource.TokenizedcardRequest();
      //expect(instance).to.be.a(CyberSource.TokenizedcardRequest);
    });
