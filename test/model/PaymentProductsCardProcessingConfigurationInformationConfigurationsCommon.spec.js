...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentProductsCardProcessingConfigurationInformationConfigurationsCommon();
  });
  ...
  describe('PaymentProductsCardProcessingConfigurationInformationConfigurationsCommon', function() {
    it('should create an instance of PaymentProductsCardProcessingConfigurationInformationConfigurationsCommon', function() {
      // uncomment below and update the code to test PaymentProductsCardProcessingConfigurationInformationConfigurationsCommon
      //var instane = new CyberSource.PaymentProductsCardProcessingConfigurationInformationConfigurationsCommon();
      //expect(instance).to.be.a(CyberSource.PaymentProductsCardProcessingConfigurationInformationConfigurationsCommon);
    });
