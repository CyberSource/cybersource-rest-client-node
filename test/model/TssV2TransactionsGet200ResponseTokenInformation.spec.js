...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TssV2TransactionsGet200ResponseTokenInformation();
  });
  ...
  describe('TssV2TransactionsGet200ResponseTokenInformation', function() {
    it('should create an instance of TssV2TransactionsGet200ResponseTokenInformation', function() {
      // uncomment below and update the code to test TssV2TransactionsGet200ResponseTokenInformation
      //var instane = new CyberSource.TssV2TransactionsGet200ResponseTokenInformation();
      //expect(instance).to.be.a(CyberSource.TssV2TransactionsGet200ResponseTokenInformation);
    });
