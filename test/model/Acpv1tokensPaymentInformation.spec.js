...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Acpv1tokensPaymentInformation();
  });
  ...
  describe('Acpv1tokensPaymentInformation', function() {
    it('should create an instance of Acpv1tokensPaymentInformation', function() {
      // uncomment below and update the code to test Acpv1tokensPaymentInformation
      //var instane = new CyberSource.Acpv1tokensPaymentInformation();
      //expect(instance).to.be.a(CyberSource.Acpv1tokensPaymentInformation);
    });
