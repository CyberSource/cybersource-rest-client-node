...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ucv1sessionsDataOrderInformationInvoiceDetails();
  });
  ...
  describe('Ucv1sessionsDataOrderInformationInvoiceDetails', function() {
    it('should create an instance of Ucv1sessionsDataOrderInformationInvoiceDetails', function() {
      // uncomment below and update the code to test Ucv1sessionsDataOrderInformationInvoiceDetails
      //var instane = new CyberSource.Ucv1sessionsDataOrderInformationInvoiceDetails();
      //expect(instance).to.be.a(CyberSource.Ucv1sessionsDataOrderInformationInvoiceDetails);
    });
