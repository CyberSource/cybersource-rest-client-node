...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PullFunds201ResponseProcessorInformation();
  });
  ...
  describe('PullFunds201ResponseProcessorInformation', function() {
    it('should create an instance of PullFunds201ResponseProcessorInformation', function() {
      // uncomment below and update the code to test PullFunds201ResponseProcessorInformation
      //var instane = new CyberSource.PullFunds201ResponseProcessorInformation();
      //expect(instance).to.be.a(CyberSource.PullFunds201ResponseProcessorInformation);
    });
