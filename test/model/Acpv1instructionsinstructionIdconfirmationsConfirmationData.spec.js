...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Acpv1instructionsinstructionIdconfirmationsConfirmationData();
  });
  ...
  describe('Acpv1instructionsinstructionIdconfirmationsConfirmationData', function() {
    it('should create an instance of Acpv1instructionsinstructionIdconfirmationsConfirmationData', function() {
      // uncomment below and update the code to test Acpv1instructionsinstructionIdconfirmationsConfirmationData
      //var instane = new CyberSource.Acpv1instructionsinstructionIdconfirmationsConfirmationData();
      //expect(instance).to.be.a(CyberSource.Acpv1instructionsinstructionIdconfirmationsConfirmationData);
    });
