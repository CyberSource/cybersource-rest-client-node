...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2billingagreementsConsumerAuthenticationInformation();
  });
  ...
  describe('Ptsv2billingagreementsConsumerAuthenticationInformation', function() {
    it('should create an instance of Ptsv2billingagreementsConsumerAuthenticationInformation', function() {
      // uncomment below and update the code to test Ptsv2billingagreementsConsumerAuthenticationInformation
      //var instane = new CyberSource.Ptsv2billingagreementsConsumerAuthenticationInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2billingagreementsConsumerAuthenticationInformation);
    });
