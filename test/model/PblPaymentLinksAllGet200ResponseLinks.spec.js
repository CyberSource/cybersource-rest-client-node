...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PblPaymentLinksAllGet200ResponseLinks();
  });
  ...
  describe('PblPaymentLinksAllGet200ResponseLinks', function() {
    it('should create an instance of PblPaymentLinksAllGet200ResponseLinks', function() {
      // uncomment below and update the code to test PblPaymentLinksAllGet200ResponseLinks
      //var instane = new CyberSource.PblPaymentLinksAllGet200ResponseLinks();
      //expect(instance).to.be.a(CyberSource.PblPaymentLinksAllGet200ResponseLinks);
    });
