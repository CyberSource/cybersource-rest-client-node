...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2002EmbeddedBatches();
  });
  ...
  describe('InlineResponse2002EmbeddedBatches', function() {
    it('should create an instance of InlineResponse2002EmbeddedBatches', function() {
      // uncomment below and update the code to test InlineResponse2002EmbeddedBatches
      //var instane = new CyberSource.InlineResponse2002EmbeddedBatches();
      //expect(instance).to.be.a(CyberSource.InlineResponse2002EmbeddedBatches);
    });
