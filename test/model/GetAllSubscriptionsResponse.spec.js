...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.GetAllSubscriptionsResponse();
  });
  ...
  describe('GetAllSubscriptionsResponse', function() {
    it('should create an instance of GetAllSubscriptionsResponse', function() {
      // uncomment below and update the code to test GetAllSubscriptionsResponse
      //var instane = new CyberSource.GetAllSubscriptionsResponse();
      //expect(instance).to.be.a(CyberSource.GetAllSubscriptionsResponse);
    });
