...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Vasv2taxOrderInformation();
  });
  ...
  describe('Vasv2taxOrderInformation', function() {
    it('should create an instance of Vasv2taxOrderInformation', function() {
      // uncomment below and update the code to test Vasv2taxOrderInformation
      //var instane = new CyberSource.Vasv2taxOrderInformation();
      //expect(instance).to.be.a(CyberSource.Vasv2taxOrderInformation);
    });
