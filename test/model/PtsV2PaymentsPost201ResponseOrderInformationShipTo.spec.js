...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PtsV2PaymentsPost201ResponseOrderInformationShipTo();
  });
  ...
  describe('PtsV2PaymentsPost201ResponseOrderInformationShipTo', function() {
    it('should create an instance of PtsV2PaymentsPost201ResponseOrderInformationShipTo', function() {
      // uncomment below and update the code to test PtsV2PaymentsPost201ResponseOrderInformationShipTo
      //var instane = new CyberSource.PtsV2PaymentsPost201ResponseOrderInformationShipTo();
      //expect(instance).to.be.a(CyberSource.PtsV2PaymentsPost201ResponseOrderInformationShipTo);
    });
