...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.DefaultPaymentInstrumentBuyerInformation();
  });
  ...
  describe('DefaultPaymentInstrumentBuyerInformation', function() {
    it('should create an instance of DefaultPaymentInstrumentBuyerInformation', function() {
      // uncomment below and update the code to test DefaultPaymentInstrumentBuyerInformation
      //var instane = new CyberSource.DefaultPaymentInstrumentBuyerInformation();
      //expect(instance).to.be.a(CyberSource.DefaultPaymentInstrumentBuyerInformation);
    });
