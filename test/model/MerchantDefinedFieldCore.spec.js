...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.MerchantDefinedFieldCore();
  });
  ...
  describe('MerchantDefinedFieldCore', function() {
    it('should create an instance of MerchantDefinedFieldCore', function() {
      // uncomment below and update the code to test MerchantDefinedFieldCore
      //var instane = new CyberSource.MerchantDefinedFieldCore();
      //expect(instance).to.be.a(CyberSource.MerchantDefinedFieldCore);
    });
