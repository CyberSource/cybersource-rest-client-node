...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsidrefundsTravelInformationTransitAirline();
  });
  ...
  describe('Ptsv2paymentsidrefundsTravelInformationTransitAirline', function() {
    it('should create an instance of Ptsv2paymentsidrefundsTravelInformationTransitAirline', function() {
      // uncomment below and update the code to test Ptsv2paymentsidrefundsTravelInformationTransitAirline
      //var instane = new CyberSource.Ptsv2paymentsidrefundsTravelInformationTransitAirline();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsidrefundsTravelInformationTransitAirline);
    });
