...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2billingagreementsOrderInformationBillTo();
  });
  ...
  describe('Ptsv2billingagreementsOrderInformationBillTo', function() {
    it('should create an instance of Ptsv2billingagreementsOrderInformationBillTo', function() {
      // uncomment below and update the code to test Ptsv2billingagreementsOrderInformationBillTo
      //var instane = new CyberSource.Ptsv2billingagreementsOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.Ptsv2billingagreementsOrderInformationBillTo);
    });
