...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PullFundsRefundRequest();
  });
  ...
  describe('PullFundsRefundRequest', function() {
    it('should create an instance of PullFundsRefundRequest', function() {
      // uncomment below and update the code to test PullFundsRefundRequest
      //var instane = new CyberSource.PullFundsRefundRequest();
      //expect(instance).to.be.a(CyberSource.PullFundsRefundRequest);
    });
