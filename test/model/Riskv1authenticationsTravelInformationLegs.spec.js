...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1authenticationsTravelInformationLegs();
  });
  ...
  describe('Riskv1authenticationsTravelInformationLegs', function() {
    it('should create an instance of Riskv1authenticationsTravelInformationLegs', function() {
      // uncomment below and update the code to test Riskv1authenticationsTravelInformationLegs
      //var instane = new CyberSource.Riskv1authenticationsTravelInformationLegs();
      //expect(instance).to.be.a(CyberSource.Riskv1authenticationsTravelInformationLegs);
    });
