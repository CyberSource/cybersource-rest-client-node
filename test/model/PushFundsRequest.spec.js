...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PushFundsRequest();
  });
  ...
  describe('PushFundsRequest', function() {
    it('should create an instance of PushFundsRequest', function() {
      // uncomment below and update the code to test PushFundsRequest
