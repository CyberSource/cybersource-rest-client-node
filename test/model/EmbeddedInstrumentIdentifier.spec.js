...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.EmbeddedInstrumentIdentifier();
  });
  ...
  describe('EmbeddedInstrumentIdentifier', function() {
    it('should create an instance of EmbeddedInstrumentIdentifier', function() {
      // uncomment below and update the code to test EmbeddedInstrumentIdentifier
      //var instane = new CyberSource.EmbeddedInstrumentIdentifier();
      //expect(instance).to.be.a(CyberSource.EmbeddedInstrumentIdentifier);
    });
