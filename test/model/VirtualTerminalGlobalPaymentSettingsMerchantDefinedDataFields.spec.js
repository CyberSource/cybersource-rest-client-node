...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.VirtualTerminalGlobalPaymentSettingsMerchantDefinedDataFields();
  });
  ...
  describe('VirtualTerminalGlobalPaymentSettingsMerchantDefinedDataFields', function() {
    it('should create an instance of VirtualTerminalGlobalPaymentSettingsMerchantDefinedDataFields', function() {
      // uncomment below and update the code to test VirtualTerminalGlobalPaymentSettingsMerchantDefinedDataFields
      //var instane = new CyberSource.VirtualTerminalGlobalPaymentSettingsMerchantDefinedDataFields();
      //expect(instance).to.be.a(CyberSource.VirtualTerminalGlobalPaymentSettingsMerchantDefinedDataFields);
    });
