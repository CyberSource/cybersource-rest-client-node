...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Iccv1tokensPaymentInformation();
  });
  ...
  describe('Iccv1tokensPaymentInformation', function() {
    it('should create an instance of Iccv1tokensPaymentInformation', function() {
      // uncomment below and update the code to test Iccv1tokensPaymentInformation
      //var instane = new CyberSource.Iccv1tokensPaymentInformation();
      //expect(instance).to.be.a(CyberSource.Iccv1tokensPaymentInformation);
    });
