...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.UpdatePaymentLinkRequest();
  });
  ...
  describe('UpdatePaymentLinkRequest', function() {
    it('should create an instance of UpdatePaymentLinkRequest', function() {
      ...
      //var instane = new CyberSource.UpdatePaymentLinkRequest();
      //expect(instance).to.be.a(CyberSource.UpdatePaymentLinkRequest);
    });
