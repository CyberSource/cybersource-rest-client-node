...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2009EmbeddedBatches();
  });
  ...
  describe('InlineResponse2009EmbeddedBatches', function() {
    it('should create an instance of InlineResponse2009EmbeddedBatches', function() {
      // uncomment below and update the code to test InlineResponse2009EmbeddedBatches
      //var instane = new CyberSource.InlineResponse2009EmbeddedBatches();
      //expect(instance).to.be.a(CyberSource.InlineResponse2009EmbeddedBatches);
    });
