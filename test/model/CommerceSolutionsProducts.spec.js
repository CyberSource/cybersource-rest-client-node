...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CommerceSolutionsProducts();
  });
  ...
  describe('CommerceSolutionsProducts', function() {
    it('should create an instance of CommerceSolutionsProducts', function() {
      // uncomment below and update the code to test CommerceSolutionsProducts
      //var instane = new CyberSource.CommerceSolutionsProducts();
      //expect(instance).to.be.a(CyberSource.CommerceSolutionsProducts);
    });
