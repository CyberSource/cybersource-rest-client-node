...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CardProcessingConfigCommonProcessors();
  });
  ...
  describe('CardProcessingConfigCommonProcessors', function() {
    it('should create an instance of CardProcessingConfigCommonProcessors', function() {
      // uncomment below and update the code to test CardProcessingConfigCommonProcessors
      //var instane = new CyberSource.CardProcessingConfigCommonProcessors();
      //expect(instance).to.be.a(CyberSource.CardProcessingConfigCommonProcessors);
    });
