...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.GetAllSubscriptionsResponseSubscriptions();
  });
  ...
  describe('GetAllSubscriptionsResponseSubscriptions', function() {
    it('should create an instance of GetAllSubscriptionsResponseSubscriptions', function() {
      // uncomment below and update the code to test GetAllSubscriptionsResponseSubscriptions
      //var instane = new CyberSource.GetAllSubscriptionsResponseSubscriptions();
      //expect(instance).to.be.a(CyberSource.GetAllSubscriptionsResponseSubscriptions);
    });
