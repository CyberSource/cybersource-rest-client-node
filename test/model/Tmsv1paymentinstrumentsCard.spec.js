...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Tmsv1paymentinstrumentsCard();
  });
  ...
  describe('Tmsv1paymentinstrumentsCard', function() {
    it('should create an instance of Tmsv1paymentinstrumentsCard', function() {
      // uncomment below and update the code to test Tmsv1paymentinstrumentsCard
      //var instane = new CyberSource.Tmsv1paymentinstrumentsCard();
      //expect(instance).to.be.a(CyberSource.Tmsv1paymentinstrumentsCard);
    });
