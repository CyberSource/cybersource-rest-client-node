...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TmsBinLookup();
  });
  ...
  describe('TmsBinLookup', function() {
    it('should create an instance of TmsBinLookup', function() {
      // uncomment below and update the code to test TmsBinLookup
      //var instane = new CyberSource.TmsBinLookup();
      //expect(instance).to.be.a(CyberSource.TmsBinLookup);
    });
