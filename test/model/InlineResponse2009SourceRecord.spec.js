...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2009SourceRecord();
  });
  ...
  describe('InlineResponse2009SourceRecord', function() {
    it('should create an instance of InlineResponse2009SourceRecord', function() {
      // uncomment below and update the code to test InlineResponse2009SourceRecord
      //var instane = new CyberSource.InlineResponse2009SourceRecord();
      //expect(instance).to.be.a(CyberSource.InlineResponse2009SourceRecord);
    });
