...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.ReportDefinitionDefaultSettings();
  });
  ...
  describe('ReportDefinitionDefaultSettings', function() {
    it('should create an instance of ReportDefinitionDefaultSettings', function() {
      // uncomment below and update the code to test ReportDefinitionDefaultSettings
      //var instane = new CyberSource.ReportDefinitionDefaultSettings();
      //expect(instance).to.be.a(CyberSource.ReportDefinitionDefaultSettings);
    });
