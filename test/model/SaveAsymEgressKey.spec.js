...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.SaveAsymEgressKey();
  });
  ...
  describe('SaveAsymEgressKey', function() {
    it('should create an instance of SaveAsymEgressKey', function() {
      // uncomment below and update the code to test SaveAsymEgressKey
      //var instane = new CyberSource.SaveAsymEgressKey();
      //expect(instance).to.be.a(CyberSource.SaveAsymEgressKey);
    });
    ...
    it('should have the property clientRequestAction (base name: "clientRequestAction")', function() {
      // uncomment below and update the code to test the property clientRequestAction
      //var instane = new CyberSource.SaveAsymEgressKey();
      //expect(instance).to.be();
    });
