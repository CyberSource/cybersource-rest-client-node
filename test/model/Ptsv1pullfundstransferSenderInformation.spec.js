...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv1pullfundstransferSenderInformation();
  });
  ...
  describe('Ptsv1pullfundstransferSenderInformation', function() {
    it('should create an instance of Ptsv1pullfundstransferSenderInformation', function() {
      // uncomment below and update the code to test Ptsv1pullfundstransferSenderInformation
      //var instane = new CyberSource.Ptsv1pullfundstransferSenderInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv1pullfundstransferSenderInformation);
    });
