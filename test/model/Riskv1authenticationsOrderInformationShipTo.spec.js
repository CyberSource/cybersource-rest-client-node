...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1authenticationsOrderInformationShipTo();
  });
  ...
  describe('Riskv1authenticationsOrderInformationShipTo', function() {
    it('should create an instance of Riskv1authenticationsOrderInformationShipTo', function() {
      // uncomment below and update the code to test Riskv1authenticationsOrderInformationShipTo
      //var instane = new CyberSource.Riskv1authenticationsOrderInformationShipTo();
      //expect(instance).to.be.a(CyberSource.Riskv1authenticationsOrderInformationShipTo);
    });
