...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv1pullfundstransferRecipientInformation();
  });
  ...
  describe('Ptsv1pullfundstransferRecipientInformation', function() {
    it('should create an instance of Ptsv1pullfundstransferRecipientInformation', function() {
      // uncomment below and update the code to test Ptsv1pullfundstransferRecipientInformation
      //var instane = new CyberSource.Ptsv1pullfundstransferRecipientInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv1pullfundstransferRecipientInformation);
    });
