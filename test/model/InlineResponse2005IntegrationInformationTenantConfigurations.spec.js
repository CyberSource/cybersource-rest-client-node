...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2005IntegrationInformationTenantConfigurations();
  });
  ...
  describe('InlineResponse2005IntegrationInformationTenantConfigurations', function() {
    it('should create an instance of InlineResponse2005IntegrationInformationTenantConfigurations', function() {
      // uncomment below and update the code to test InlineResponse2005IntegrationInformationTenantConfigurations
      //var instane = new CyberSource.InlineResponse2005IntegrationInformationTenantConfigurations();
      //expect(instance).to.be.a(CyberSource.InlineResponse2005IntegrationInformationTenantConfigurations);
    });
