...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Binv1binlookupPaymentInformation();
  });
  ...
  describe('Binv1binlookupPaymentInformation', function() {
    it('should create an instance of Binv1binlookupPaymentInformation', function() {
      // uncomment below and update the code to test Binv1binlookupPaymentInformation
      //var instane = new CyberSource.Binv1binlookupPaymentInformation();
      //expect(instance).to.be.a(CyberSource.Binv1binlookupPaymentInformation);
    });
