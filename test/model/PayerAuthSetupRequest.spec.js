...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PayerAuthSetupRequest();
  });
  ...
  describe('PayerAuthSetupRequest', function() {
    it('should create an instance of PayerAuthSetupRequest', function() {
      // uncomment below and update the code to test PayerAuthSetupRequest
      //var instane = new CyberSource.PayerAuthSetupRequest();
      //expect(instance).to.be.a(CyberSource.PayerAuthSetupRequest);
    });
