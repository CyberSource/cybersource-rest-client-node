...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentInstrumentListLinks();
  });
  ...
  describe('PaymentInstrumentListLinks', function() {
    it('should create an instance of PaymentInstrumentListLinks', function() {
      // uncomment below and update the code to test PaymentInstrumentListLinks
      //var instane = new CyberSource.PaymentInstrumentListLinks();
      //expect(instance).to.be.a(CyberSource.PaymentInstrumentListLinks);
    });
