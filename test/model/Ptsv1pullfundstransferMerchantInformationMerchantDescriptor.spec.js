...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv1pullfundstransferMerchantInformationMerchantDescriptor();
  });
  ...
  describe('Ptsv1pullfundstransferMerchantInformationMerchantDescriptor', function() {
    it('should create an instance of Ptsv1pullfundstransferMerchantInformationMerchantDescriptor', function() {
      // uncomment below and update the code to test Ptsv1pullfundstransferMerchantInformationMerchantDescriptor
      //var instane = new CyberSource.Ptsv1pullfundstransferMerchantInformationMerchantDescriptor();
      //expect(instance).to.be.a(CyberSource.Ptsv1pullfundstransferMerchantInformationMerchantDescriptor);
    });
