...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Iccv1instructionsinstructionIdconfirmationsProcessorInformation();
  });
  ...
  describe('Iccv1instructionsinstructionIdconfirmationsProcessorInformation', function() {
    it('should create an instance of Iccv1instructionsinstructionIdconfirmationsProcessorInformation', function() {
      // uncomment below and update the code to test Iccv1instructionsinstructionIdconfirmationsProcessorInformation
      //var instane = new CyberSource.Iccv1instructionsinstructionIdconfirmationsProcessorInformation();
      //expect(instance).to.be.a(CyberSource.Iccv1instructionsinstructionIdconfirmationsProcessorInformation);
    });
