...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentProducts();
  });
  ...
  describe('PaymentProducts', function() {
    it('should create an instance of PaymentProducts', function() {
      // uncomment below and update the code to test PaymentProducts
      //var instane = new CyberSource.PaymentProducts();
      //expect(instance).to.be.a(CyberSource.PaymentProducts);
    });
    ...
    it('should have the property differentialFee (base name: "differentialFee")', function() {
      // uncomment below and update the code to test the property differentialFee
      //var instane = new CyberSource.PaymentProducts();
      //expect(instance).to.be();
    });
