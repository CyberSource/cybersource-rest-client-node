...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.ECheckConfig();
  });
  ...
  describe('ECheckConfig', function() {
    it('should create an instance of ECheckConfig', function() {
      // uncomment below and update the code to test ECheckConfig
      //var instane = new CyberSource.ECheckConfig();
      //expect(instance).to.be.a(CyberSource.ECheckConfig);
    });
