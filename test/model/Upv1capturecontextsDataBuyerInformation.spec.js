...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Upv1capturecontextsDataBuyerInformation();
  });
  ...
  describe('Upv1capturecontextsDataBuyerInformation', function() {
    it('should create an instance of Upv1capturecontextsDataBuyerInformation', function() {
      // uncomment below and update the code to test Upv1capturecontextsDataBuyerInformation
      //var instane = new CyberSource.Upv1capturecontextsDataBuyerInformation();
      //expect(instance).to.be.a(CyberSource.Upv1capturecontextsDataBuyerInformation);
    });
