...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2intentsidOrderInformation();
  });
  ...
  describe('Ptsv2intentsidOrderInformation', function() {
    it('should create an instance of Ptsv2intentsidOrderInformation', function() {
      // uncomment below and update the code to test Ptsv2intentsidOrderInformation
      //var instane = new CyberSource.Ptsv2intentsidOrderInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2intentsidOrderInformation);
    });
