...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.OrderPaymentRequest();
  });
  ...
  describe('OrderPaymentRequest', function() {
    it('should create an instance of OrderPaymentRequest', function() {
      // uncomment below and update the code to test OrderPaymentRequest
      //var instane = new CyberSource.OrderPaymentRequest();
      //expect(instance).to.be.a(CyberSource.OrderPaymentRequest);
    });
