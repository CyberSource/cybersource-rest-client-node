...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1decisionsOrderInformationAddress();
  });
  ...
  describe('Riskv1decisionsOrderInformationAddress', function() {
    it('should create an instance of Riskv1decisionsOrderInformationAddress', function() {
      // uncomment below and update the code to test Riskv1decisionsOrderInformationAddress
      //var instane = new CyberSource.Riskv1decisionsOrderInformationAddress();
      //expect(instance).to.be.a(CyberSource.Riskv1decisionsOrderInformationAddress);
    });
