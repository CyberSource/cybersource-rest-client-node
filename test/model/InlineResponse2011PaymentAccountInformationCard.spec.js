...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2011PaymentAccountInformationCard();
  });
  ...
  describe('InlineResponse2011PaymentAccountInformationCard', function() {
    it('should create an instance of InlineResponse2011PaymentAccountInformationCard', function() {
      // uncomment below and update the code to test InlineResponse2011PaymentAccountInformationCard
      //var instane = new CyberSource.InlineResponse2011PaymentAccountInformationCard();
      //expect(instance).to.be.a(CyberSource.InlineResponse2011PaymentAccountInformationCard);
    });
