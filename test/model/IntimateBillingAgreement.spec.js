...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.IntimateBillingAgreement();
  });
  ...
  describe('IntimateBillingAgreement', function() {
    it('should create an instance of IntimateBillingAgreement', function() {
      // uncomment below and update the code to test IntimateBillingAgreement
      //var instane = new CyberSource.IntimateBillingAgreement();
      //expect(instance).to.be.a(CyberSource.IntimateBillingAgreement);
    });
