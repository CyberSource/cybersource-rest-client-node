...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.RiskProductsPortfolioRiskControls();
  });
  ...
  describe('RiskProductsPortfolioRiskControls', function() {
    it('should create an instance of RiskProductsPortfolioRiskControls', function() {
      // uncomment below and update the code to test RiskProductsPortfolioRiskControls
