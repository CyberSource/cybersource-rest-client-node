...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1authenticationsetupsPaymentInformation();
  });
  ...
  describe('Riskv1authenticationsetupsPaymentInformation', function() {
    it('should create an instance of Riskv1authenticationsetupsPaymentInformation', function() {
      // uncomment below and update the code to test Riskv1authenticationsetupsPaymentInformation
      //var instane = new CyberSource.Riskv1authenticationsetupsPaymentInformation();
      //expect(instance).to.be.a(CyberSource.Riskv1authenticationsetupsPaymentInformation);
    });
