...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentInstrumentListEmbeddedPaymentInstruments();
  });
  ...
  describe('PaymentInstrumentListEmbeddedPaymentInstruments', function() {
    it('should create an instance of PaymentInstrumentListEmbeddedPaymentInstruments', function() {
      // uncomment below and update the code to test PaymentInstrumentListEmbeddedPaymentInstruments
      //var instane = new CyberSource.PaymentInstrumentListEmbeddedPaymentInstruments();
      //expect(instance).to.be.a(CyberSource.PaymentInstrumentListEmbeddedPaymentInstruments);
    });
