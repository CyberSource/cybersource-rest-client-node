...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Upv1capturecontextsOrderInformationBillTo();
  });
  ...
  describe('Upv1capturecontextsOrderInformationBillTo', function() {
    it('should create an instance of Upv1capturecontextsOrderInformationBillTo', function() {
      // uncomment below and update the code to test Upv1capturecontextsOrderInformationBillTo
      //var instane = new CyberSource.Upv1capturecontextsOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.Upv1capturecontextsOrderInformationBillTo);
    });
