...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.GetSubscriptionResponse1PaymentInstrument();
  });
  ...
  describe('GetSubscriptionResponse1PaymentInstrument', function() {
    it('should create an instance of GetSubscriptionResponse1PaymentInstrument', function() {
      // uncomment below and update the code to test GetSubscriptionResponse1PaymentInstrument
      //var instane = new CyberSource.GetSubscriptionResponse1PaymentInstrument();
      //expect(instance).to.be.a(CyberSource.GetSubscriptionResponse1PaymentInstrument);
    });
