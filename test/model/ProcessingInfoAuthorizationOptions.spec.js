...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.ProcessingInfoAuthorizationOptions();
  });
  ...
  describe('ProcessingInfoAuthorizationOptions', function() {
    it('should create an instance of ProcessingInfoAuthorizationOptions', function() {
      // uncomment below and update the code to test ProcessingInfoAuthorizationOptions
      //var instane = new CyberSource.ProcessingInfoAuthorizationOptions();
      //expect(instance).to.be.a(CyberSource.ProcessingInfoAuthorizationOptions);
    });
