...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Acpv1instructionsinstructionIdcredentialsMerchantInformation();
  });
  ...
  describe('Acpv1instructionsinstructionIdcredentialsMerchantInformation', function() {
    it('should create an instance of Acpv1instructionsinstructionIdcredentialsMerchantInformation', function() {
      // uncomment below and update the code to test Acpv1instructionsinstructionIdcredentialsMerchantInformation
      //var instane = new CyberSource.Acpv1instructionsinstructionIdcredentialsMerchantInformation();
      //expect(instance).to.be.a(CyberSource.Acpv1instructionsinstructionIdcredentialsMerchantInformation);
    });
