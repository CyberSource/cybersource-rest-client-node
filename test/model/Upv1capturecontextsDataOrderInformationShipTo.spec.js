...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Upv1capturecontextsDataOrderInformationShipTo();
  });
  ...
  describe('Upv1capturecontextsDataOrderInformationShipTo', function() {
    it('should create an instance of Upv1capturecontextsDataOrderInformationShipTo', function() {
      // uncomment below and update the code to test Upv1capturecontextsDataOrderInformationShipTo
      //var instane = new CyberSource.Upv1capturecontextsDataOrderInformationShipTo();
      //expect(instance).to.be.a(CyberSource.Upv1capturecontextsDataOrderInformationShipTo);
    });
