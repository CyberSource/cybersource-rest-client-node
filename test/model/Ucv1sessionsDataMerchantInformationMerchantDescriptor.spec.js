...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ucv1sessionsDataMerchantInformationMerchantDescriptor();
  });
  ...
  describe('Ucv1sessionsDataMerchantInformationMerchantDescriptor', function() {
    it('should create an instance of Ucv1sessionsDataMerchantInformationMerchantDescriptor', function() {
      // uncomment below and update the code to test Ucv1sessionsDataMerchantInformationMerchantDescriptor
      //var instane = new CyberSource.Ucv1sessionsDataMerchantInformationMerchantDescriptor();
      //expect(instance).to.be.a(CyberSource.Ucv1sessionsDataMerchantInformationMerchantDescriptor);
    });
