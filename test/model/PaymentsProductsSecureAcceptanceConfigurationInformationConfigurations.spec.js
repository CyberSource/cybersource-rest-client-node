...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentsProductsSecureAcceptanceConfigurationInformationConfigurations();
  });
  ...
  describe('PaymentsProductsSecureAcceptanceConfigurationInformationConfigurations', function() {
    it('should create an instance of PaymentsProductsSecureAcceptanceConfigurationInformationConfigurations', function() {
      // uncomment below and update the code to test PaymentsProductsSecureAcceptanceConfigurationInformationConfigurations
      //var instane = new CyberSource.PaymentsProductsSecureAcceptanceConfigurationInformationConfigurations();
      //expect(instance).to.be.a(CyberSource.PaymentsProductsSecureAcceptanceConfigurationInformationConfigurations);
    });
