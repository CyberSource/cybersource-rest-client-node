...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication();
  });
  ...
  describe('Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication', function() {
    it('should create an instance of Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication', function() {
      // uncomment below and update the code to test Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication
      //var instane = new CyberSource.Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication();
      //expect(instance).to.be.a(CyberSource.Ptsv1pullfundstransferSenderInformationConsumerAuthenticationStrongAuthentication);
    });
