...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse200PaymentBatchSummaries();
  });
  ...
  describe('InlineResponse200PaymentBatchSummaries', function() {
    it('should create an instance of InlineResponse200PaymentBatchSummaries', function() {
      // uncomment below and update the code to test InlineResponse200PaymentBatchSummaries
      //var instane = new CyberSource.InlineResponse200PaymentBatchSummaries();
      //expect(instance).to.be.a(CyberSource.InlineResponse200PaymentBatchSummaries);
    });
