...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ucv1sessionsDataBuyerInformation();
  });
  ...
  describe('Ucv1sessionsDataBuyerInformation', function() {
    it('should create an instance of Ucv1sessionsDataBuyerInformation', function() {
      // uncomment below and update the code to test Ucv1sessionsDataBuyerInformation
      //var instane = new CyberSource.Ucv1sessionsDataBuyerInformation();
      //expect(instance).to.be.a(CyberSource.Ucv1sessionsDataBuyerInformation);
    });
