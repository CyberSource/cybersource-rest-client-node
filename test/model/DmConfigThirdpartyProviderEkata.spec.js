...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.DmConfigThirdpartyProviderEkata();
  });
  ...
  describe('DmConfigThirdpartyProviderEkata', function() {
    it('should create an instance of DmConfigThirdpartyProviderEkata', function() {
      // uncomment below and update the code to test DmConfigThirdpartyProviderEkata
      //var instane = new CyberSource.DmConfigThirdpartyProviderEkata();
      //expect(instance).to.be.a(CyberSource.DmConfigThirdpartyProviderEkata);
    });
