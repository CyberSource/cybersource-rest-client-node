...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.GetAllPlansResponse();
  });
  ...
  describe('GetAllPlansResponse', function() {
    it('should create an instance of GetAllPlansResponse', function() {
      // uncomment below and update the code to test GetAllPlansResponse
      //var instane = new CyberSource.GetAllPlansResponse();
      //expect(instance).to.be.a(CyberSource.GetAllPlansResponse);
    });
