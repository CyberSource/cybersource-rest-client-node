...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentsProductsECheck();
  });
  ...
  describe('PaymentsProductsECheck', function() {
    it('should create an instance of PaymentsProductsECheck', function() {
      // uncomment below and update the code to test PaymentsProductsECheck
      //var instane = new CyberSource.PaymentsProductsECheck();
      //expect(instance).to.be.a(CyberSource.PaymentsProductsECheck);
    });
