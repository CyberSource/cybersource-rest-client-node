...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2014KeyInformation();
  });
  ...
  describe('InlineResponse2014KeyInformation', function() {
    it('should create an instance of InlineResponse2014KeyInformation', function() {
      // uncomment below and update the code to test InlineResponse2014KeyInformation
      //var instane = new CyberSource.InlineResponse2014KeyInformation();
      //expect(instance).to.be.a(CyberSource.InlineResponse2014KeyInformation);
    });
