...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Upv1capturecontextsDataRecipientInformation();
  });
  ...
  describe('Upv1capturecontextsDataRecipientInformation', function() {
    it('should create an instance of Upv1capturecontextsDataRecipientInformation', function() {
      // uncomment below and update the code to test Upv1capturecontextsDataRecipientInformation
      //var instane = new CyberSource.Upv1capturecontextsDataRecipientInformation();
      //expect(instance).to.be.a(CyberSource.Upv1capturecontextsDataRecipientInformation);
    });
