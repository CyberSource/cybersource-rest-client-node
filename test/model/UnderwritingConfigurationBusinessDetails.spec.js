...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.UnderwritingConfigurationBusinessDetails();
  });
  ...
  describe('UnderwritingConfigurationBusinessDetails', function() {
    it('should create an instance of UnderwritingConfigurationBusinessDetails', function() {
      // uncomment below and update the code to test UnderwritingConfigurationBusinessDetails
      //var instane = new CyberSource.UnderwritingConfigurationBusinessDetails();
      //expect(instance).to.be.a(CyberSource.UnderwritingConfigurationBusinessDetails);
    });
