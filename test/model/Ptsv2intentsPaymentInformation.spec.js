...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2intentsPaymentInformation();
  });
  ...
  describe('Ptsv2intentsPaymentInformation', function() {
    it('should create an instance of Ptsv2intentsPaymentInformation', function() {
      // uncomment below and update the code to test Ptsv2intentsPaymentInformation
      //var instane = new CyberSource.Ptsv2intentsPaymentInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2intentsPaymentInformation);
    });
