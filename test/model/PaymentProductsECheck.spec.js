...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentProductsECheck();
  });
  ...
  describe('PaymentProductsECheck', function() {
    it('should create an instance of PaymentProductsECheck', function() {
      // uncomment below and update the code to test PaymentProductsECheck
      //var instane = new CyberSource.PaymentProductsECheck();
      //expect(instance).to.be.a(CyberSource.PaymentProductsECheck);
    });
