...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbeddedInstrumentIdentifier();
  });
  ...
  describe('Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbeddedInstrumentIdentifier', function() {
    it('should create an instance of Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbeddedInstrumentIdentifier', function() {
      // uncomment below and update the code to test Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbeddedInstrumentIdentifier
      //var instane = new CyberSource.Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbeddedInstrumentIdentifier();
      //expect(instance).to.be.a(CyberSource.Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbeddedInstrumentIdentifier);
    });
