...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2billingagreementsPaymentInformationTokenizedCard();
  });
  ...
  describe('Ptsv2billingagreementsPaymentInformationTokenizedCard', function() {
    it('should create an instance of Ptsv2billingagreementsPaymentInformationTokenizedCard', function() {
      // uncomment below and update the code to test Ptsv2billingagreementsPaymentInformationTokenizedCard
      //var instane = new CyberSource.Ptsv2billingagreementsPaymentInformationTokenizedCard();
      //expect(instance).to.be.a(CyberSource.Ptsv2billingagreementsPaymentInformationTokenizedCard);
    });
