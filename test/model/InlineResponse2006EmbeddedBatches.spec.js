...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2006EmbeddedBatches();
  });
  ...
  describe('InlineResponse2006EmbeddedBatches', function() {
    it('should create an instance of InlineResponse2006EmbeddedBatches', function() {
      // uncomment below and update the code to test InlineResponse2006EmbeddedBatches
      //var instane = new CyberSource.InlineResponse2006EmbeddedBatches();
      //expect(instance).to.be.a(CyberSource.InlineResponse2006EmbeddedBatches);
    });
