...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2intentsOrderInformationShipTo();
  });
  ...
  describe('Ptsv2intentsOrderInformationShipTo', function() {
    it('should create an instance of Ptsv2intentsOrderInformationShipTo', function() {
      // uncomment below and update the code to test Ptsv2intentsOrderInformationShipTo
      //var instane = new CyberSource.Ptsv2intentsOrderInformationShipTo();
      //expect(instance).to.be.a(CyberSource.Ptsv2intentsOrderInformationShipTo);
    });
