...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.DefaultPaymentInstrumentBillTo();
  });
  ...
  describe('DefaultPaymentInstrumentBillTo', function() {
    it('should create an instance of DefaultPaymentInstrumentBillTo', function() {
      // uncomment below and update the code to test DefaultPaymentInstrumentBillTo
      //var instane = new CyberSource.DefaultPaymentInstrumentBillTo();
      //expect(instance).to.be.a(CyberSource.DefaultPaymentInstrumentBillTo);
    });
