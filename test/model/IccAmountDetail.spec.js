...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.IccAmountDetail();
  });
  ...
  describe('IccAmountDetail', function() {
    it('should create an instance of IccAmountDetail', function() {
      // uncomment below and update the code to test IccAmountDetail
      //var instane = new CyberSource.IccAmountDetail();
      //expect(instance).to.be.a(CyberSource.IccAmountDetail);
    });
