...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PushFunds201ResponseLinks();
  });
  ...
  describe('PushFunds201ResponseLinks', function() {
    it('should create an instance of PushFunds201ResponseLinks', function() {
      // uncomment below and update the code to test PushFunds201ResponseLinks
      //var instane = new CyberSource.PushFunds201ResponseLinks();
      //expect(instance).to.be.a(CyberSource.PushFunds201ResponseLinks);
    });
