...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Tmsv1paymentinstrumentsBillTo();
  });
  ...
  describe('Tmsv1paymentinstrumentsBillTo', function() {
    it('should create an instance of Tmsv1paymentinstrumentsBillTo', function() {
      // uncomment below and update the code to test Tmsv1paymentinstrumentsBillTo
      //var instane = new CyberSource.Tmsv1paymentinstrumentsBillTo();
      //expect(instance).to.be.a(CyberSource.Tmsv1paymentinstrumentsBillTo);
    });
