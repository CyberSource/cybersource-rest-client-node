...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ucv1sessionsDataOrderInformationBillToCompany();
  });
  ...
  describe('Ucv1sessionsDataOrderInformationBillToCompany', function() {
    it('should create an instance of Ucv1sessionsDataOrderInformationBillToCompany', function() {
      // uncomment below and update the code to test Ucv1sessionsDataOrderInformationBillToCompany
      //var instane = new CyberSource.Ucv1sessionsDataOrderInformationBillToCompany();
      //expect(instance).to.be.a(CyberSource.Ucv1sessionsDataOrderInformationBillToCompany);
    });
