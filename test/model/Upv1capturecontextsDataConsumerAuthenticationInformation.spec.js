...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Upv1capturecontextsDataConsumerAuthenticationInformation();
  });
  ...
  describe('Upv1capturecontextsDataConsumerAuthenticationInformation', function() {
    it('should create an instance of Upv1capturecontextsDataConsumerAuthenticationInformation', function() {
      // uncomment below and update the code to test Upv1capturecontextsDataConsumerAuthenticationInformation
      //var instane = new CyberSource.Upv1capturecontextsDataConsumerAuthenticationInformation();
      //expect(instance).to.be.a(CyberSource.Upv1capturecontextsDataConsumerAuthenticationInformation);
    });
