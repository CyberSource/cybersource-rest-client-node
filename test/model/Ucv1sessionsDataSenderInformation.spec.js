...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ucv1sessionsDataSenderInformation();
  });
  ...
  describe('Ucv1sessionsDataSenderInformation', function() {
    it('should create an instance of Ucv1sessionsDataSenderInformation', function() {
      // uncomment below and update the code to test Ucv1sessionsDataSenderInformation
      //var instane = new CyberSource.Ucv1sessionsDataSenderInformation();
      //expect(instance).to.be.a(CyberSource.Ucv1sessionsDataSenderInformation);
    });
