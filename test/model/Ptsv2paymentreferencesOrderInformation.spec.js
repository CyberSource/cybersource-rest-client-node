...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentreferencesOrderInformation();
  });
  ...
  describe('Ptsv2paymentreferencesOrderInformation', function() {
    it('should create an instance of Ptsv2paymentreferencesOrderInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentreferencesOrderInformation
      //var instane = new CyberSource.Ptsv2paymentreferencesOrderInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentreferencesOrderInformation);
    });
