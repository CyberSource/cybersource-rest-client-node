...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CreateP12KeysRequest();
  });
  ...
  describe('CreateP12KeysRequest', function() {
    it('should create an instance of CreateP12KeysRequest', function() {
      // uncomment below and update the code to test CreateP12KeysRequest
      //var instane = new CyberSource.CreateP12KeysRequest();
      //expect(instance).to.be.a(CyberSource.CreateP12KeysRequest);
    });
