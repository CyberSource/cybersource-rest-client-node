...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Upv1capturecontextsDataOrderInformationBillTo();
  });
  ...
  describe('Upv1capturecontextsDataOrderInformationBillTo', function() {
    it('should create an instance of Upv1capturecontextsDataOrderInformationBillTo', function() {
      // uncomment below and update the code to test Upv1capturecontextsDataOrderInformationBillTo
      //var instane = new CyberSource.Upv1capturecontextsDataOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.Upv1capturecontextsDataOrderInformationBillTo);
    });
