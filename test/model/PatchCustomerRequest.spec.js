...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PatchCustomerRequest();
  });
  ...
  describe('PatchCustomerRequest', function() {
    it('should create an instance of PatchCustomerRequest', function() {
      // uncomment below and update the code to test PatchCustomerRequest
      //var instane = new CyberSource.PatchCustomerRequest();
      //expect(instance).to.be.a(CyberSource.PatchCustomerRequest);
    });
