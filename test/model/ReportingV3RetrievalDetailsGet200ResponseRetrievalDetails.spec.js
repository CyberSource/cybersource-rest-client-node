...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.ReportingV3RetrievalDetailsGet200ResponseRetrievalDetails();
  });
  ...
  describe('ReportingV3RetrievalDetailsGet200ResponseRetrievalDetails', function() {
    it('should create an instance of ReportingV3RetrievalDetailsGet200ResponseRetrievalDetails', function() {
      // uncomment below and update the code to test ReportingV3RetrievalDetailsGet200ResponseRetrievalDetails
      //var instane = new CyberSource.ReportingV3RetrievalDetailsGet200ResponseRetrievalDetails();
      //expect(instance).to.be.a(CyberSource.ReportingV3RetrievalDetailsGet200ResponseRetrievalDetails);
    });
