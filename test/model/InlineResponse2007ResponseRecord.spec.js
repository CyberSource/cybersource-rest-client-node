...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2007ResponseRecord();
  });
  ...
  describe('InlineResponse2007ResponseRecord', function() {
    it('should create an instance of InlineResponse2007ResponseRecord', function() {
      // uncomment below and update the code to test InlineResponse2007ResponseRecord
      //var instane = new CyberSource.InlineResponse2007ResponseRecord();
      //expect(instance).to.be.a(CyberSource.InlineResponse2007ResponseRecord);
    });
