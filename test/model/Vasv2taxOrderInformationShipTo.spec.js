...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Vasv2taxOrderInformationShipTo();
  });
  ...
  describe('Vasv2taxOrderInformationShipTo', function() {
    it('should create an instance of Vasv2taxOrderInformationShipTo', function() {
      // uncomment below and update the code to test Vasv2taxOrderInformationShipTo
      //var instane = new CyberSource.Vasv2taxOrderInformationShipTo();
      //expect(instance).to.be.a(CyberSource.Vasv2taxOrderInformationShipTo);
    });
