...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2creditsTokenInformation();
  });
  ...
  describe('Ptsv2creditsTokenInformation', function() {
    it('should create an instance of Ptsv2creditsTokenInformation', function() {
      // uncomment below and update the code to test Ptsv2creditsTokenInformation
      //var instane = new CyberSource.Ptsv2creditsTokenInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2creditsTokenInformation);
    });
