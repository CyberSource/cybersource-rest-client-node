...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Binv1binlookupClientReferenceInformation();
  });
  ...
  describe('Binv1binlookupClientReferenceInformation', function() {
    it('should create an instance of Binv1binlookupClientReferenceInformation', function() {
      // uncomment below and update the code to test Binv1binlookupClientReferenceInformation
      //var instane = new CyberSource.Binv1binlookupClientReferenceInformation();
      //expect(instance).to.be.a(CyberSource.Binv1binlookupClientReferenceInformation);
    });
