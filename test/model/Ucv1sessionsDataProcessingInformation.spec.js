...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ucv1sessionsDataProcessingInformation();
  });
  ...
  describe('Ucv1sessionsDataProcessingInformation', function() {
    it('should create an instance of Ucv1sessionsDataProcessingInformation', function() {
      // uncomment below and update the code to test Ucv1sessionsDataProcessingInformation
      //var instane = new CyberSource.Ucv1sessionsDataProcessingInformation();
      //expect(instance).to.be.a(CyberSource.Ucv1sessionsDataProcessingInformation);
    });
