...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Upv1capturecontextsDataOrderInformation();
  });
  ...
  describe('Upv1capturecontextsDataOrderInformation', function() {
    it('should create an instance of Upv1capturecontextsDataOrderInformation', function() {
      // uncomment below and update the code to test Upv1capturecontextsDataOrderInformation
      //var instane = new CyberSource.Upv1capturecontextsDataOrderInformation();
      //expect(instance).to.be.a(CyberSource.Upv1capturecontextsDataOrderInformation);
    });
