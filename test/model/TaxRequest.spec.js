...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TaxRequest();
  });
  ...
  describe('TaxRequest', function() {
    it('should create an instance of TaxRequest', function() {
      // uncomment below and update the code to test TaxRequest
      //var instane = new CyberSource.TaxRequest();
      //expect(instance).to.be.a(CyberSource.TaxRequest);
    });
