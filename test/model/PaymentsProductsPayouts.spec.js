...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentsProductsPayouts();
  });
  ...
  describe('PaymentsProductsPayouts', function() {
    it('should create an instance of PaymentsProductsPayouts', function() {
      // uncomment below and update the code to test PaymentsProductsPayouts
      //var instane = new CyberSource.PaymentsProductsPayouts();
      //expect(instance).to.be.a(CyberSource.PaymentsProductsPayouts);
    });
