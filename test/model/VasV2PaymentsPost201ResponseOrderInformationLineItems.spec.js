...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.VasV2PaymentsPost201ResponseOrderInformationLineItems();
  });
  ...
  describe('VasV2PaymentsPost201ResponseOrderInformationLineItems', function() {
    it('should create an instance of VasV2PaymentsPost201ResponseOrderInformationLineItems', function() {
      // uncomment below and update the code to test VasV2PaymentsPost201ResponseOrderInformationLineItems
      //var instane = new CyberSource.VasV2PaymentsPost201ResponseOrderInformationLineItems();
      //expect(instance).to.be.a(CyberSource.VasV2PaymentsPost201ResponseOrderInformationLineItems);
    });
