...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2008ResponseRecord();
  });
  ...
  describe('InlineResponse2008ResponseRecord', function() {
    it('should create an instance of InlineResponse2008ResponseRecord', function() {
      // uncomment below and update the code to test InlineResponse2008ResponseRecord
      //var instane = new CyberSource.InlineResponse2008ResponseRecord();
      //expect(instance).to.be.a(CyberSource.InlineResponse2008ResponseRecord);
    });
