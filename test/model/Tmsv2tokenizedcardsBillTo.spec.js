...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Tmsv2tokenizedcardsBillTo();
  });
  ...
  describe('Tmsv2tokenizedcardsBillTo', function() {
    it('should create an instance of Tmsv2tokenizedcardsBillTo', function() {
      // uncomment below and update the code to test Tmsv2tokenizedcardsBillTo
      //var instane = new CyberSource.Tmsv2tokenizedcardsBillTo();
      //expect(instance).to.be.a(CyberSource.Tmsv2tokenizedcardsBillTo);
    });
