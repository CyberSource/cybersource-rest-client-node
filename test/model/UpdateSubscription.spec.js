...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.UpdateSubscription();
  });
  ...
  describe('UpdateSubscription', function() {
    it('should create an instance of UpdateSubscription', function() {
      // uncomment below and update the code to test UpdateSubscription
      //var instane = new CyberSource.UpdateSubscription();
      //expect(instance).to.be.a(CyberSource.UpdateSubscription);
    });
