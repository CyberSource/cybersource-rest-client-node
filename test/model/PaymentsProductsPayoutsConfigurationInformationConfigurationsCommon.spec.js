...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentsProductsPayoutsConfigurationInformationConfigurationsCommon();
  });
  ...
  describe('PaymentsProductsPayoutsConfigurationInformationConfigurationsCommon', function() {
    it('should create an instance of PaymentsProductsPayoutsConfigurationInformationConfigurationsCommon', function() {
      // uncomment below and update the code to test PaymentsProductsPayoutsConfigurationInformationConfigurationsCommon
      //var instane = new CyberSource.PaymentsProductsPayoutsConfigurationInformationConfigurationsCommon();
      //expect(instance).to.be.a(CyberSource.PaymentsProductsPayoutsConfigurationInformationConfigurationsCommon);
    });
