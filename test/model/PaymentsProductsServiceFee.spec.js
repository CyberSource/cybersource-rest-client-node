...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentsProductsServiceFee();
  });
  ...
  describe('PaymentsProductsServiceFee', function() {
    it('should create an instance of PaymentsProductsServiceFee', function() {
      // uncomment below and update the code to test PaymentsProductsServiceFee
      //var instane = new CyberSource.PaymentsProductsServiceFee();
      //expect(instance).to.be.a(CyberSource.PaymentsProductsServiceFee);
    });
