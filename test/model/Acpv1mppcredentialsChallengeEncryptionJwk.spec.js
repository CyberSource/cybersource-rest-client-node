...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Acpv1mppcredentialsChallengeEncryptionJwk();
  });
  ...
  describe('Acpv1mppcredentialsChallengeEncryptionJwk', function() {
    it('should create an instance of Acpv1mppcredentialsChallengeEncryptionJwk', function() {
      // uncomment below and update the code to test Acpv1mppcredentialsChallengeEncryptionJwk
      //var instane = new CyberSource.Acpv1mppcredentialsChallengeEncryptionJwk();
      //expect(instance).to.be.a(CyberSource.Acpv1mppcredentialsChallengeEncryptionJwk);
    });
