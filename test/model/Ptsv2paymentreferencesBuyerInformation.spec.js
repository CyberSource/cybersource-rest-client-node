...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentreferencesBuyerInformation();
  });
  ...
  describe('Ptsv2paymentreferencesBuyerInformation', function() {
    it('should create an instance of Ptsv2paymentreferencesBuyerInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentreferencesBuyerInformation
      //var instane = new CyberSource.Ptsv2paymentreferencesBuyerInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentreferencesBuyerInformation);
    });
