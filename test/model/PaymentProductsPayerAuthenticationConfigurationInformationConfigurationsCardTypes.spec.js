...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes();
  });
  ...
  describe('PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes', function() {
    it('should create an instance of PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes', function() {
      // uncomment below and update the code to test PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes
      //var instane = new CyberSource.PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes();
      //expect(instance).to.be.a(CyberSource.PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes);
    });
