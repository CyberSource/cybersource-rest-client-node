...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsidrefundsPaymentInformationBank();
  });
  ...
  describe('Ptsv2paymentsidrefundsPaymentInformationBank', function() {
    it('should create an instance of Ptsv2paymentsidrefundsPaymentInformationBank', function() {
      // uncomment below and update the code to test Ptsv2paymentsidrefundsPaymentInformationBank
      //var instane = new CyberSource.Ptsv2paymentsidrefundsPaymentInformationBank();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsidrefundsPaymentInformationBank);
    });
