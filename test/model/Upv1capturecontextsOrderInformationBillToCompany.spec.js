...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Upv1capturecontextsOrderInformationBillToCompany();
  });
  ...
  describe('Upv1capturecontextsOrderInformationBillToCompany', function() {
    it('should create an instance of Upv1capturecontextsOrderInformationBillToCompany', function() {
      // uncomment below and update the code to test Upv1capturecontextsOrderInformationBillToCompany
      //var instane = new CyberSource.Upv1capturecontextsOrderInformationBillToCompany();
      //expect(instance).to.be.a(CyberSource.Upv1capturecontextsOrderInformationBillToCompany);
    });
