...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Iccv1instructionsinstructionIdcredentialsMerchantInformation();
  });
  ...
  describe('Iccv1instructionsinstructionIdcredentialsMerchantInformation', function() {
    it('should create an instance of Iccv1instructionsinstructionIdcredentialsMerchantInformation', function() {
      // uncomment below and update the code to test Iccv1instructionsinstructionIdcredentialsMerchantInformation
      //var instane = new CyberSource.Iccv1instructionsinstructionIdcredentialsMerchantInformation();
      //expect(instance).to.be.a(CyberSource.Iccv1instructionsinstructionIdcredentialsMerchantInformation);
    });
