...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentsProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes();
  });
  ...
  describe('PaymentsProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes', function() {
    it('should create an instance of PaymentsProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes', function() {
      // uncomment below and update the code to test PaymentsProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes
      //var instane = new CyberSource.PaymentsProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes();
      //expect(instance).to.be.a(CyberSource.PaymentsProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypes);
    });
