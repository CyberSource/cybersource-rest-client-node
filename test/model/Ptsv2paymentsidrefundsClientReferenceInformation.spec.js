...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsidrefundsClientReferenceInformation();
  });
  ...
  describe('Ptsv2paymentsidrefundsClientReferenceInformation', function() {
    it('should create an instance of Ptsv2paymentsidrefundsClientReferenceInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentsidrefundsClientReferenceInformation
      //var instane = new CyberSource.Ptsv2paymentsidrefundsClientReferenceInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsidrefundsClientReferenceInformation);
    });
