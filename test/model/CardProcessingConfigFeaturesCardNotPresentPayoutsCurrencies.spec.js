...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CardProcessingConfigFeaturesCardNotPresentPayoutsCurrencies();
  });
  ...
  describe('CardProcessingConfigFeaturesCardNotPresentPayoutsCurrencies', function() {
    it('should create an instance of CardProcessingConfigFeaturesCardNotPresentPayoutsCurrencies', function() {
      // uncomment below and update the code to test CardProcessingConfigFeaturesCardNotPresentPayoutsCurrencies
      //var instane = new CyberSource.CardProcessingConfigFeaturesCardNotPresentPayoutsCurrencies();
      //expect(instance).to.be.a(CyberSource.CardProcessingConfigFeaturesCardNotPresentPayoutsCurrencies);
    });
