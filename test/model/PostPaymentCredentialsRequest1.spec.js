...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PostPaymentCredentialsRequest1();
  });
  ...
  describe('PostPaymentCredentialsRequest1', function() {
    it('should create an instance of PostPaymentCredentialsRequest1', function() {
      // uncomment below and update the code to test PostPaymentCredentialsRequest1
      //var instane = new CyberSource.PostPaymentCredentialsRequest1();
      //expect(instance).to.be.a(CyberSource.PostPaymentCredentialsRequest1);
    });

    it('should have the property paymentCredentialType (base name: "paymentCredentialType")', function() {
      // uncomment below and update the code to test the property paymentCredentialType
      //var instane = new CyberSource.PostPaymentCredentialsRequest1();
