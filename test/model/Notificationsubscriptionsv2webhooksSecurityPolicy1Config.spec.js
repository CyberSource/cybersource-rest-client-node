...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Notificationsubscriptionsv2webhooksSecurityPolicy1Config();
  });
  ...
  describe('Notificationsubscriptionsv2webhooksSecurityPolicy1Config', function() {
    it('should create an instance of Notificationsubscriptionsv2webhooksSecurityPolicy1Config', function() {
      // uncomment below and update the code to test Notificationsubscriptionsv2webhooksSecurityPolicy1Config
      //var instane = new CyberSource.Notificationsubscriptionsv2webhooksSecurityPolicy1Config();
      //expect(instance).to.be.a(CyberSource.Notificationsubscriptionsv2webhooksSecurityPolicy1Config);
    });
