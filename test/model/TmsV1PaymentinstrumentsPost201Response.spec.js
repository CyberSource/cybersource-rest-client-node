...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TmsV1PaymentinstrumentsPost201Response();
  });
  ...
  describe('TmsV1PaymentinstrumentsPost201Response', function() {
    it('should create an instance of TmsV1PaymentinstrumentsPost201Response', function() {
      // uncomment below and update the code to test TmsV1PaymentinstrumentsPost201Response
      //var instane = new CyberSource.TmsV1PaymentinstrumentsPost201Response();
      //expect(instance).to.be.a(CyberSource.TmsV1PaymentinstrumentsPost201Response);
    });
