...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ucv1sessionsData();
  });
  ...
  describe('Ucv1sessionsData', function() {
    it('should create an instance of Ucv1sessionsData', function() {
      // uncomment below and update the code to test Ucv1sessionsData
