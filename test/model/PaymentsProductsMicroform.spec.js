...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentsProductsMicroform();
  });
  ...
  describe('PaymentsProductsMicroform', function() {
    it('should create an instance of PaymentsProductsMicroform', function() {
      // uncomment below and update the code to test PaymentsProductsMicroform
      //var instane = new CyberSource.PaymentsProductsMicroform();
      //expect(instance).to.be.a(CyberSource.PaymentsProductsMicroform);
    });
