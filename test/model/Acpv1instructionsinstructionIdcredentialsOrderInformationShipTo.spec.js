...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Acpv1instructionsinstructionIdcredentialsOrderInformationShipTo();
  });
  ...
  describe('Acpv1instructionsinstructionIdcredentialsOrderInformationShipTo', function() {
    it('should create an instance of Acpv1instructionsinstructionIdcredentialsOrderInformationShipTo', function() {
      // uncomment below and update the code to test Acpv1instructionsinstructionIdcredentialsOrderInformationShipTo
      //var instane = new CyberSource.Acpv1instructionsinstructionIdcredentialsOrderInformationShipTo();
      //expect(instance).to.be.a(CyberSource.Acpv1instructionsinstructionIdcredentialsOrderInformationShipTo);
    });
    ...
    it('should have the property numberIsVoiceOnly (base name: "numberIsVoiceOnly")', function() {
      // uncomment below and update the code to test the property numberIsVoiceOnly
      //var instane = new CyberSource.Acpv1instructionsinstructionIdcredentialsOrderInformationShipTo();
      //expect(instance).to.be();
    });
