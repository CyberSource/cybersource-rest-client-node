...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2billingagreementsInstallmentInformation();
  });
  ...
  describe('Ptsv2billingagreementsInstallmentInformation', function() {
    it('should create an instance of Ptsv2billingagreementsInstallmentInformation', function() {
      // uncomment below and update the code to test Ptsv2billingagreementsInstallmentInformation
      //var instane = new CyberSource.Ptsv2billingagreementsInstallmentInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2billingagreementsInstallmentInformation);
    });

    it('should have the property alertPreference (base name: "alertPreference")', function() {
      // uncomment below and update the code to test the property alertPreference
      //var instane = new CyberSource.Ptsv2billingagreementsInstallmentInformation();
    ...
    it('should have the property lastInstallmentDate (base name: "lastInstallmentDate")', function() {
      // uncomment below and update the code to test the property lastInstallmentDate
      //var instane = new CyberSource.Ptsv2billingagreementsInstallmentInformation();
      //expect(instance).to.be();
    });
