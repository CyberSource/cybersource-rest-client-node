...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentProductsSecureAcceptanceConfigurationInformationConfigurations();
  });
  ...
  describe('PaymentProductsSecureAcceptanceConfigurationInformationConfigurations', function() {
    it('should create an instance of PaymentProductsSecureAcceptanceConfigurationInformationConfigurations', function() {
      // uncomment below and update the code to test PaymentProductsSecureAcceptanceConfigurationInformationConfigurations
      //var instane = new CyberSource.PaymentProductsSecureAcceptanceConfigurationInformationConfigurations();
      //expect(instance).to.be.a(CyberSource.PaymentProductsSecureAcceptanceConfigurationInformationConfigurations);
    });
