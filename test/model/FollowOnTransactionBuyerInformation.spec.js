...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.FollowOnTransactionBuyerInformation();
  });
  ...
  describe('FollowOnTransactionBuyerInformation', function() {
    it('should create an instance of FollowOnTransactionBuyerInformation', function() {
      // uncomment below and update the code to test FollowOnTransactionBuyerInformation
      //var instane = new CyberSource.FollowOnTransactionBuyerInformation();
      //expect(instance).to.be.a(CyberSource.FollowOnTransactionBuyerInformation);
    });
