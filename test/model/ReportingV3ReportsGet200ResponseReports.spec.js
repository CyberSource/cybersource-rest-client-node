...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.ReportingV3ReportsGet200ResponseReports();
  });
  ...
  describe('ReportingV3ReportsGet200ResponseReports', function() {
    it('should create an instance of ReportingV3ReportsGet200ResponseReports', function() {
      // uncomment below and update the code to test ReportingV3ReportsGet200ResponseReports
      //var instane = new CyberSource.ReportingV3ReportsGet200ResponseReports();
      //expect(instance).to.be.a(CyberSource.ReportingV3ReportsGet200ResponseReports);
    });
    ...
    it('should have the property selectedMerchantGroupName (base name: "selectedMerchantGroupName")', function() {
      // uncomment below and update the code to test the property selectedMerchantGroupName
      //var instane = new CyberSource.ReportingV3ReportsGet200ResponseReports();
      //expect(instance).to.be();
    });
