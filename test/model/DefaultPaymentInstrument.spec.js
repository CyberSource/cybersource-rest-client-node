...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.DefaultPaymentInstrument();
  });
  ...
  describe('DefaultPaymentInstrument', function() {
    it('should create an instance of DefaultPaymentInstrument', function() {
      // uncomment below and update the code to test DefaultPaymentInstrument
      //var instane = new CyberSource.DefaultPaymentInstrument();
      //expect(instance).to.be.a(CyberSource.DefaultPaymentInstrument);
    });
