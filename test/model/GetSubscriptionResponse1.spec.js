...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.GetSubscriptionResponse1();
  });
  ...
  describe('GetSubscriptionResponse1', function() {
    it('should create an instance of GetSubscriptionResponse1', function() {
      // uncomment below and update the code to test GetSubscriptionResponse1
      //var instane = new CyberSource.GetSubscriptionResponse1();
      //expect(instance).to.be.a(CyberSource.GetSubscriptionResponse1);
    });
