...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.ModifyBillingAgreement();
  });
  ...
  describe('ModifyBillingAgreement', function() {
    it('should create an instance of ModifyBillingAgreement', function() {
      // uncomment below and update the code to test ModifyBillingAgreement
      //var instane = new CyberSource.ModifyBillingAgreement();
      //expect(instance).to.be.a(CyberSource.ModifyBillingAgreement);
    });
