...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2002KeyInformation();
  });
  ...
  describe('InlineResponse2002KeyInformation', function() {
    it('should create an instance of InlineResponse2002KeyInformation', function() {
      // uncomment below and update the code to test InlineResponse2002KeyInformation
      //var instane = new CyberSource.InlineResponse2002KeyInformation();
      //expect(instance).to.be.a(CyberSource.InlineResponse2002KeyInformation);
    });
