...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2001IntegrationInformationTenantConfigurations();
  });
  ...
  describe('InlineResponse2001IntegrationInformationTenantConfigurations', function() {
    it('should create an instance of InlineResponse2001IntegrationInformationTenantConfigurations', function() {
      // uncomment below and update the code to test InlineResponse2001IntegrationInformationTenantConfigurations
      //var instane = new CyberSource.InlineResponse2001IntegrationInformationTenantConfigurations();
      //expect(instance).to.be.a(CyberSource.InlineResponse2001IntegrationInformationTenantConfigurations);
    });
