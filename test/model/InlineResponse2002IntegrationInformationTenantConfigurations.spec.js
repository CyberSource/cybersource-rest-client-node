...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2002IntegrationInformationTenantConfigurations();
  });
  ...
  describe('InlineResponse2002IntegrationInformationTenantConfigurations', function() {
    it('should create an instance of InlineResponse2002IntegrationInformationTenantConfigurations', function() {
      // uncomment below and update the code to test InlineResponse2002IntegrationInformationTenantConfigurations
      //var instane = new CyberSource.InlineResponse2002IntegrationInformationTenantConfigurations();
      //expect(instance).to.be.a(CyberSource.InlineResponse2002IntegrationInformationTenantConfigurations);
    });
