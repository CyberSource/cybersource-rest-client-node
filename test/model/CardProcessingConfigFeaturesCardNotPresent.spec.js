...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CardProcessingConfigFeaturesCardNotPresent();
  });
  ...
  describe('CardProcessingConfigFeaturesCardNotPresent', function() {
    it('should create an instance of CardProcessingConfigFeaturesCardNotPresent', function() {
      // uncomment below and update the code to test CardProcessingConfigFeaturesCardNotPresent
      //var instane = new CyberSource.CardProcessingConfigFeaturesCardNotPresent();
      //expect(instance).to.be.a(CyberSource.CardProcessingConfigFeaturesCardNotPresent);
    });
