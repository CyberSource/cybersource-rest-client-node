...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2intentsOrderInformation();
  });
  ...
  describe('Ptsv2intentsOrderInformation', function() {
    it('should create an instance of Ptsv2intentsOrderInformation', function() {
      // uncomment below and update the code to test Ptsv2intentsOrderInformation
      //var instane = new CyberSource.Ptsv2intentsOrderInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2intentsOrderInformation);
    });
