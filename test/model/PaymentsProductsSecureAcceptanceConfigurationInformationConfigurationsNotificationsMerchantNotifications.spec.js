...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications();
  });
  ...
  describe('PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications', function() {
    it('should create an instance of PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications', function() {
      // uncomment below and update the code to test PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications
      //var instane = new CyberSource.PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications();
      //expect(instance).to.be.a(CyberSource.PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications);
    });
