...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.AccountValidationsRequest();
  });
  ...
  describe('AccountValidationsRequest', function() {
    it('should create an instance of AccountValidationsRequest', function() {
      // uncomment below and update the code to test AccountValidationsRequest
      //var instane = new CyberSource.AccountValidationsRequest();
      //expect(instance).to.be.a(CyberSource.AccountValidationsRequest);
    });
