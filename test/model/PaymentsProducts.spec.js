...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentsProducts();
  });
  ...
  describe('PaymentsProducts', function() {
    it('should create an instance of PaymentsProducts', function() {
      // uncomment below and update the code to test PaymentsProducts
      //var instane = new CyberSource.PaymentsProducts();
      //expect(instance).to.be.a(CyberSource.PaymentsProducts);
    });
