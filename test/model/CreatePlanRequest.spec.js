...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CreatePlanRequest();
  });
  ...
  describe('CreatePlanRequest', function() {
    it('should create an instance of CreatePlanRequest', function() {
      // uncomment below and update the code to test CreatePlanRequest
