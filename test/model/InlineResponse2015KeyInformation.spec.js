...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2015KeyInformation();
  });
  ...
  describe('InlineResponse2015KeyInformation', function() {
    it('should create an instance of InlineResponse2015KeyInformation', function() {
      // uncomment below and update the code to test InlineResponse2015KeyInformation
      //var instane = new CyberSource.InlineResponse2015KeyInformation();
      //expect(instance).to.be.a(CyberSource.InlineResponse2015KeyInformation);
    });
