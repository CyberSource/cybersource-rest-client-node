...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications();
  });
  ...
  describe('PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications', function() {
    it('should create an instance of PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications', function() {
      // uncomment below and update the code to test PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications
      //var instane = new CyberSource.PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications();
      //expect(instance).to.be.a(CyberSource.PaymentProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsMerchantNotifications);
    });
