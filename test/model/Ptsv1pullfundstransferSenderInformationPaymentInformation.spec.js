...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv1pullfundstransferSenderInformationPaymentInformation();
  });
  ...
  describe('Ptsv1pullfundstransferSenderInformationPaymentInformation', function() {
    it('should create an instance of Ptsv1pullfundstransferSenderInformationPaymentInformation', function() {
      // uncomment below and update the code to test Ptsv1pullfundstransferSenderInformationPaymentInformation
      //var instane = new CyberSource.Ptsv1pullfundstransferSenderInformationPaymentInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv1pullfundstransferSenderInformationPaymentInformation);
    });
