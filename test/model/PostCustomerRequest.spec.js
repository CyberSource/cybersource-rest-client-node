...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PostCustomerRequest();
  });
  ...
  describe('PostCustomerRequest', function() {
    it('should create an instance of PostCustomerRequest', function() {
      // uncomment below and update the code to test PostCustomerRequest
      //var instane = new CyberSource.PostCustomerRequest();
      //expect(instance).to.be.a(CyberSource.PostCustomerRequest);
    });
