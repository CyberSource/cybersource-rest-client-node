...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.AuthenticationExemptionsRequest();
  });
  ...
  describe('AuthenticationExemptionsRequest', function() {
    it('should create an instance of AuthenticationExemptionsRequest', function() {
      // uncomment below and update the code to test AuthenticationExemptionsRequest
      //var instane = new CyberSource.AuthenticationExemptionsRequest();
      //expect(instance).to.be.a(CyberSource.AuthenticationExemptionsRequest);
    });
