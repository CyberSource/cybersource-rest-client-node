...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.RiskAddressVerificationInformationStandardAddress();
  });
  ...
  describe('RiskAddressVerificationInformationStandardAddress', function() {
    it('should create an instance of RiskAddressVerificationInformationStandardAddress', function() {
      // uncomment below and update the code to test RiskAddressVerificationInformationStandardAddress
      //var instane = new CyberSource.RiskAddressVerificationInformationStandardAddress();
      //expect(instance).to.be.a(CyberSource.RiskAddressVerificationInformationStandardAddress);
    });
