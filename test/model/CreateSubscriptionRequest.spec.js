...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CreateSubscriptionRequest();
  });
  ...
  describe('CreateSubscriptionRequest', function() {
    it('should create an instance of CreateSubscriptionRequest', function() {
      ...
      //var instane = new CyberSource.CreateSubscriptionRequest();
      //expect(instance).to.be.a(CyberSource.CreateSubscriptionRequest);
    });
