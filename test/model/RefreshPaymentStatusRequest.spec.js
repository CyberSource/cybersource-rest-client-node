...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.RefreshPaymentStatusRequest();
  });
  ...
  describe('RefreshPaymentStatusRequest', function() {
    it('should create an instance of RefreshPaymentStatusRequest', function() {
      // uncomment below and update the code to test RefreshPaymentStatusRequest
      //var instane = new CyberSource.RefreshPaymentStatusRequest();
      //expect(instance).to.be.a(CyberSource.RefreshPaymentStatusRequest);
    });
