...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Tmsv2TokenizedCardMetadata();
  });
  ...
  describe('Tmsv2TokenizedCardMetadata', function() {
    it('should create an instance of Tmsv2TokenizedCardMetadata', function() {
      // uncomment below and update the code to test Tmsv2TokenizedCardMetadata
      //var instane = new CyberSource.Tmsv2TokenizedCardMetadata();
      //expect(instance).to.be.a(CyberSource.Tmsv2TokenizedCardMetadata);
    });
