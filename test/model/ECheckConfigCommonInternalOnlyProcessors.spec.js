...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.ECheckConfigCommonInternalOnlyProcessors();
  });
  ...
  describe('ECheckConfigCommonInternalOnlyProcessors', function() {
    it('should create an instance of ECheckConfigCommonInternalOnlyProcessors', function() {
      // uncomment below and update the code to test ECheckConfigCommonInternalOnlyProcessors
      //var instane = new CyberSource.ECheckConfigCommonInternalOnlyProcessors();
      //expect(instance).to.be.a(CyberSource.ECheckConfigCommonInternalOnlyProcessors);
    });
    ...
    it('should have the property verificationLevel (base name: "verificationLevel")', function() {
      // uncomment below and update the code to test the property verificationLevel
      //var instane = new CyberSource.ECheckConfigCommonInternalOnlyProcessors();
      //expect(instance).to.be();
    });
