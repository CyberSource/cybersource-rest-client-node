...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PushFunds201ResponseProcessorInformation();
  });
  ...
  describe('PushFunds201ResponseProcessorInformation', function() {
    it('should create an instance of PushFunds201ResponseProcessorInformation', function() {
      // uncomment below and update the code to test PushFunds201ResponseProcessorInformation
      //var instane = new CyberSource.PushFunds201ResponseProcessorInformation();
      //expect(instance).to.be.a(CyberSource.PushFunds201ResponseProcessorInformation);
    });
