...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentreferencesPaymentInformationCard();
  });
  ...
  describe('Ptsv2paymentreferencesPaymentInformationCard', function() {
    it('should create an instance of Ptsv2paymentreferencesPaymentInformationCard', function() {
      // uncomment below and update the code to test Ptsv2paymentreferencesPaymentInformationCard
      //var instane = new CyberSource.Ptsv2paymentreferencesPaymentInformationCard();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentreferencesPaymentInformationCard);
    });
