...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ucv1sessionsDataOrderInformation();
  });
  ...
  describe('Ucv1sessionsDataOrderInformation', function() {
    it('should create an instance of Ucv1sessionsDataOrderInformation', function() {
      // uncomment below and update the code to test Ucv1sessionsDataOrderInformation
      //var instane = new CyberSource.Ucv1sessionsDataOrderInformation();
      //expect(instance).to.be.a(CyberSource.Ucv1sessionsDataOrderInformation);
    });
