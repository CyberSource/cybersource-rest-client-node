...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CreateBinLookupRequest();
  });
  ...
  describe('CreateBinLookupRequest', function() {
    it('should create an instance of CreateBinLookupRequest', function() {
      // uncomment below and update the code to test CreateBinLookupRequest
      //var instane = new CyberSource.CreateBinLookupRequest();
      //expect(instance).to.be.a(CyberSource.CreateBinLookupRequest);
    });
