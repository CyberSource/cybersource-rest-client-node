...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.BoardingBusinessInformation();
  });
  ...
  describe('BoardingBusinessInformation', function() {
    it('should create an instance of BoardingBusinessInformation', function() {
      // uncomment below and update the code to test BoardingBusinessInformation
      //var instane = new CyberSource.BoardingBusinessInformation();
      //expect(instance).to.be.a(CyberSource.BoardingBusinessInformation);
    });
