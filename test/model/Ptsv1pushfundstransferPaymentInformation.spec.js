...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv1pushfundstransferPaymentInformation();
  });
  ...
  describe('Ptsv1pushfundstransferPaymentInformation', function() {
    it('should create an instance of Ptsv1pushfundstransferPaymentInformation', function() {
      // uncomment below and update the code to test Ptsv1pushfundstransferPaymentInformation
      //var instane = new CyberSource.Ptsv1pushfundstransferPaymentInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv1pushfundstransferPaymentInformation);
    });
