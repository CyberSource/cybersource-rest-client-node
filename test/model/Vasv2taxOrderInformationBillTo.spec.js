...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Vasv2taxOrderInformationBillTo();
  });
  ...
  describe('Vasv2taxOrderInformationBillTo', function() {
    it('should create an instance of Vasv2taxOrderInformationBillTo', function() {
      // uncomment below and update the code to test Vasv2taxOrderInformationBillTo
      //var instane = new CyberSource.Vasv2taxOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.Vasv2taxOrderInformationBillTo);
    });
