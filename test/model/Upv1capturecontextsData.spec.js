...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Upv1capturecontextsData();
  });
  ...
  describe('Upv1capturecontextsData', function() {
    it('should create an instance of Upv1capturecontextsData', function() {
      // uncomment below and update the code to test Upv1capturecontextsData
      //var instane = new CyberSource.Upv1capturecontextsData();
      //expect(instance).to.be.a(CyberSource.Upv1capturecontextsData);
    });
