...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ucv1sessionsDataOrderInformationBillTo();
  });
  ...
  describe('Ucv1sessionsDataOrderInformationBillTo', function() {
    it('should create an instance of Ucv1sessionsDataOrderInformationBillTo', function() {
      // uncomment below and update the code to test Ucv1sessionsDataOrderInformationBillTo
      //var instane = new CyberSource.Ucv1sessionsDataOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.Ucv1sessionsDataOrderInformationBillTo);
    });
