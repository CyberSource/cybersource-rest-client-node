...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PullFundsRequest();
  });
  ...
  describe('PullFundsRequest', function() {
    it('should create an instance of PullFundsRequest', function() {
      // uncomment below and update the code to test PullFundsRequest
      //var instane = new CyberSource.PullFundsRequest();
      //expect(instance).to.be.a(CyberSource.PullFundsRequest);
    });
