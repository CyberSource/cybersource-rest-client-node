...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PtsV2PaymentsRefundPost201ResponseOrderInformationAmountDetails();
  });
  ...
  describe('PtsV2PaymentsRefundPost201ResponseOrderInformationAmountDetails', function() {
    it('should create an instance of PtsV2PaymentsRefundPost201ResponseOrderInformationAmountDetails', function() {
      // uncomment below and update the code to test PtsV2PaymentsRefundPost201ResponseOrderInformationAmountDetails
