...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TmsV1PaymentinstrumentsGet200Response();
  });
  ...
  describe('TmsV1PaymentinstrumentsGet200Response', function() {
    it('should create an instance of TmsV1PaymentinstrumentsGet200Response', function() {
      // uncomment below and update the code to test TmsV1PaymentinstrumentsGet200Response
      //var instane = new CyberSource.TmsV1PaymentinstrumentsGet200Response();
      //expect(instance).to.be.a(CyberSource.TmsV1PaymentinstrumentsGet200Response);
    });
