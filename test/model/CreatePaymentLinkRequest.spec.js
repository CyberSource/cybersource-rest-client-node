...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CreatePaymentLinkRequest();
  });
  ...
  describe('CreatePaymentLinkRequest', function() {
    it('should create an instance of CreatePaymentLinkRequest', function() {
      // uncomment below and update the code to test CreatePaymentLinkRequest
      //var instane = new CyberSource.CreatePaymentLinkRequest();
      //expect(instance).to.be.a(CyberSource.CreatePaymentLinkRequest);
    });
