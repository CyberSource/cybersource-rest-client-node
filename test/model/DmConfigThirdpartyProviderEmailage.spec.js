...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.DmConfigThirdpartyProviderEmailage();
  });
  ...
  describe('DmConfigThirdpartyProviderEmailage', function() {
    it('should create an instance of DmConfigThirdpartyProviderEmailage', function() {
      // uncomment below and update the code to test DmConfigThirdpartyProviderEmailage
      //var instane = new CyberSource.DmConfigThirdpartyProviderEmailage();
      //expect(instance).to.be.a(CyberSource.DmConfigThirdpartyProviderEmailage);
    });
