...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Tmsv3tokenstokenIdpaymentcredentialsDeviceInformation();
  });
  ...
  describe('Tmsv3tokenstokenIdpaymentcredentialsDeviceInformation', function() {
    it('should create an instance of Tmsv3tokenstokenIdpaymentcredentialsDeviceInformation', function() {
      // uncomment below and update the code to test Tmsv3tokenstokenIdpaymentcredentialsDeviceInformation
      //var instane = new CyberSource.Tmsv3tokenstokenIdpaymentcredentialsDeviceInformation();
      //expect(instance).to.be.a(CyberSource.Tmsv3tokenstokenIdpaymentcredentialsDeviceInformation);
    });
