...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Tmsv2tokenstokenIdpaymentcredentialsDeviceInformation();
  });
  ...
  describe('Tmsv2tokenstokenIdpaymentcredentialsDeviceInformation', function() {
    it('should create an instance of Tmsv2tokenstokenIdpaymentcredentialsDeviceInformation', function() {
      // uncomment below and update the code to test Tmsv2tokenstokenIdpaymentcredentialsDeviceInformation
      //var instane = new CyberSource.Tmsv2tokenstokenIdpaymentcredentialsDeviceInformation();
      //expect(instance).to.be.a(CyberSource.Tmsv2tokenstokenIdpaymentcredentialsDeviceInformation);
    });
