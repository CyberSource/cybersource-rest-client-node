...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.IccLineItem();
  });
  ...
  describe('IccLineItem', function() {
    it('should create an instance of IccLineItem', function() {
      // uncomment below and update the code to test IccLineItem
      //var instane = new CyberSource.IccLineItem();
      //expect(instance).to.be.a(CyberSource.IccLineItem);
    });
