...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PtsV2PaymentsOrderPost201ResponseOrderInformationBillTo();
  });
  ...
  describe('PtsV2PaymentsOrderPost201ResponseOrderInformationBillTo', function() {
    it('should create an instance of PtsV2PaymentsOrderPost201ResponseOrderInformationBillTo', function() {
      // uncomment below and update the code to test PtsV2PaymentsOrderPost201ResponseOrderInformationBillTo
      //var instane = new CyberSource.PtsV2PaymentsOrderPost201ResponseOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.PtsV2PaymentsOrderPost201ResponseOrderInformationBillTo);
    });
