...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsCustomerNotifications();
  });
  ...
  describe('PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsCustomerNotifications', function() {
    it('should create an instance of PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsCustomerNotifications', function() {
      // uncomment below and update the code to test PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsCustomerNotifications
      //var instane = new CyberSource.PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsCustomerNotifications();
      //expect(instance).to.be.a(CyberSource.PaymentsProductsSecureAcceptanceConfigurationInformationConfigurationsNotificationsCustomerNotifications);
    });
