...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PullFunds201ResponseLinks();
  });
  ...
  describe('PullFunds201ResponseLinks', function() {
    it('should create an instance of PullFunds201ResponseLinks', function() {
      // uncomment below and update the code to test PullFunds201ResponseLinks
      //var instane = new CyberSource.PullFunds201ResponseLinks();
      //expect(instance).to.be.a(CyberSource.PullFunds201ResponseLinks);
    });
