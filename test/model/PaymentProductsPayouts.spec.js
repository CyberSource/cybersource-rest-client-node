...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentProductsPayouts();
  });
  ...
  describe('PaymentProductsPayouts', function() {
    it('should create an instance of PaymentProductsPayouts', function() {
      // uncomment below and update the code to test PaymentProductsPayouts
      //var instane = new CyberSource.PaymentProductsPayouts();
      //expect(instance).to.be.a(CyberSource.PaymentProductsPayouts);
    });
