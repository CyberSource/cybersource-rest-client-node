...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2billingagreementsPaymentInformation();
  });
  ...
  describe('Ptsv2billingagreementsPaymentInformation', function() {
    it('should create an instance of Ptsv2billingagreementsPaymentInformation', function() {
      // uncomment below and update the code to test Ptsv2billingagreementsPaymentInformation
      //var instane = new CyberSource.Ptsv2billingagreementsPaymentInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2billingagreementsPaymentInformation);
    });
