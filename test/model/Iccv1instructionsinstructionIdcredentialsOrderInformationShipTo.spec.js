...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Iccv1instructionsinstructionIdcredentialsOrderInformationShipTo();
  });
  ...
  describe('Iccv1instructionsinstructionIdcredentialsOrderInformationShipTo', function() {
    it('should create an instance of Iccv1instructionsinstructionIdcredentialsOrderInformationShipTo', function() {
      // uncomment below and update the code to test Iccv1instructionsinstructionIdcredentialsOrderInformationShipTo
      //var instane = new CyberSource.Iccv1instructionsinstructionIdcredentialsOrderInformationShipTo();
      //expect(instance).to.be.a(CyberSource.Iccv1instructionsinstructionIdcredentialsOrderInformationShipTo);
    });
