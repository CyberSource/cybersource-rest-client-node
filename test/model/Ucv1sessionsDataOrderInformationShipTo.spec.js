...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ucv1sessionsDataOrderInformationShipTo();
  });
  ...
  describe('Ucv1sessionsDataOrderInformationShipTo', function() {
    it('should create an instance of Ucv1sessionsDataOrderInformationShipTo', function() {
      // uncomment below and update the code to test Ucv1sessionsDataOrderInformationShipTo
      //var instane = new CyberSource.Ucv1sessionsDataOrderInformationShipTo();
      //expect(instance).to.be.a(CyberSource.Ucv1sessionsDataOrderInformationShipTo);
    });
