...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsSenderInformation();
  });
  ...
  describe('Ptsv2paymentsSenderInformation', function() {
    it('should create an instance of Ptsv2paymentsSenderInformation', function() {
      // uncomment below and update the code to test Ptsv2paymentsSenderInformation
      //var instane = new CyberSource.Ptsv2paymentsSenderInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsSenderInformation);
    });
