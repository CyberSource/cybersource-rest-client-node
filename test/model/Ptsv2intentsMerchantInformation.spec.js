...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2intentsMerchantInformation();
  });
  ...
  describe('Ptsv2intentsMerchantInformation', function() {
    it('should create an instance of Ptsv2intentsMerchantInformation', function() {
      // uncomment below and update the code to test Ptsv2intentsMerchantInformation
