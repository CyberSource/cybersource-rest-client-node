...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.RiskV1DecisionsPost201ResponseRiskInformationIpAddress();
  });
  ...
  describe('RiskV1DecisionsPost201ResponseRiskInformationIpAddress', function() {
    it('should create an instance of RiskV1DecisionsPost201ResponseRiskInformationIpAddress', function() {
      // uncomment below and update the code to test RiskV1DecisionsPost201ResponseRiskInformationIpAddress
      //var instane = new CyberSource.RiskV1DecisionsPost201ResponseRiskInformationIpAddress();
      //expect(instance).to.be.a(CyberSource.RiskV1DecisionsPost201ResponseRiskInformationIpAddress);
    });
