...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.SAConfigPaymentTypesCardTypes();
  });
  ...
  describe('SAConfigPaymentTypesCardTypes', function() {
    it('should create an instance of SAConfigPaymentTypesCardTypes', function() {
      // uncomment below and update the code to test SAConfigPaymentTypesCardTypes
      //var instane = new CyberSource.SAConfigPaymentTypesCardTypes();
      //expect(instance).to.be.a(CyberSource.SAConfigPaymentTypesCardTypes);
    });
