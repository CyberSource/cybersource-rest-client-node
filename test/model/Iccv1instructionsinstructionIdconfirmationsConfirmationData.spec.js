...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Iccv1instructionsinstructionIdconfirmationsConfirmationData();
  });
  ...
  describe('Iccv1instructionsinstructionIdconfirmationsConfirmationData', function() {
    it('should create an instance of Iccv1instructionsinstructionIdconfirmationsConfirmationData', function() {
      // uncomment below and update the code to test Iccv1instructionsinstructionIdconfirmationsConfirmationData
      //var instane = new CyberSource.Iccv1instructionsinstructionIdconfirmationsConfirmationData();
      //expect(instance).to.be.a(CyberSource.Iccv1instructionsinstructionIdconfirmationsConfirmationData);
    });
