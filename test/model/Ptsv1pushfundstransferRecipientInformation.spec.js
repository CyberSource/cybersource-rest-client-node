...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv1pushfundstransferRecipientInformation();
  });
  ...
  describe('Ptsv1pushfundstransferRecipientInformation', function() {
    it('should create an instance of Ptsv1pushfundstransferRecipientInformation', function() {
      // uncomment below and update the code to test Ptsv1pushfundstransferRecipientInformation
      //var instane = new CyberSource.Ptsv1pushfundstransferRecipientInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv1pushfundstransferRecipientInformation);
    });
