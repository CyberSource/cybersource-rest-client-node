...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2billingagreementsClientReferenceInformation();
  });
  ...
  describe('Ptsv2billingagreementsClientReferenceInformation', function() {
    it('should create an instance of Ptsv2billingagreementsClientReferenceInformation', function() {
      // uncomment below and update the code to test Ptsv2billingagreementsClientReferenceInformation
      //var instane = new CyberSource.Ptsv2billingagreementsClientReferenceInformation();
      //expect(instance).to.be.a(CyberSource.Ptsv2billingagreementsClientReferenceInformation);
    });
