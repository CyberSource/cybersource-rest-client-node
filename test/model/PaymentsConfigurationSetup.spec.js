...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentsConfigurationSetup();
  });
  ...
  describe('PaymentsConfigurationSetup', function() {
    it('should create an instance of PaymentsConfigurationSetup', function() {
      // uncomment below and update the code to test PaymentsConfigurationSetup
      //var instane = new CyberSource.PaymentsConfigurationSetup();
      //expect(instance).to.be.a(CyberSource.PaymentsConfigurationSetup);
    });
