...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Iccv1instructionsinstructionIdconfirmationsOrderInformation();
  });
  ...
  describe('Iccv1instructionsinstructionIdconfirmationsOrderInformation', function() {
    it('should create an instance of Iccv1instructionsinstructionIdconfirmationsOrderInformation', function() {
      // uncomment below and update the code to test Iccv1instructionsinstructionIdconfirmationsOrderInformation
      //var instane = new CyberSource.Iccv1instructionsinstructionIdconfirmationsOrderInformation();
      //expect(instance).to.be.a(CyberSource.Iccv1instructionsinstructionIdconfirmationsOrderInformation);
    });
