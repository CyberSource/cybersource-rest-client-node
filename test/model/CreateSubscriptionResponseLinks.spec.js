...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CreateSubscriptionResponseLinks();
  });
  ...
  describe('CreateSubscriptionResponseLinks', function() {
    it('should create an instance of CreateSubscriptionResponseLinks', function() {
      // uncomment below and update the code to test CreateSubscriptionResponseLinks
      //var instane = new CyberSource.CreateSubscriptionResponseLinks();
      //expect(instance).to.be.a(CyberSource.CreateSubscriptionResponseLinks);
    });
