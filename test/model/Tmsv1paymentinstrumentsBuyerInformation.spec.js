...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Tmsv1paymentinstrumentsBuyerInformation();
  });
  ...
  describe('Tmsv1paymentinstrumentsBuyerInformation', function() {
    it('should create an instance of Tmsv1paymentinstrumentsBuyerInformation', function() {
      // uncomment below and update the code to test Tmsv1paymentinstrumentsBuyerInformation
      //var instane = new CyberSource.Tmsv1paymentinstrumentsBuyerInformation();
      //expect(instance).to.be.a(CyberSource.Tmsv1paymentinstrumentsBuyerInformation);
    });
