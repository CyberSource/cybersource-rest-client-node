...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse201KeyInformation();
  });
  ...
  describe('InlineResponse201KeyInformation', function() {
    it('should create an instance of InlineResponse201KeyInformation', function() {
      // uncomment below and update the code to test InlineResponse201KeyInformation
      //var instane = new CyberSource.InlineResponse201KeyInformation();
      //expect(instance).to.be.a(CyberSource.InlineResponse201KeyInformation);
    });
