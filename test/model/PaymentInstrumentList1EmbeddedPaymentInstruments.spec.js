...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentInstrumentList1EmbeddedPaymentInstruments();
  });
  ...
  describe('PaymentInstrumentList1EmbeddedPaymentInstruments', function() {
    it('should create an instance of PaymentInstrumentList1EmbeddedPaymentInstruments', function() {
      // uncomment below and update the code to test PaymentInstrumentList1EmbeddedPaymentInstruments
      //var instane = new CyberSource.PaymentInstrumentList1EmbeddedPaymentInstruments();
      //expect(instance).to.be.a(CyberSource.PaymentInstrumentList1EmbeddedPaymentInstruments);
    });
