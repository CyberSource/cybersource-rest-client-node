...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse201OrderInformationShipTo();
  });
  ...
  describe('InlineResponse201OrderInformationShipTo', function() {
    it('should create an instance of InlineResponse201OrderInformationShipTo', function() {
      // uncomment below and update the code to test InlineResponse201OrderInformationShipTo
      //var instane = new CyberSource.InlineResponse201OrderInformationShipTo();
      //expect(instance).to.be.a(CyberSource.InlineResponse201OrderInformationShipTo);
    });
