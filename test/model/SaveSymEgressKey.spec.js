...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.SaveSymEgressKey();
  });
  ...
  describe('SaveSymEgressKey', function() {
    it('should create an instance of SaveSymEgressKey', function() {
      // uncomment below and update the code to test SaveSymEgressKey
      //var instane = new CyberSource.SaveSymEgressKey();
      //expect(instance).to.be.a(CyberSource.SaveSymEgressKey);
    });
