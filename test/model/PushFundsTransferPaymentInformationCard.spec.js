...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PushFundsTransferPaymentInformationCard();
  });
  ...
  describe('PushFundsTransferPaymentInformationCard', function() {
    it('should create an instance of PushFundsTransferPaymentInformationCard', function() {
      // uncomment below and update the code to test PushFundsTransferPaymentInformationCard
      //var instane = new CyberSource.PushFundsTransferPaymentInformationCard();
      //expect(instance).to.be.a(CyberSource.PushFundsTransferPaymentInformationCard);
    });
