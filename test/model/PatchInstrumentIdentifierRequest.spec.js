...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PatchInstrumentIdentifierRequest();
  });
  ...
  describe('PatchInstrumentIdentifierRequest', function() {
    it('should create an instance of PatchInstrumentIdentifierRequest', function() {
      // uncomment below and update the code to test PatchInstrumentIdentifierRequest
      //var instane = new CyberSource.PatchInstrumentIdentifierRequest();
      //expect(instance).to.be.a(CyberSource.PatchInstrumentIdentifierRequest);
    });
