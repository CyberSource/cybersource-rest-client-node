...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard();
  });
  ...
  describe('PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard', function() {
    it('should create an instance of PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard', function() {
      // uncomment below and update the code to test PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard
      //var instane = new CyberSource.PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard();
      //expect(instance).to.be.a(CyberSource.PtsV2PaymentsPost201ResponsePaymentAccountInformationTokenizedCard);
    });
