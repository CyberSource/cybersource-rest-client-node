...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TmsEmbeddedInstrumentIdentifierBillTo();
  });
  ...
  describe('TmsEmbeddedInstrumentIdentifierBillTo', function() {
    it('should create an instance of TmsEmbeddedInstrumentIdentifierBillTo', function() {
      // uncomment below and update the code to test TmsEmbeddedInstrumentIdentifierBillTo
      //var instane = new CyberSource.TmsEmbeddedInstrumentIdentifierBillTo();
      //expect(instance).to.be.a(CyberSource.TmsEmbeddedInstrumentIdentifierBillTo);
    });
