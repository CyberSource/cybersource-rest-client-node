...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PatchCustomerPaymentInstrumentRequest();
  });
  ...
  describe('PatchCustomerPaymentInstrumentRequest', function() {
    it('should create an instance of PatchCustomerPaymentInstrumentRequest', function() {
      // uncomment below and update the code to test PatchCustomerPaymentInstrumentRequest
      //var instane = new CyberSource.PatchCustomerPaymentInstrumentRequest();
      //expect(instance).to.be.a(CyberSource.PatchCustomerPaymentInstrumentRequest);
    });
