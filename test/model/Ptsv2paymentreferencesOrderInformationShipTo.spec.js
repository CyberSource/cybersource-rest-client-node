...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentreferencesOrderInformationShipTo();
  });
  ...
  describe('Ptsv2paymentreferencesOrderInformationShipTo', function() {
    it('should create an instance of Ptsv2paymentreferencesOrderInformationShipTo', function() {
      // uncomment below and update the code to test Ptsv2paymentreferencesOrderInformationShipTo
      //var instane = new CyberSource.Ptsv2paymentreferencesOrderInformationShipTo();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentreferencesOrderInformationShipTo);
    });
