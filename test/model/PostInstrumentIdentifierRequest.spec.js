...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PostInstrumentIdentifierRequest();
  });
  ...
  describe('PostInstrumentIdentifierRequest', function() {
    it('should create an instance of PostInstrumentIdentifierRequest', function() {
      // uncomment below and update the code to test PostInstrumentIdentifierRequest
      //var instane = new CyberSource.PostInstrumentIdentifierRequest();
      //expect(instance).to.be.a(CyberSource.PostInstrumentIdentifierRequest);
    });
