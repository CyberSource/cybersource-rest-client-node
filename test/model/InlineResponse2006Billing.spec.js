...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2006Billing();
  });
  ...
  describe('InlineResponse2006Billing', function() {
    it('should create an instance of InlineResponse2006Billing', function() {
      // uncomment below and update the code to test InlineResponse2006Billing
      //var instane = new CyberSource.InlineResponse2006Billing();
      //expect(instance).to.be.a(CyberSource.InlineResponse2006Billing);
    });
