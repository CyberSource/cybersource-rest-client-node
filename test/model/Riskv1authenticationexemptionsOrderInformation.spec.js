...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Riskv1authenticationexemptionsOrderInformation();
  });
  ...
  describe('Riskv1authenticationexemptionsOrderInformation', function() {
    it('should create an instance of Riskv1authenticationexemptionsOrderInformation', function() {
      // uncomment below and update the code to test Riskv1authenticationexemptionsOrderInformation
      //var instane = new CyberSource.Riskv1authenticationexemptionsOrderInformation();
      //expect(instance).to.be.a(CyberSource.Riskv1authenticationexemptionsOrderInformation);
    });
