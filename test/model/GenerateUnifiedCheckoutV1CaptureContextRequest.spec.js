...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.GenerateUnifiedCheckoutV1CaptureContextRequest();
  });
  ...
  describe('GenerateUnifiedCheckoutV1CaptureContextRequest', function() {
    it('should create an instance of GenerateUnifiedCheckoutV1CaptureContextRequest', function() {
      // uncomment below and update the code to test GenerateUnifiedCheckoutV1CaptureContextRequest
      //var instane = new CyberSource.GenerateUnifiedCheckoutV1CaptureContextRequest();
      //expect(instance).to.be.a(CyberSource.GenerateUnifiedCheckoutV1CaptureContextRequest);
    });
    ...
    it('should have the property paymentConfigurations (base name: "paymentConfigurations")', function() {
      // uncomment below and update the code to test the property paymentConfigurations
      //var instane = new CyberSource.GenerateUnifiedCheckoutV1CaptureContextRequest();
      //expect(instance).to.be();
    });
