...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard();
  });
  ...
  describe('TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard', function() {
    it('should create an instance of TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard', function() {
      // uncomment below and update the code to test TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard
      //var instane = new CyberSource.TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard();
      //expect(instance).to.be.a(CyberSource.TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard);
    });
