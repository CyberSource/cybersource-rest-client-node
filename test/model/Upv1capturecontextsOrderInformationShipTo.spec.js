...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Upv1capturecontextsOrderInformationShipTo();
  });
  ...
  describe('Upv1capturecontextsOrderInformationShipTo', function() {
    it('should create an instance of Upv1capturecontextsOrderInformationShipTo', function() {
      // uncomment below and update the code to test Upv1capturecontextsOrderInformationShipTo
      //var instane = new CyberSource.Upv1capturecontextsOrderInformationShipTo();
      //expect(instance).to.be.a(CyberSource.Upv1capturecontextsOrderInformationShipTo);
    });
