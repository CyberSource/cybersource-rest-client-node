...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Boardingv1registrationsOrganizationInformationKYC();
  });
  ...
  describe('Boardingv1registrationsOrganizationInformationKYC', function() {
    it('should create an instance of Boardingv1registrationsOrganizationInformationKYC', function() {
      // uncomment below and update the code to test Boardingv1registrationsOrganizationInformationKYC
      //var instane = new CyberSource.Boardingv1registrationsOrganizationInformationKYC();
      //expect(instance).to.be.a(CyberSource.Boardingv1registrationsOrganizationInformationKYC);
    });
    ...
    it('should have the property timeToProductDelivery (base name: "timeToProductDelivery")', function() {
      // uncomment below and update the code to test the property timeToProductDelivery
      //var instane = new CyberSource.Boardingv1registrationsOrganizationInformationKYC();
      //expect(instance).to.be();
    });
    ...
    it('should have the property depositBankAccount (base name: "depositBankAccount")', function() {
      // uncomment below and update the code to test the property depositBankAccount
      //var instane = new CyberSource.Boardingv1registrationsOrganizationInformationKYC();
      //expect(instance).to.be();
    });
