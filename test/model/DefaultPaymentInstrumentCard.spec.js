...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.DefaultPaymentInstrumentCard();
  });
  ...
  describe('DefaultPaymentInstrumentCard', function() {
    it('should create an instance of DefaultPaymentInstrumentCard', function() {
      // uncomment below and update the code to test DefaultPaymentInstrumentCard
      //var instane = new CyberSource.DefaultPaymentInstrumentCard();
      //expect(instance).to.be.a(CyberSource.DefaultPaymentInstrumentCard);
    });
