...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.DefaultShippingAddressShipTo();
  });
  ...
  describe('DefaultShippingAddressShipTo', function() {
    it('should create an instance of DefaultShippingAddressShipTo', function() {
      // uncomment below and update the code to test DefaultShippingAddressShipTo
      //var instane = new CyberSource.DefaultShippingAddressShipTo();
      //expect(instance).to.be.a(CyberSource.DefaultShippingAddressShipTo);
    });
