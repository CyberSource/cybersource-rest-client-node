...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PtsV2PayoutsPostResponse();
  });
  ...
  describe('PtsV2PayoutsPostResponse', function() {
    it('should create an instance of PtsV2PayoutsPostResponse', function() {
      // uncomment below and update the code to test PtsV2PayoutsPostResponse
      //var instane = new CyberSource.PtsV2PayoutsPostResponse();
      //expect(instance).to.be.a(CyberSource.PtsV2PayoutsPostResponse);
    });
