...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2003KeyInformation();
  });
  ...
  describe('InlineResponse2003KeyInformation', function() {
    it('should create an instance of InlineResponse2003KeyInformation', function() {
      // uncomment below and update the code to test InlineResponse2003KeyInformation
      //var instane = new CyberSource.InlineResponse2003KeyInformation();
      //expect(instance).to.be.a(CyberSource.InlineResponse2003KeyInformation);
    });
