...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CardProcessingConfigCommonCurrencies1();
  });
  ...
  describe('CardProcessingConfigCommonCurrencies1', function() {
    it('should create an instance of CardProcessingConfigCommonCurrencies1', function() {
      // uncomment below and update the code to test CardProcessingConfigCommonCurrencies1
      //var instane = new CyberSource.CardProcessingConfigCommonCurrencies1();
      //expect(instance).to.be.a(CyberSource.CardProcessingConfigCommonCurrencies1);
    });
