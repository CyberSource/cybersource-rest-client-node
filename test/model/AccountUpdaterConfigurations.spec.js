...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.AccountUpdaterConfigurations();
  });
  ...
  describe('AccountUpdaterConfigurations', function() {
    it('should create an instance of AccountUpdaterConfigurations', function() {
      // uncomment below and update the code to test AccountUpdaterConfigurations
      //var instane = new CyberSource.AccountUpdaterConfigurations();
      //expect(instance).to.be.a(CyberSource.AccountUpdaterConfigurations);
    });
