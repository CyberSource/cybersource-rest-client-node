...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2007Billing();
  });
  ...
  describe('InlineResponse2007Billing', function() {
    it('should create an instance of InlineResponse2007Billing', function() {
      // uncomment below and update the code to test InlineResponse2007Billing
      //var instane = new CyberSource.InlineResponse2007Billing();
      //expect(instance).to.be.a(CyberSource.InlineResponse2007Billing);
    });
