...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ucv1sessionsDataConsumerAuthenticationInformation();
  });
  ...
  describe('Ucv1sessionsDataConsumerAuthenticationInformation', function() {
    it('should create an instance of Ucv1sessionsDataConsumerAuthenticationInformation', function() {
      // uncomment below and update the code to test Ucv1sessionsDataConsumerAuthenticationInformation
      //var instane = new CyberSource.Ucv1sessionsDataConsumerAuthenticationInformation();
      //expect(instance).to.be.a(CyberSource.Ucv1sessionsDataConsumerAuthenticationInformation);
    });
