...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentsProductsServiceFeeConfigurationInformationConfigurations();
  });
  ...
  describe('PaymentsProductsServiceFeeConfigurationInformationConfigurations', function() {
    it('should create an instance of PaymentsProductsServiceFeeConfigurationInformationConfigurations', function() {
      // uncomment below and update the code to test PaymentsProductsServiceFeeConfigurationInformationConfigurations
      //var instane = new CyberSource.PaymentsProductsServiceFeeConfigurationInformationConfigurations();
      //expect(instance).to.be.a(CyberSource.PaymentsProductsServiceFeeConfigurationInformationConfigurations);
    });
