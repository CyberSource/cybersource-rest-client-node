...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.BoardingBusinessInformationAddress();
  });
  ...
  describe('BoardingBusinessInformationAddress', function() {
    it('should create an instance of BoardingBusinessInformationAddress', function() {
      // uncomment below and update the code to test BoardingBusinessInformationAddress
      //var instane = new CyberSource.BoardingBusinessInformationAddress();
      //expect(instance).to.be.a(CyberSource.BoardingBusinessInformationAddress);
    });
