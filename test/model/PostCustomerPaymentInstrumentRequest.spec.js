...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PostCustomerPaymentInstrumentRequest();
  });
  ...
  describe('PostCustomerPaymentInstrumentRequest', function() {
    it('should create an instance of PostCustomerPaymentInstrumentRequest', function() {
      // uncomment below and update the code to test PostCustomerPaymentInstrumentRequest
      //var instane = new CyberSource.PostCustomerPaymentInstrumentRequest();
      //expect(instance).to.be.a(CyberSource.PostCustomerPaymentInstrumentRequest);
    });
