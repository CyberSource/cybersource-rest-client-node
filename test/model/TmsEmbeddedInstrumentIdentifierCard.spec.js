...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.TmsEmbeddedInstrumentIdentifierCard();
  });
  ...
  describe('TmsEmbeddedInstrumentIdentifierCard', function() {
    it('should create an instance of TmsEmbeddedInstrumentIdentifierCard', function() {
      // uncomment below and update the code to test TmsEmbeddedInstrumentIdentifierCard
      //var instane = new CyberSource.TmsEmbeddedInstrumentIdentifierCard();
      //expect(instance).to.be.a(CyberSource.TmsEmbeddedInstrumentIdentifierCard);
    });
