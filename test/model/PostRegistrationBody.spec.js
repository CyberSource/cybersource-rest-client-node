...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PostRegistrationBody();
  });
  ...
  describe('PostRegistrationBody', function() {
    it('should create an instance of PostRegistrationBody', function() {
      // uncomment below and update the code to test PostRegistrationBody
      //var instane = new CyberSource.PostRegistrationBody();
      //expect(instance).to.be.a(CyberSource.PostRegistrationBody);
    });
