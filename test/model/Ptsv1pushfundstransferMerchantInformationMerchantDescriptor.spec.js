...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv1pushfundstransferMerchantInformationMerchantDescriptor();
  });
  ...
  describe('Ptsv1pushfundstransferMerchantInformationMerchantDescriptor', function() {
    it('should create an instance of Ptsv1pushfundstransferMerchantInformationMerchantDescriptor', function() {
      // uncomment below and update the code to test Ptsv1pushfundstransferMerchantInformationMerchantDescriptor
      //var instane = new CyberSource.Ptsv1pushfundstransferMerchantInformationMerchantDescriptor();
      //expect(instance).to.be.a(CyberSource.Ptsv1pushfundstransferMerchantInformationMerchantDescriptor);
    });
