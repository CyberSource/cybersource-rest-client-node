...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2004SourceRecord();
  });
  ...
  describe('InlineResponse2004SourceRecord', function() {
    it('should create an instance of InlineResponse2004SourceRecord', function() {
      // uncomment below and update the code to test InlineResponse2004SourceRecord
      //var instane = new CyberSource.InlineResponse2004SourceRecord();
      //expect(instance).to.be.a(CyberSource.InlineResponse2004SourceRecord);
    });
