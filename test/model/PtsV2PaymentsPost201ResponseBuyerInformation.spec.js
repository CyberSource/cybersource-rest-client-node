...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PtsV2PaymentsPost201ResponseBuyerInformation();
  });
  ...
  describe('PtsV2PaymentsPost201ResponseBuyerInformation', function() {
    it('should create an instance of PtsV2PaymentsPost201ResponseBuyerInformation', function() {
      // uncomment below and update the code to test PtsV2PaymentsPost201ResponseBuyerInformation
      //var instane = new CyberSource.PtsV2PaymentsPost201ResponseBuyerInformation();
      //expect(instance).to.be.a(CyberSource.PtsV2PaymentsPost201ResponseBuyerInformation);
    });
