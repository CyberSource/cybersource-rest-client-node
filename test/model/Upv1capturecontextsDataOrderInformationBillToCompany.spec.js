...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Upv1capturecontextsDataOrderInformationBillToCompany();
  });
  ...
  describe('Upv1capturecontextsDataOrderInformationBillToCompany', function() {
    it('should create an instance of Upv1capturecontextsDataOrderInformationBillToCompany', function() {
      // uncomment below and update the code to test Upv1capturecontextsDataOrderInformationBillToCompany
      //var instane = new CyberSource.Upv1capturecontextsDataOrderInformationBillToCompany();
      //expect(instance).to.be.a(CyberSource.Upv1capturecontextsDataOrderInformationBillToCompany);
    });
