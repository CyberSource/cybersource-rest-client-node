...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InstrumentIdentifier();
  });
  ...
  describe('InstrumentIdentifier', function() {
    it('should create an instance of InstrumentIdentifier', function() {
      // uncomment below and update the code to test InstrumentIdentifier
      //var instane = new CyberSource.InstrumentIdentifier();
      //expect(instance).to.be.a(CyberSource.InstrumentIdentifier);
    });
