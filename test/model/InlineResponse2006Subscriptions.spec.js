...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2006Subscriptions();
  });
  ...
  describe('InlineResponse2006Subscriptions', function() {
    it('should create an instance of InlineResponse2006Subscriptions', function() {
      // uncomment below and update the code to test InlineResponse2006Subscriptions
      //var instane = new CyberSource.InlineResponse2006Subscriptions();
      //expect(instance).to.be.a(CyberSource.InlineResponse2006Subscriptions);
    });
