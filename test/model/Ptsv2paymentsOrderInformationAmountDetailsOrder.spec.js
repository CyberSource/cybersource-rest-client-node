...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Ptsv2paymentsOrderInformationAmountDetailsOrder();
  });
  ...
  describe('Ptsv2paymentsOrderInformationAmountDetailsOrder', function() {
    it('should create an instance of Ptsv2paymentsOrderInformationAmountDetailsOrder', function() {
      // uncomment below and update the code to test Ptsv2paymentsOrderInformationAmountDetailsOrder
      //var instane = new CyberSource.Ptsv2paymentsOrderInformationAmountDetailsOrder();
      //expect(instance).to.be.a(CyberSource.Ptsv2paymentsOrderInformationAmountDetailsOrder);
    });
