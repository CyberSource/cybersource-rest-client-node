...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Vasv1currencyconversionClientReferenceInformation();
  });
  ...
  describe('Vasv1currencyconversionClientReferenceInformation', function() {
    it('should create an instance of Vasv1currencyconversionClientReferenceInformation', function() {
      // uncomment below and update the code to test Vasv1currencyconversionClientReferenceInformation
      //var instane = new CyberSource.Vasv1currencyconversionClientReferenceInformation();
      //expect(instance).to.be.a(CyberSource.Vasv1currencyconversionClientReferenceInformation);
    });
