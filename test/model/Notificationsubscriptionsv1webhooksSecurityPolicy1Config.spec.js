...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Notificationsubscriptionsv1webhooksSecurityPolicy1Config();
  });
  ...
  describe('Notificationsubscriptionsv1webhooksSecurityPolicy1Config', function() {
    it('should create an instance of Notificationsubscriptionsv1webhooksSecurityPolicy1Config', function() {
      // uncomment below and update the code to test Notificationsubscriptionsv1webhooksSecurityPolicy1Config
      //var instane = new CyberSource.Notificationsubscriptionsv1webhooksSecurityPolicy1Config();
      //expect(instance).to.be.a(CyberSource.Notificationsubscriptionsv1webhooksSecurityPolicy1Config);
    });
