...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2004ResponseRecord();
  });
  ...
  describe('InlineResponse2004ResponseRecord', function() {
    it('should create an instance of InlineResponse2004ResponseRecord', function() {
      // uncomment below and update the code to test InlineResponse2004ResponseRecord
      //var instane = new CyberSource.InlineResponse2004ResponseRecord();
      //expect(instance).to.be.a(CyberSource.InlineResponse2004ResponseRecord);
    });
