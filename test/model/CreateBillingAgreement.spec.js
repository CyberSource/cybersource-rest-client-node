...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.CreateBillingAgreement();
  });
  ...
  describe('CreateBillingAgreement', function() {
    it('should create an instance of CreateBillingAgreement', function() {
      // uncomment below and update the code to test CreateBillingAgreement
