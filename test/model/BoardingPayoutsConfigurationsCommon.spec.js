...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.BoardingPayoutsConfigurationsCommon();
  });
  ...
  describe('BoardingPayoutsConfigurationsCommon', function() {
    it('should create an instance of BoardingPayoutsConfigurationsCommon', function() {
      // uncomment below and update the code to test BoardingPayoutsConfigurationsCommon
      //var instane = new CyberSource.BoardingPayoutsConfigurationsCommon();
      //expect(instance).to.be.a(CyberSource.BoardingPayoutsConfigurationsCommon);
    });
