...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2003Billing();
  });
  ...
  describe('InlineResponse2003Billing', function() {
    it('should create an instance of InlineResponse2003Billing', function() {
      // uncomment below and update the code to test InlineResponse2003Billing
      //var instane = new CyberSource.InlineResponse2003Billing();
      //expect(instance).to.be.a(CyberSource.InlineResponse2003Billing);
    });
