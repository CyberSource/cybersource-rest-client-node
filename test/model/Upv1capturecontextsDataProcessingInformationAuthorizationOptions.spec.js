...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.Upv1capturecontextsDataProcessingInformationAuthorizationOptions();
  });
  ...
  describe('Upv1capturecontextsDataProcessingInformationAuthorizationOptions', function() {
    it('should create an instance of Upv1capturecontextsDataProcessingInformationAuthorizationOptions', function() {
      // uncomment below and update the code to test Upv1capturecontextsDataProcessingInformationAuthorizationOptions
      //var instane = new CyberSource.Upv1capturecontextsDataProcessingInformationAuthorizationOptions();
      //expect(instance).to.be.a(CyberSource.Upv1capturecontextsDataProcessingInformationAuthorizationOptions);
    });
